  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "font-bold text-xl text-gray-900 dark:text-white uppercase tracking-tight", children: isEditing ? "Lengkapi / Edit Profil Pengguna" : "Tambah Pengguna Baru" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12 bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-64px)]", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto sm:px-6 lg:px-8", children: [
          ...
          /* @__PURE__ */ jsxs("form", { onSubmit: submit, encType: "multipart/form-data", className: "space-y-8", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] p-8 shadow-xl border border-white dark:border-gray-800 space-y-6", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600 dark:text-gray-400 font-medium pb-2 border-b border-gray-100 dark:border-gray-800", children: "Fitur ini digunakan untuk mendaftarkan pengguna (pasien, admin, atau staf) yang dilakukan secara manual oleh Admin. Admin wajib memastikan:" }),
              /* @__PURE__ */ jsxs("ul", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3 text-xs text-gray-600 dark:text-gray-300 font-medium", children: [
                  ...
                  /* @__PURE__ */ jsxs("p", { children: [
                    ...
                    /* @__PURE__ */ jsx("strong", { className: "text-gray-900 dark:text-white", children: "data asli" }),
                ...
                /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3 text-xs text-gray-600 dark:text-gray-300 font-medium", children: [
                  ...
                  /* @__PURE__ */ jsxs("p", { children: [
                    /* @__PURE__ */ jsx("strong", { className: "text-gray-900 dark:text-white", children: "Pengguna" }),
                    " telah memberikan ",
                ...
                /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3 text-xs text-gray-600 dark:text-gray-300 font-medium", children: [
                  ...
                  /* @__PURE__ */ jsxs("p", { children: [
                    "Password yang dibuat harus diberitahukan kepada ",
                    /* @__PURE__ */ jsx("strong", { className: "text-gray-900 dark:text-white", children: "pengguna" }),
                    " dan ",
              ...
              /* @__PURE__ */ jsx("div", { className: "mt-6 p-4 bg-rose-50 dark:bg-rose-900/20 rounded-2xl border border-rose-100 dark:border-rose-900/30", children: /* @__PURE__ */ jsxs("label", { className: "flex items-start gap-4 cursor-pointer p-4 bg-rose-50/50 dark:bg-rose-900/10 rounded-2xl border border-rose-100 dark:border-rose-900/30 hover:bg-rose-50 transition-colors", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-rose-700 dark:text-rose-400 leading-snug", children: "Saya menyatakan bahwa data yang akan dimasukkan adalah data asli dan telah mendapat persetujuan dari yang bersangkutan." })
              ] }) })
            ] }),
            /* @__PURE__ */ jsx(Section, { icon: User, iconBg: "bg-indigo-50 dark:bg-indigo-900/40", iconColor: "text-indigo-600 dark:text-indigo-400", title: "Identitas Pengguna", subtitle: "Step 1 — Data diri utama", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
              [
            ...
            /* @__PURE__ */ jsxs(Section, { icon: ClipboardList, iconBg: "bg-teal-50 dark:bg-teal-900/40", iconColor: "text-teal-600 dark:text-teal-400", title: "Skrining (Screening)", subtitle: "Step 4 — Hasil asesmen kesehatan mental", children: [
              ...
              data.screening_type === "manual" && /* @__PURE__ */ jsxs("div", { className: "space-y-6 p-6 bg-violet-50/50 dark:bg-violet-950/20 rounded-2xl border border-violet-100 dark:border-violet-900/40", children: [
                ...
                /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-3 p-4 rounded-2xl border-2 cursor-pointer transition-all ${data.is_high_risk ? "bg-rose-600 border-rose-600 text-white shadow-lg shadow-rose-600/20" : "bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 hover:border-rose-300"}`, children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: `text-[10px] font-black uppercase tracking-widest ${data.is_high_risk ? "text-white" : "text-gray-700 dark:text-gray-300"}`, children: "Berisiko Tinggi" }),
            ...
            /* @__PURE__ */ jsxs(Section, { icon: FileImage, iconBg: "bg-emerald-50 dark:bg-emerald-900/40", iconColor: "text-emerald-600 dark:text-emerald-400", title: "Perjanjian & Persetujuan", subtitle: "Step 5 — Tandatangan S&K", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed mb-4", children: "Jika pengguna telah menandatangani perjanjian layanan secara fisik/offline, centang di bawah ini." }),
              /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-4 p-5 rounded-2xl border-2 cursor-pointer transition-all ${data.agreement_signed_offline ? "bg-emerald-600 border-emerald-600 text-white shadow-lg shadow-emerald-600/20" : "bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-emerald-300"}`, children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: `text-[10px] font-medium mt-0.5 ${data.agreement_signed_offline ? "text-white/80" : "text-gray-400"}`, children: "Pihak yang bersangkutan telah membaca dan menyetujui S&K layanan secara fisik" })
                ] })
              ] })
            ] }),
            (!isEditing || isGroupMember) && /* @__PURE__ */ jsx(Section, { icon: Calendar, iconBg: "bg-blue-50 dark:bg-blue-900/40", iconColor: "text-blue-600 dark:text-blue-400", title: "Jadwal & Paket Sesi", subtitle: `Step 6 — ${isGroupMember ? "Sinkron dengan Grup" : "Opsional, bisa diatur nanti"}`, children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              ...
              ] }) : /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed", children: "Isi bagian ini jika pengguna sudah memilih jadwal dan paket. Kosongkan jika belum." }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            ...
            (isGroupMember || !isEditing && hasSchedule) && /* @__PURE__ */ jsx(Section, { icon: Save, iconBg: "bg-orange-50 dark:bg-orange-900/40", iconColor: "text-orange-600 dark:text-orange-400", title: "Informasi Pembayaran", subtitle: "Step 7 — Metode pembayaran anggota", children: /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed", children: isGroupMember ? "Anggota grup melakukan pembayaran secara mandiri. Tentukan metode pembayaran yang akan digunakan." : "Pilih metode pembayaran pengguna." }),
              ...
              data.payment_status === "paid" && /* @__PURE__ */ jsxs("div", { className: "space-y-6 p-6 bg-emerald-50/50 dark:bg-emerald-950/20 rounded-[2rem] border border-emerald-100 dark:border-emerald-900/40", children: [
                data.payment_method === "Transfer Bank" && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsx(InputLabel, { className: "text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1", children: "Nomor Rekening" }),
                    /* @__PURE__ */ jsx(TextInput, { className: "w-full bg-white dark:bg-gray-900 border-transparent focus:ring-4 focus:ring-emerald-500/10 rounded-2xl px-6 py-4 text-sm font-bold transition-all", value: data.payment_account_number, onChange: (e) => setData("payment_account_number", e.target.value), placeholder: "000111222" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              ...
              activeBooking && data.payment_method && data.payment_status && (data.payment_status !== "paid" || (data.payment_method !== "Transfer Bank" || data.payment_bank && data.payment_account_number && data.payment_account_name)) && /* @__PURE__ */ jsx("div", { className: "pt-4 border-t border-gray-100 dark:border-gray-800 flex justify-center mt-6", children: /* @__PURE__ */ jsxs(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 dark:bg-gray-800/50 rounded-[2rem] p-6 border border-gray-100 dark:border-gray-800 space-y-3", children: [
                  roles.map((role) => {
                    ...
                    return /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all ${isChecked ? "bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-600/20" : "bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-indigo-300"}`, children: [
                      /* @__PURE__ */ jsx(
                        "input",
                        {
                          type: "checkbox",
                      ...
                      /* @__PURE__ */ jsx("div", { className: `w-4 h-4 rounded border-2 flex items-center justify-center flex-shrink-0 ${isChecked ? "border-white bg-white" : "border-gray-300 dark:border-gray-600"}`, children: isChecked && /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-sm bg-indigo-600" }) }),
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase tracking-widest", children: role.name })
                    ] }, role.id);
                  }),
                  roles.length === 0 && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400 font-medium text-center py-4", children: "Tidak ada role tersedia." })
                ] }),
