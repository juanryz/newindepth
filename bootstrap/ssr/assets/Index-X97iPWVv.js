...
function TherapistScheduleIndex({ bookings, availableSchedules = [], calendarSchedules = [], mySchedules = [], serverNow, clinicSettings = {}, isAdmin = false }) {
                      ...
                      children: [
                        /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-4", children: [
                          /* @__PURE__ */ jsxs("div", { children: [
                            /* @__PURE__ */ jsx("h4", { className: "font-black text-lg text-gray-900 dark:text-white uppercase tracking-tight", children: booking.is_group ? `🏢 GRUP: ${booking.group_booking?.group_name || "Grup"}` : booking.patient?.name || "Pasien Tidak Dikenal" }),
                            /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 font-bold italic", children: booking.is_group ? `Instansi: ${booking.group_booking?.institution_name || booking.group_booking?.group_name}` : booking.patient?.email || "-" })
                          ] }),
                        ...
                        booking.is_group && booking.group_members?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mb-4 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl border border-indigo-100 dark:border-indigo-800/40", children: [
                          /* @__PURE__ */ jsxs("p", { className: "text-[9px] font-black text-indigo-500 uppercase tracking-widest mb-3 flex items-center justify-between", children: [
                            /* @__PURE__ */ jsx("span", { children: "👥 Anggota Grup — Laporan 1/1" }),
                            /* @__PURE__ */ jsxs("span", { className: "bg-indigo-500 text-white px-2 py-0.5 rounded-full text-[8px]", children: [
                              booking.group_members.length,
                              " org"
                            ] })
                          ] }),
                          /* @__PURE__ */ jsx("div", { className: "space-y-2", children: booking.group_members.map((m) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-white dark:bg-slate-800 rounded-xl px-3 py-2 border border-indigo-100/50 dark:border-indigo-800/30", children: [
                            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                              /* @__PURE__ */ jsx("div", { className: "w-6 h-6 rounded-lg bg-indigo-100 dark:bg-indigo-900 text-indigo-600 dark:text-indigo-400 text-[9px] font-black flex items-center justify-center uppercase shrink-0", children: m.name?.charAt(0) }),
                              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black text-gray-800 dark:text-gray-200 uppercase", children: m.name })
                            ] }),
                            m.booking_id && !isPastBooking(booking) && ["confirmed", "in_progress"].includes(booking.status) && /* @__PURE__ */ jsx(
                              Link,
                              {
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 mt-auto", children: [
                          !booking.is_group && /* @__PURE__ */ jsx(Link, { href: booking.patient?.id ? route("schedules.patient-detail", booking.patient.id) : "#", className: `w-full text-center text-[10px] font-black text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 py-3 rounded-2xl uppercase tracking-widest ${!booking.patient?.id ? "opacity-50 pointer-events-none" : ""}`, children: "Rekam Medis & Detail" }),
                          ...
                          booking.status === "confirmed" && !isPast && /* @__PURE__ */ jsx("button", { onClick: () => handleStartSession(booking.id), className: "w-full text-center text-xs font-black text-white bg-indigo-600 hover:bg-indigo-700 py-3 rounded-2xl shadow-lg uppercase", children: booking.is_group ? "Mulai Sesi Grup" : "Mulai Sesi" }),
                          booking.status === "in_progress" && !booking.is_group && /* @__PURE__ */ jsx(Link, { href: route("schedules.active-session", booking.id), className: "w-full text-center text-xs font-black text-white bg-red-600 hover:bg-red-700 py-3 rounded-2xl uppercase", children: "Selesaikan Sesi" }),
