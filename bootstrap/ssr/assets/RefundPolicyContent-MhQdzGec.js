...
function RefundPolicyContent() {
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("p", { className: "font-bold text-gray-900 dark:text-white mb-4 italic uppercase text-xs", children: [
      "Terakhir diperbarui: ",
      REFUND_POLICY.updated
    ] }),
    /* @__PURE__ */ jsx("div", { className: "whitespace-pre-wrap text-xs leading-relaxed text-gray-600 dark:text-gray-400", children: REFUND_POLICY.content })
  ] });
}
export {
  RefundPolicyContent as R
};
