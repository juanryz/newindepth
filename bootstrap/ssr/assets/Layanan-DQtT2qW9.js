...
function Layanan({ auth, packages = [] }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    ...
    /* @__PURE__ */ jsx(Head, { title: "Layanan Hipnoterapi Semarang | InDepth Klinik" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp(0), className: "bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-white/60 dark:border-gray-800/50 rounded-[3rem] p-8 shadow-xl hover:shadow-2xl transition-all duration-500 relative flex flex-col h-full", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-6 border-b border-gray-200 dark:border-gray-700 pb-6 mt-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5 mb-1", children: [
              regulerPkg.discount_percentage > 0 && /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-gray-400 line-through decoration-rose-500/50 decoration-2", children: formatPrice(regulerPkg.base_price || 2e6) }),
              /* @__PURE__ */ jsx("span", { className: "text-3xl font-extrabold text-gray-900 dark:text-white", children: regulerPkg.current_price ? formatPrice(regulerPkg.current_price) : "Rp 2.000.000" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-sm", children: "/ sesi · ±2 jam" }),
            regulerPkg.discount_ends_at && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/50 dark:bg-gray-800/50 text-gold-600 dark:text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: [
              "⏳ s/d ",
              formatDate(regulerPkg.discount_ends_at)
            ] }),
            !regulerPkg.discount_ends_at && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/50 dark:bg-gray-800/50 text-gold-600 dark:text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: "⏳ Diskon 50% hingga 21 Mei 2026" })
          ] }),
        ...
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp(0.1), className: "relative bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-gold-500/50 rounded-[3rem] p-8 shadow-2xl hover:shadow-[0_20px_40px_rgba(208,170,33,0.15)] transition-all duration-500 flex flex-col h-full", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-6 border-b border-gray-200 dark:border-gray-700 pb-6 mt-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5 mb-1", children: [
              premiumPkg.discount_percentage > 0 && /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-gray-400 line-through decoration-rose-500/50 decoration-2", children: formatPrice(premiumPkg.base_price || 3e6) }),
              /* @__PURE__ */ jsx("span", { className: "text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gold-500 to-yellow-500", children: premiumPkg.current_price ? formatPrice(premiumPkg.current_price) : "Rp 3.000.000" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-sm", children: "/ sesi · ±2 jam" }),
            premiumPkg.discount_ends_at && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/50 dark:bg-gray-800/50 text-gold-600 dark:text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: [
              "⏳ s/d ",
              formatDate(premiumPkg.discount_ends_at)
            ] }),
            !premiumPkg.discount_ends_at && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/50 dark:bg-gray-800/50 text-gold-600 dark:text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: "⏳ Diskon 50% hingga 21 Mei 2026" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-grow space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-3", children: "Kondisi yang Anda alami" }),
        ...
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp(0.2), className: "relative bg-gray-900/90 dark:bg-black/40 backdrop-blur-xl border border-gray-700/50 rounded-[3rem] p-8 shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col h-full", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-6 border-b border-gray-700 pb-6 mt-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5 mb-1", children: [
              vipPkg.discount_percentage > 0 && /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-gray-500 line-through decoration-rose-500/50 decoration-2", children: formatPrice(vipPkg.base_price || 8e6) }),
              /* @__PURE__ */ jsx("span", { className: "text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-yellow-200", children: vipPkg.current_price ? formatPrice(vipPkg.current_price) : "Rp 8.000.000" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-sm", children: "/ sesi · ±2 jam" }),
            vipPkg.discount_ends_at && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/10 text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: [
              "⏳ s/d ",
              formatDate(vipPkg.discount_ends_at)
            ] }),
            !vipPkg.discount_ends_at && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/10 text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: "⏳ Diskon 50% hingga 21 Mei 2026" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-grow space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
