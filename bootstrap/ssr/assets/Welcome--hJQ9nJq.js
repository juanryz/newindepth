      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center gap-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "w-full md:w-3/4", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-2xl font-black text-gray-900 dark:text-white mb-4 tracking-tight flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs font-bold text-gold-600 dark:text-gold-400 uppercase tracking-widest bg-gold-500/10 px-3 py-1.5 rounded-full border border-gold-500/20", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "py-24 relative z-10 overflow-hidden bg-white/20 dark:bg-gray-900/20 backdrop-blur-sm", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl p-10 md:p-14 rounded-[3rem] border border-gold-500/30 shadow-2xl text-gray-800 dark:text-gray-200 relative overflow-hidden group hover:shadow-gold-500/10 transition-all duration-500", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-lg md:text-2xl leading-relaxed font-light text-left md:text-center relative z-10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-col items-center gap-3 animate-pulse", children: [
            /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-3 bg-gradient-to-r from-gold-500/20 to-yellow-500/20 border border-gold-500/30 rounded-full px-6 py-3 shadow-[0_4px_20px_rgba(208,170,33,0.15)]", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "py-24 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-center gap-16", children: [
        /* @__PURE__ */ jsx("div", { className: "w-full lg:w-5/12", children: /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative rounded-[2.5rem] overflow-hidden border border-gold-500/20 shadow-2xl aspect-[4/5] bg-gray-100 dark:bg-gray-800", children: [
            /* @__PURE__ */ jsx("div", { className: "absolute inset-0", children: /* @__PURE__ */ jsx("img", { src: "/images/saiful-anam.png", alt: "Saiful Anam", className: "w-full h-full object-cover object-top" }) }),
            /* @__PURE__ */ jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/90 via-black/50 to-transparent", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-gold-400 font-medium", children: "Direktur InDepth / Pakar Hipnoterapi" })
            ] })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "w-full lg:w-7/12", children: /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-2 text-lg font-semibold text-gold-600 dark:text-gold-400 tracking-wide", children: "Direktur InDepth / Pakar Hipnoterapi" }),
            /* @__PURE__ */ jsx("p", { className: "mt-6 text-xl text-gray-600 dark:text-gray-300 font-light leading-relaxed italic", children: "Mengajar hipnotis dan hipnoterapi secara konsisten sejak tahun 2004." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 text-left", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-6 bg-white/40 dark:bg-gray-900/40 backdrop-blur-md rounded-2xl border border-gold-500/10 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-6 bg-gradient-to-br from-gold-500/10 to-transparent rounded-3xl border border-gold-500/20", children: [
              /* @__PURE__ */ jsx("div", { className: "text-4xl font-extrabold text-gold-600 dark:text-gold-400 mb-1", children: "17.000+" }),
              /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-gray-600 dark:text-gray-300 uppercase underline decoration-gold-500/30 decoration-4 text-left", children: "Klien Personal" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-6 bg-gradient-to-br from-gold-500/10 to-transparent rounded-3xl border border-gold-500/20", children: [
              /* @__PURE__ */ jsx("div", { className: "text-4xl font-extrabold text-gold-600 dark:text-gold-400 mb-1", children: "1150+" }),
              /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-gray-600 dark:text-gray-300 uppercase underline decoration-gold-500/30 decoration-4 text-left", children: "Klien Korporasi" })
            ] })
          ] })
        ] }) })
      ] }) })
