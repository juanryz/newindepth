          ...
          bookings.data.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100 dark:divide-gray-800", children: bookings.data.map((booking) => {
              ...
              return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors", children: [
                ...
                /* @__PURE__ */ jsx("td", { className: "py-4 px-4 align-top", children: /* @__PURE__ */ jsx("div", { className: "font-medium whitespace-nowrap", children: booking.package_type === "vip" ? "Paket VIP" : booking.package_type === "premium" ? "Paket Premium" : booking.package_type === "reguler" ? "Paket Reguler" : "Paket Hipnoterapi" }) }),
                /* @__PURE__ */ jsxs("td", { className: "py-4 px-4 align-top min-w-[200px]", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500 dark:text-gray-400 mt-1", children: (() => {
                    ...
                    return (/* @__PURE__ */ new Date(d + "T00:00:00")).toLocaleDateString("id-ID", { day: "numeric", month: "short", year: "numeric" });
                  })() }),
                ...
                /* @__PURE__ */ jsxs("td", { className: "py-4 px-4 align-top text-right space-y-2", children: [
                  ...
                  ["pending_payment", "pending_validation", "pending_screening", "pending", "draft"].includes(booking.status) && /* @__PURE__ */ jsx(
                    Link,
                    {
