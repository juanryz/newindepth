...
function TherapistShow({ therapist, schedules }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white dark:bg-gray-950", children: [
    ...
    /* @__PURE__ */ jsxs(Head, { title: `${therapist.name} — Terapis InDepth Mental Wellness Semarang`, children: [
      /* @__PURE__ */ jsx("meta", { name: "description", content: `Profil ${therapist.name}, terapis hipnoterapi profesional bersertifikat di InDepth Mental Wellness Semarang. Lihat jadwal sesi, spesialisasi, dan cara booking konsultasi.` }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: `${therapist.name}, terapis hipnoterapi, InDepth Semarang, profil terapis, hipnoterapis bersertifikat, booking sesi hipnoterapi` }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: `${therapist.name} — Terapis InDepth Mental Wellness` }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: `Profil ${therapist.name}: terapis hipnoterapi profesional di InDepth Semarang. Lihat jadwal dan booking sesi.` }),
      /* @__PURE__ */ jsx("meta", { property: "og:image", content: therapist.photo ? `/storage/${therapist.photo}` : "/images/og-dark.jpg" }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: `${therapist.name} — Terapis InDepth` }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: `Profil terapis hipnoterapi ${therapist.name} di InDepth Semarang.` }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:image", content: therapist.photo ? `/storage/${therapist.photo}` : "/images/og-dark.jpg" }),
