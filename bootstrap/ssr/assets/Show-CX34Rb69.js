...
function BookingShow({ booking, userVouchers = [] }) {
  ...
  const handleCancel = () => {
    destroy(route("bookings.cancel", booking.id), {
      onFinish: () => setShowCancelConfirm(false)
    });
  };
    ...
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6", children: [
          ...
          isCompleted && /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 border-purple-100", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold border-b pb-4 mb-4 flex items-center gap-2 text-purple-800", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-gray-500 mb-2 uppercase tracking-wider", children: "Link Rekaman Sesi" }),
                /* @__PURE__ */ jsxs(
                  "a",
                  {
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-purple-50 p-5 rounded-2xl border border-purple-100", children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-purple-800 mb-2 uppercase tracking-wider", children: "Pesan / Summary dari Terapis" }),
                /* @__PURE__ */ jsx("div", { className: "text-gray-700 whitespace-pre-wrap leading-relaxed font-medium", children: booking.patient_visible_notes || "Terapis tidak menyertakan catatan tambahan." })
              ] })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-medium border-b pb-4 mb-4", children: "Informasi Jadwal" }),
            /* @__PURE__ */ jsxs("dl", { className: "grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Terapis" }),
                /* @__PURE__ */ jsx("dd", { className: "mt-1 text-sm text-gray-900 font-semibold", children: booking.therapist?.name || booking.schedule.therapist?.name || "-" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Tanggal" }),
                /* @__PURE__ */ jsx("dd", { className: "mt-1 text-sm text-gray-900", children: new Date(booking.schedule.date).toLocaleDateString("id-ID", { weekday: "long", year: "numeric", month: "long", day: "numeric" }) })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Waktu" }),
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Lokasi" }),
                /* @__PURE__ */ jsx("dd", { className: "mt-1 text-sm text-gray-900", children: "Klinik Utama (Offline)" })
              ] })
            ] }),
            booking.reschedule_reason && /* @__PURE__ */ jsxs("div", { className: "mt-8 p-6 bg-amber-50 border border-amber-200 rounded-2xl", children: [
              /* @__PURE__ */ jsxs("h4", { className: "text-xs font-black text-amber-700 uppercase tracking-widest mb-3 flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-sm font-medium text-amber-800 leading-relaxed italic", children: [
                '"',
                booking.reschedule_reason,
                '"'
              ] }),
              /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-amber-600 font-bold mt-2 uppercase", children: [
                "Diperbarui pada: ",
                new Date(booking.rescheduled_at).toLocaleString("id-ID", { dateStyle: "medium", timeStyle: "short" })
              ] })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-medium border-b pb-4 mb-4", children: "Ringkasan Pemesanan (Order Summary)" }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Layanan InDepth Mental Wellness" }),
                /* @__PURE__ */ jsx("span", { className: "font-medium truncate", children: booking.package_type === "vip" ? "Paket VIP (Intensive Care)" : booking.package_type === "upgrade" ? "Paket Upgrade (Pengembangan Diri)" : "Paket Hipnoterapi" })
              ] }),
              hasAppliedVoucher && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-2 border-t border-green-100", children: [
                /* @__PURE__ */ jsx("span", { className: "text-sm text-green-700", children: "✅ Voucher Diterapkan" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-2 border-t border-gray-100", children: [
                /* @__PURE__ */ jsx("span", { className: "text-lg font-bold text-gray-900", children: "Total Pembayaran" }),
                /* @__PURE__ */ jsxs("span", { className: "text-xl font-bold text-indigo-700", children: [
                  "Rp ",
                  new Intl.NumberFormat("id-ID").format(booking.transaction?.amount || 0)
                ] })
              ] }),
              isPendingPayment && /* @__PURE__ */ jsxs("div", { className: "mt-4 p-4 bg-orange-50 border border-orange-200 rounded-lg text-sm text-orange-800", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-6 p-5 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-100 dark:border-gray-800", children: [
                /* @__PURE__ */ jsxs("h4", { className: "text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 flex items-center gap-2", children: [
          ...
          isPendingPayment && !hasAppliedVoucher && /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-lg font-medium border-b pb-4 mb-4 flex items-center gap-2", children: [
            ...
            activeVouchers.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-500", children: [
              "Anda tidak memiliki voucher aktif. ",
              /* @__PURE__ */ jsx(Link, { href: route("vouchers.index"), className: "text-indigo-600 hover:underline", children: "Klaim voucher sekarang →" })
            ] }) : /* @__PURE__ */ jsxs("form", { onSubmit: handleApplyVoucher, className: "flex gap-3 items-end", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Pilih Voucher" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    children: [
                      ...
                      activeVouchers.map((v) => /* @__PURE__ */ jsxs("option", { value: v.id, children: [
                        v.code,
                        " — Diskon Rp ",
                        new Intl.NumberFormat("id-ID").format(v.discount_amount)
                      ] }, v.id))
                    ]
                  }
                )
          ...
          isPendingPayment && /* @__PURE__ */ jsxs("div", { className: "mt-6 flex justify-between items-center", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                onClick: () => setShowCancelConfirm(true),
                className: "inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-red-600 border border-red-200 rounded-xl hover:bg-red-50 transition-colors",
                children: [
            ...
            /* @__PURE__ */ jsx(Link, { href: route("payments.create", booking.id), children: /* @__PURE__ */ jsx(PrimaryButton, { className: "!bg-blue-600 hover:!bg-blue-500 !rounded-md !px-6 !py-2.5 !text-sm !font-bold", children: "Lanjutkan ke Pembayaran" }) })
          ] }),
          isPendingValidation && /* @__PURE__ */ jsx("div", { className: "mt-6 flex justify-start", children: /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => setShowCancelConfirm(true),
              className: "inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-red-600 border border-red-200 rounded-xl hover:bg-red-50 transition-colors",
          ...
          showCancelConfirm && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 max-w-sm w-full mx-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 flex-shrink-0 bg-red-100 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 text-red-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" }) }) }),
              /* @__PURE__ */ jsx("h3", { className: "font-bold text-gray-900 dark:text-white", children: "Batalkan Pesanan?" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400 mb-6", children: "Pesanan Anda akan dibatalkan dan slot waktu akan dikembalikan. Tindakan ini tidak dapat diurungkan." }),
