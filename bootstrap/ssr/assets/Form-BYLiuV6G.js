  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsx(Link, { href: route("admin.blog.index"), className: "text-gray-500 hover:text-gray-700", children: "← Batal" }),
        /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 leading-tight", children: isEditing ? "Edit Artikel" : "Tulis Artikel Baru" })
      ] }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: isEditing ? "Edit Artikel" : "Tulis Artikel Baru" }),
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg p-8", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "body", value: "Konten Artikel (HTML / Teks Panjang)" }),
            /* @__PURE__ */ jsx(
              "textarea",
              {
                id: "body",
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Anda dapat menggunakan tag HTML dasar seperti <p>, <h2>, <strong>, dll." }),
          ...
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-gray-800", children: "SEO Meta Data (Opsional)" }),
          /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "block mt-6", children: /* @__PURE__ */ jsxs("label", { className: "flex items-center", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "ms-2 text-sm text-gray-600 font-bold", children: "Publikasikan Artikel Ini (Terlihat oleh Publik)" })
          ] }) }),
