...
function TimeSlotPicker({ schedules = [], selectedScheduleId, onSelect, activeBooking, allowPast = false }) {
...
function BookingCreate({ schedules, packageOptions, screeningResult, activeBooking, isAdmin = false }) {
  ...
  const availablePaymentMethods = data.session_type === "online" ? ALL_PAYMENT_METHODS.filter((m) => m.id === "transfer") : ALL_PAYMENT_METHODS;
  useEffect(() => {
    ...
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-8", children: [
          step === 1 && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in", children: [
          ...
          step === 2 && /* @__PURE__ */ jsxs("div", { className: "space-y-8 animate-fade-in-up", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl shadow-sm sm:rounded-2xl border border-gray-100 dark:border-gray-700/50 overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
                packageOptions.is_vip_only ? /* @__PURE__ */ jsx("p", { className: "text-sm text-amber-600 dark:text-amber-400 font-bold mb-6", children: "⚠️ Berdasarkan hasil skrining, kondisi Anda memerlukan penanganan intensif (Paket VIP)." }) : /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500 dark:text-gray-400 mb-6", children: [
                  ...
                  packageOptions.recommended === "reguler" ? "Paket Reguler" : "Paket Premium",
                  " berdasarkan hasil skrining Anda."
                ] }),
                /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6", children: Object.values(packageOptions.packages).map((pkg) => {
                  ...
                  const isLocked = packageOptions.is_vip_only && pkg.id !== "vip";
                  return /* @__PURE__ */ jsxs(
                    "div",
                    {
                      className: `relative rounded-2xl border-2 p-5 sm:p-6 transition-all duration-300 cursor-pointer flex flex-col md:flex-row lg:flex-col items-center md:items-start text-center md:text-left lg:text-center gap-4 ${isSelected ? "border-gold-500 bg-gold-50 dark:bg-gold-900/40 shadow-xl ring-1 ring-gold-500/20" : isLocked ? "opacity-40 grayscale cursor-not-allowed border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/40 hover:border-gold-300 shadow-sm"}`,
                      onClick: () => !isLocked && setData("package_type", pkg.id),
                      children: [
                        isRecommended && /* @__PURE__ */ jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest shadow-lg z-10 whitespace-nowrap", children: "Pilihan Terbaik" }),
                        /* @__PURE__ */ jsxs("div", { className: "flex-1 w-full", children: [
                          /* @__PURE__ */ jsxs("div", { className: "flex justify-center md:justify-between lg:justify-center items-center mb-2", children: [
                            /* @__PURE__ */ jsx("h4", { className: `font-black text-sm sm:text-base uppercase tracking-widest ${isSelected ? "text-gold-700 dark:text-gold-400" : "text-gray-900 dark:text-white"}`, children: pkg.name }),
                            /* @__PURE__ */ jsx("div", { className: `hidden md:flex lg:hidden w-6 h-6 rounded-full border-2 items-center justify-center ${isSelected ? "border-gold-500 bg-gold-500" : "border-gray-300"}`, children: isSelected && /* @__PURE__ */ jsx("div", { className: "w-2.5 h-2.5 rounded-full bg-white" }) })
                          ] }),
                          /* @__PURE__ */ jsxs("div", { className: "mb-2", children: [
                            pkg.original_price && /* @__PURE__ */ jsxs("div", { className: "text-[11px] text-gray-400 dark:text-gray-500 line-through", children: [
                              "Rp ",
                              new Intl.NumberFormat("id-ID").format(pkg.original_price)
                            ] }),
                            /* @__PURE__ */ jsxs("p", { className: "text-2xl sm:text-3xl font-black text-gold-600 dark:text-gold-400 leading-tight", children: [
                              "Rp ",
                              new Intl.NumberFormat("id-ID").format(data.session_type === "online" ? pkg.online_price || pkg.price : pkg.price)
                            ] }),
                            /* @__PURE__ */ jsxs("p", { className: "text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-0.5", children: [
                              "*Sudah Termasuk Konsultasi ",
                              data.session_type === "online" ? "(Online)" : "(Offline)"
                            ] })
                          ] }),
                          /* @__PURE__ */ jsx("div", { className: "text-[11px] sm:text-xs font-medium text-gray-600 dark:text-gray-300 leading-relaxed max-w-xs mx-auto md:mx-0 lg:mx-auto", dangerouslySetInnerHTML: { __html: pkg.description } })
                        ] }),
                        /* @__PURE__ */ jsx("div", { className: `w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all md:hidden lg:flex ${isSelected ? "border-gold-500 bg-gold-500 shadow-lg scale-110" : "border-gray-300 bg-white dark:bg-gray-800"}`, children: isSelected && /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 text-white", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "4", d: "M5 13l4 4L19 7" }) }) })
                      ]
                    },
                    pkg.id
                  );
                ...
                data.package_type && /* @__PURE__ */ jsxs("div", { className: "mt-6 p-5 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-950/30 dark:to-blue-950/30 rounded-2xl border border-indigo-100 dark:border-indigo-900/40", children: [
                  /* @__PURE__ */ jsxs("h4", { className: "text-[10px] font-black text-indigo-900 dark:text-indigo-300 uppercase tracking-[0.2em] mb-3 flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: [
                    ...
                    "button",
                    {
                      ...
                      className: `flex flex-col items-center gap-1.5 p-4 rounded-2xl border-2 transition-all ${data.session_type === mode.id ? "border-indigo-500 bg-indigo-100 dark:bg-indigo-900/40 shadow-md" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/40 hover:border-indigo-300"}`,
                      children: [
                        /* @__PURE__ */ jsx("span", { className: "text-xl", children: mode.icon }),
                        /* @__PURE__ */ jsx("span", { className: `text-[10px] font-black uppercase tracking-wider ${data.session_type === mode.id ? "text-indigo-700 dark:text-indigo-300" : "text-gray-700 dark:text-gray-300"}`, children: mode.label }),
                        /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-gray-400 uppercase", children: mode.desc })
                      ]
                    },
                    mode.id
                  )) }),
                  data.session_type === "online" && /* @__PURE__ */ jsxs("p", { className: "mt-3 text-[10px] font-bold text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50 rounded-xl px-4 py-2", children: [
                    "💻 Sesi online hanya dapat dibayar via ",
                    /* @__PURE__ */ jsx("strong", { children: "Transfer Bank" }),
                    "."
                  ] })
                ] }),
                /* @__PURE__ */ jsx(AnimatePresence, { children: !data.package_type && /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-[0.2em] mb-2", children: "Lihat Jadwal di Bawah" }),
                      /* @__PURE__ */ jsx(
                        motion.div,
                        {
                          animate: { y: [0, 8, 0] },
                          transition: { repeat: Infinity, duration: 1.5 },
                          children: /* @__PURE__ */ jsx("svg", { className: "w-6 h-6 text-indigo-500", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3", d: "M19 14l-7 7-7-7" }) })
                        }
                      )
                    ]
                  }
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl shadow-sm sm:rounded-2xl border border-gray-100 dark:border-gray-700/50 overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
                /* @__PURE__ */ jsx(TimeSlotPicker, { schedules, selectedScheduleId: data.schedule_id, onSelect: (id) => setData("schedule_id", id), activeBooking, allowPast: isAdmin }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl shadow-sm sm:rounded-2xl border border-red-100 dark:border-red-900/30 overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-6", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-2 p-5 bg-indigo-50/70 dark:bg-indigo-950/20 rounded-2xl border border-indigo-100 dark:border-indigo-900/30", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: availablePaymentMethods.map((method) => /* @__PURE__ */ jsxs(
                    "button",
                    {
                      type: "button",
