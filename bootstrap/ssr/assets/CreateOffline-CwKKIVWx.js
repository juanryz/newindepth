...
import { User, ArrowRight, Users, ChevronLeft, AlertTriangle, CheckSquare, Mail, Phone, Camera, AlertCircle, Contact, ClipboardList, Wifi, WifiOff, FileImage, CheckCircle, Calendar, Package, CreditCard, Clock, Banknote, Shield, Lock, EyeOff, Eye, Save, Trash2, Upload } from "lucide-react";
    ...
    return /* @__PURE__ */ jsxs(
      AuthenticatedLayout,
      {
        header: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsx(Link, { href: route("admin.users.index"), className: "p-2 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 text-gray-400 hover:text-indigo-600 transition-colors shadow-sm", children: /* @__PURE__ */ jsx(ChevronLeft, { className: "w-6 h-6" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "font-bold text-xl text-gray-900 dark:text-white uppercase tracking-tight", children: "Tambah User" }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1", children: "Pilih skema pendaftaran" })
          ] })
        ] }),
        children: [
          /* @__PURE__ */ jsx(Head, { title: "Tambah User" }),
          /* @__PURE__ */ jsx("div", { className: "py-20 bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-64px)]", children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto px-6 space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-center mb-10", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tight", children: "Pilih Skema Pendaftaran" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400 font-medium mt-2", children: "Pilih jenis pendaftaran yang sesuai" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("div", { className: "p-4 bg-indigo-50 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 rounded-2xl inline-flex mb-5 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsx(User, { className: "w-8 h-8" }) }),
                    /* @__PURE__ */ jsx("h4", { className: "text-lg font-black text-gray-900 dark:text-white uppercase tracking-wide mb-2", children: "Individual" }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 font-medium leading-relaxed mb-4", children: "Daftarkan satu pasien. Bisa memilih sesi online atau offline. Invoice individual tersedia untuk didownload." }),
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
                      /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-blue-50 text-blue-700 text-[9px] font-black rounded-full uppercase", children: "💻 Online" }),
                      /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-emerald-50 text-emerald-700 text-[9px] font-black rounded-full uppercase", children: "🏥 Offline" }),
                      /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-violet-50 text-violet-700 text-[9px] font-black rounded-full uppercase", children: "📄 Invoice" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-5 text-indigo-600 dark:text-indigo-400", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase tracking-widest", children: "Pilih" }),
              ...
              /* @__PURE__ */ jsxs(
                ...
                {
                  onClick: () => {
                    window.location.href = route("admin.group-bookings.create");
                  },
                  ...
                  children: [
                    /* @__PURE__ */ jsx("div", { className: "p-4 bg-emerald-50 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 rounded-2xl inline-flex mb-5 group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsx(Users, { className: "w-8 h-8" }) }),
                    /* @__PURE__ */ jsx("h4", { className: "text-lg font-black text-gray-900 dark:text-white uppercase tracking-wide mb-2", children: "Grup / Institusi" }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 font-medium leading-relaxed mb-4", children: "Daftarkan banyak pasien sekaligus dalam satu grup. Sesi offline, invoice dikelola per grup." }),
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
                      /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-emerald-50 text-emerald-700 text-[9px] font-black rounded-full uppercase", children: "🏥 Offline Only" }),
                      /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-amber-50 text-amber-700 text-[9px] font-black rounded-full uppercase", children: "👥 Multi-user" }),
                      /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-violet-50 text-violet-700 text-[9px] font-black rounded-full uppercase", children: "📄 Invoice Grup" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-5 text-emerald-600 dark:text-emerald-400", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase tracking-widest", children: "Pilih" }),
                      /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 group-hover:translate-x-1 transition-transform" })
                    ] })
                  ]
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsx(
                      "select",
                      {
                        ...
                        children: availablePaymentMethods.map((m) => /* @__PURE__ */ jsx("option", { value: m, children: m }, m))
                      }
                    ),
                    /* @__PURE__ */ jsx(CreditCard, { className: "absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" })
                  ] }),
                  data.session_type === "online" && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-blue-600 font-bold", children: "💻 Sesi online hanya mendukung Transfer Bank" }),
