        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-10 p-8 bg-gradient-to-br from-gold-50/50 to-white dark:from-gold-950/20 dark:to-transparent rounded-[2rem] border border-gold-100 dark:border-gold-900/30 relative overflow-hidden group", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-8", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "flex-1 space-y-4", children: /* @__PURE__ */ jsx("div", { className: "p-4 bg-white/50 dark:bg-black/20 rounded-2xl border border-white dark:border-gray-800 shadow-sm transition-all hover:shadow-md", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "pt-6 border-t border-gold-100/50 dark:border-white/5", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                ...
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    className: `px-6 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${isVoucherApplied ? "bg-emerald-100 text-emerald-600 border border-emerald-200 cursor-default" : "bg-gold-600 text-white hover:bg-gold-700 disabled:opacity-50"}`,
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("label", { htmlFor: "payment_account_number", className: "text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1", children: "Nomor Rekening Pengirim" }),
              /* @__PURE__ */ jsx(
                "input",
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("label", { htmlFor: "payment_account_name", className: "text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1", children: "Nama Pemilik Rekening" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                ...
                /* @__PURE__ */ jsxs(
                  "label",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-slate-600 dark:text-slate-400 truncate max-w-[200px]", children: data.payment_proof ? data.payment_proof.name : "Pilih File Gambar Bukti Transfer" })
                    ]
                  }
                )
              ] }),
