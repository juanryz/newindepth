...
function Privacy({ auth }) {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      ...
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Kebijakan privasi InDepth Mental Wellness. Pelajari bagaimana kami mengumpulkan, menggunakan, dan melindungi data pribadi Anda selama menggunakan layanan hipnoterapi kami." }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: "kebijakan privasi InDepth, perlindungan data hipnoterapi, privasi klien InDepth, data pribadi InDepth Semarang" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Kebijakan Privasi | InDepth Mental Wellness" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Pelajari bagaimana InDepth Mental Wellness mengumpulkan dan melindungi data pribadi klien." }),
