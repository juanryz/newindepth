...
function BlogIndex({ posts, auth }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Blog Kesehatan Mental | InDepth Mental Wellness Semarang" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Baca artikel, tips, dan wawasan seputar kesehatan mental, hipnoterapi, psikologi, dan kesejahteraan jiwa langsung dari tim profesional InDepth Mental Wellness Semarang." }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: "blog kesehatan mental, artikel hipnoterapi, tips psikologi, wawasan kesehatan jiwa, InDepth Mental Wellness, artikel terapi mental Semarang" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Blog Kesehatan Mental | InDepth Mental Wellness" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Artikel, tips, dan wawasan kesehatan mental dan hipnoterapi dari tim profesional InDepth Mental Wellness Semarang." }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Blog Kesehatan Mental | InDepth Mental Wellness" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Artikel dan tips kesehatan mental dari tim profesional InDepth Semarang." }),
