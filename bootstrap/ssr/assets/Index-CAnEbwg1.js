    ...
    /* @__PURE__ */ jsxs("main", { className: "relative z-10 pt-40 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-24 mb-32", children: [
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "lg:w-1/2 order-2 lg:order-1", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xl text-gold-600 dark:text-gold-400 font-medium mb-6", children: "Mengakses Akar Masalah dari Dalam" }),
                /* @__PURE__ */ jsxs("p", { className: "text-gray-600 dark:text-gray-300 mb-6 leading-relaxed", children: [
                  "InDepth Trance State adalah kondisi hipnotik mendalam yang memungkinkan klien mengakses lapisan bawah sadar dan kecerdasan tubuh ",
                  /* @__PURE__ */ jsx("em", { children: "(somatic mind)" }),
                  ".",
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("strong", { children: "Bukan sekadar relaksasi. Bukan sekadar sugesti." }),
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("br", {}),
                  "Metode ini membawa klien ke kondisi ",
                  /* @__PURE__ */ jsx("em", { children: "trans-hypnosleep" }),
                  " yang stabil, di mana:"
                ] }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "bg-white/50 dark:bg-gray-900/50 backdrop-blur-md rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm", children: [
                  /* @__PURE__ */ jsxs("h4", { className: "font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 text-gold-500", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsx("path", { fillRule: "evenodd", d: "M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z", clipRule: "evenodd" }) }),
                    "Kelebihan Utama:"
                  ] }),
                  /* @__PURE__ */ jsxs("ul", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-600 dark:text-gray-400", children: [
                    ...
                    /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-gold-500" }),
                      " Minim resistensi pikiran sadar"
                    ] }),
                    /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-gold-500" }),
                      " Efektif untuk trauma & fobia"
                    ] }),
                    /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-gold-500" }),
                      " Aktivasi komunikasi internal"
                    ] })
                  ] })
                ] })
              ] }),
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            className: "flex flex-col lg:flex-row items-center gap-12 group",
            children: [
              /* @__PURE__ */ jsx("div", { className: "lg:w-1/2 w-full", children: /* @__PURE__ */ jsxs("div", { className: "relative aspect-square lg:aspect-[4/3] rounded-[3rem] bg-gradient-to-bl from-gray-900/10 to-transparent border border-gray-900/10 dark:border-white/10 overflow-hidden flex items-center justify-center group-hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)] dark:group-hover:shadow-[0_20px_60px_rgba(255,255,255,0.05)] transition-all duration-700", children: [
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-10 dark:opacity-30" }),
                /* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-gray-900/10 dark:bg-white/10 blur-[100px] rounded-full group-hover:scale-110 transition-transform duration-700" }),
                /* @__PURE__ */ jsx("img", { src: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=800&auto=format&fit=crop", alt: "Supreme Trance State", className: "relative z-10 w-full h-full object-cover rounded-[3rem] transform group-hover:scale-105 transition-transform duration-700 shadow-2xl" })
              ] }) }),
              /* @__PURE__ */ jsxs("div", { className: "lg:w-1/2", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-700 dark:text-gray-300 font-medium mb-6", children: "Kedalaman Maksimal dengan Kendali Penuh" }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400 mb-6 leading-relaxed", children: "Supreme Trance State adalah pengembangan lanjutan dari InDepth Trance State. Pada metode ini, klien tidak hanya masuk ke kedalaman bawah sadar, tetapi juga mempertahankan kesadaran tinggi secara simultan." }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("h4", { className: "font-bold text-gray-900 dark:text-white mb-3 text-sm uppercase tracking-wider", children: "Cocok Untuk:" }),
                    /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-gray-600 dark:text-gray-400", children: [
                      /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 mt-1.5 shrink-0 rounded-full bg-gray-400" }),
                        " Kasus kompleks & kronis"
                      ] }),
                      /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 mt-1.5 shrink-0 rounded-full bg-gray-400" }),
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("h4", { className: "font-bold text-gray-900 dark:text-white mb-3 text-sm uppercase tracking-wider", children: "Keunggulan:" }),
                    /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-gray-600 dark:text-gray-400", children: [
                      /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 mt-1.5 shrink-0 rounded-full bg-gold-500" }),
                        " Gabungan kontrol sadar"
                      ] }),
                      /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 mt-1.5 shrink-0 rounded-full bg-gold-500" }),
                        " Rekonstruksi sangat terstruktur"
                      ] })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-300 leading-relaxed font-light mt-6", children: "Metode ini sangat disarankan untuk klien dengan tingkat resistensi tinggi atau individu yang ingin mempertahankan kesadaran penuh namun tetap ingin melakukan eksplorasi bawah sadar yang mendalam." })
              ] })
            ]
          }
        ),
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "lg:w-1/2 order-2 lg:order-1", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xl text-gold-600 dark:text-gold-400 font-medium mb-6", children: "Solusi Versi Tubuh Anda Sendiri" }),
                /* @__PURE__ */ jsxs("p", { className: "text-gray-600 dark:text-gray-300 mb-6 leading-relaxed", children: [
                  "Pendekatan sistematis untuk menggali solusi terbaik berdasarkan kecerdasan tubuh klien sendiri. Dalam kondisi InDepth Trance State, dilakukan wawancara terstruktur dengan ",
                  /* @__PURE__ */ jsx("em", { children: "somatic mind" }),
                  " untuk mengetahui:"
                ] }),
                /* @__PURE__ */ jsx("div", { className: "bg-white/40 dark:bg-gray-900/40 backdrop-blur-md rounded-2xl p-6 border border-white/60 dark:border-gray-800/50 shadow-sm mb-8", children: /* @__PURE__ */ jsx("ul", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-gray-200 dark:border-gray-800 pt-8", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("h4", { className: "font-bold text-gray-900 dark:text-white mb-4", children: "Hasil Solusi 100%:" }),
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
                      /* @__PURE__ */ jsx("span", { className: "px-3 py-1 bg-gold-500/10 border border-gold-500/20 rounded-lg text-gold-700 dark:text-gold-400 text-sm font-medium", children: "Personal" }),
                      /* @__PURE__ */ jsx("span", { className: "px-3 py-1 bg-gold-500/10 border border-gold-500/20 rounded-lg text-gold-700 dark:text-gold-400 text-sm font-medium", children: "Spesifik" }),
                      /* @__PURE__ */ jsx("span", { className: "px-3 py-1 bg-gold-500/10 border border-gold-500/20 rounded-lg text-gold-700 dark:text-gold-400 text-sm font-medium", children: "Tidak Generik" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("h4", { className: "font-bold text-gray-900 dark:text-white mb-3", children: "Sangat Efektif Untuk:" }),
                    /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-gray-600 dark:text-gray-400", children: [
                      /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-gray-400" }),
                        " Masalah medis tak terjelaskan (psikosomatis)"
                      ] }),
                      /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-gray-400" }),
                        " Kebuntuan terapi sebelumnya"
                      ] })
                    ] })
                  ] })
                ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative rounded-[3rem] overflow-hidden bg-white/50 dark:bg-gray-900/50 backdrop-blur-2xl border border-gold-500/20 shadow-2xl p-10 md:p-16 mb-24 text-center group", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white mb-6", children: "Mengapa InDepth Berbeda?" }),
          ...
          ].map((item, i) => /* @__PURE__ */ jsxs("div", { className: "bg-white/60 dark:bg-black/40 border border-gold-500/20 rounded-2xl p-6 group-hover:-translate-y-1 transition-transform", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 mb-1", children: item.title }),
