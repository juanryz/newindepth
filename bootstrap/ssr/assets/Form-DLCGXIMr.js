    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
      ...
      /* @__PURE__ */ jsxs(
        "select",
        {
          ...
          required: true,
          children: [
            /* @__PURE__ */ jsx("option", { value: "consultation", children: "👤 Konsultasi Pasien" }),
            /* @__PURE__ */ jsx("option", { value: "class", children: "🎓 Kelas / Kelompok" })
          ]
        }
      )
    ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxs(
          "select",
          {
            ...
            required: true,
            children: [
              /* @__PURE__ */ jsx("option", { value: "", children: "Pilih Sesi..." }),
              SESSIONS.map((s) => /* @__PURE__ */ jsx("option", { value: s.id, children: s.name }, s.id))
            ]
          }
        ),
