...
function BlogIndex({ posts, auth }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "relative z-10 pt-32 pb-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: posts.data.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "col-span-full py-20 text-center rounded-[3rem] border border-dashed border-gold-500/30 bg-white/20 dark:bg-gray-900/20 backdrop-blur-md", children: [
        ...
        /* @__PURE__ */ jsxs(Link, { href: route("blog.show", post.slug), className: "block relative aspect-[16/10] overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-8 flex-1 flex flex-col", children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-4 flex items-center gap-3 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest", children: [
            /* @__PURE__ */ jsx("span", { children: new Date(post.published_at).toLocaleDateString("id-ID", { day: "numeric", month: "long", year: "numeric" }) }),
            /* @__PURE__ */ jsx("span", { className: "w-1 h-1 rounded-full bg-gold-400" }),
            /* @__PURE__ */ jsx("span", { children: "5 Menit Baca" })
          ] }),
          /* @__PURE__ */ jsxs(Link, { href: route("blog.show", post.slug), className: "flex-1", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400 line-clamp-3 font-light leading-relaxed mb-6", children: post.excerpt || (post.body || "").replace(/(<([^>]+)>)/gi, "").substring(0, 120) + "..." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "pt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-full bg-gold-500/10 flex items-center justify-center font-bold text-gold-600 text-xs", children: post.author?.name?.charAt(0) }),
              /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-700 dark:text-gray-300", children: post.author?.name })
            ] }),
            /* @__PURE__ */ jsx(Link, { href: route("blog.show", post.slug), className: "text-gold-600 dark:text-gold-400 hover:translate-x-1 transition-transform", children: /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M17 8l4 4m0 0l-4 4m4-4H3" }) }) })
          ] })
        ] })
      ] }, post.id)) })
    ] }) }),
