...
function SupremeTrance({ auth }) {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased transition-colors duration-500 overflow-x-hidden relative", children: [
    /* @__PURE__ */ jsxs(Head, { title: "SUPREME TRANCE — Akses Penuh ke Unconscious dalam Kondisi Sadar", children: [
      /* @__PURE__ */ jsx("meta", { name: "description", content: "SUPREME TRANCE adalah puncak metodologi InDepth — teknik hipnoterapi tertinggi yang memungkinkan akses penuh ke unconscious mind dalam kondisi klien tetap sadar penuh. Untuk kasus kompleks dan transformasi mendalam." }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: "SUPREME TRANCE, akses unconscious sadar, hipnoterapi tingkat lanjut, teknik hipnoterapi tertinggi, transformasi mendalam, kasus kompleks hipnoterapi, metodologi InDepth" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "SUPREME TRANCE — Akses Penuh ke Unconscious dalam Kondisi Sadar" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Puncak metodologi InDepth: SUPREME TRANCE untuk akses penuh ke unconscious mind sambil klien tetap sadar penuh. Untuk kasus paling kompleks." }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "SUPREME TRANCE — Teknik Hipnoterapi Tertinggi" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Akses penuh ke unconscious mind dalam kondisi sadar. Puncak metodologi InDepth untuk kasus kompleks." }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
        ...
        /* @__PURE__ */ jsxs(
          motion.h1,
          {
            ...
            children: [
              "SUPREME ",
              /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-gold-500 to-yellow-500", children: "TRANCE" })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
          motion.p,
          {
            ...
            children: "Akses Penuh ke Unconscious dalam Kondisi Sadar"
          }
        )
      ] }),
      /* @__PURE__ */ jsxs(
          ...
          children: [
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-gray-700 dark:text-gray-200 leading-relaxed mb-6 relative z-10 font-bold", children: "SUPREME TRANCE adalah kondisi lanjutan dari InDepth TRANCE." }),
                  /* @__PURE__ */ jsxs("p", { className: "text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6 relative z-10", children: [
                    "Dalam kondisi ini, Anda mengakses ",
                    /* @__PURE__ */ jsx("strong", { children: "unconscious" }),
                    " sambil tetap sadar sepenuhnya dan mengendalikan proses secara langsung. Kondisi ini memungkinkan akses ke sistem terdalam tanpa kehilangan kesadaran."
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "text-lg text-gold-600 dark:text-gold-400 leading-relaxed relative z-10 font-medium italic", children: "Digunakan untuk kontrol diri, pengembangan potensi, dan pengambilan keputusan secara terarah." })
                ]
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 bg-white/20 dark:bg-black/20 border border-white/10 dark:border-white/5 p-4 rounded-2xl opacity-60", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("h4", { className: "font-bold text-gray-900 dark:text-white", children: "InDepth TRANCE" }),
                      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "→ Akses ke unconscious dan kecerdasan tubuh" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 bg-gold-500/20 border border-gold-500/30 p-5 rounded-3xl shadow-lg ring-1 ring-gold-500/20", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("h4", { className: "font-black text-gray-900 dark:text-white uppercase tracking-tight", children: "SUPREME TRANCE" }),
                      /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gold-700 dark:text-gold-400", children: "→ Akses sadar ke unconscious" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 bg-white/20 dark:bg-black/20 border border-white/10 dark:border-white/5 p-4 rounded-2xl opacity-60", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "→ Komunikasi dengan kecerdasan tubuh" })
                    ] })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-gray-900 to-black rounded-[2.5rem] p-10 text-white relative overflow-hidden shadow-2xl flex items-center border border-white/10", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xl md:text-2xl font-bold relative z-10 italic leading-snug text-gold-100", children: '"SUPREME TRANCE hanya dapat dibangun di atas fondasi InDepth TRANCE yang stabil."' })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "py-12", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-3xl font-black text-gray-900 dark:text-white text-center mb-12 uppercase tracking-tighter", children: "Karakter Kondisi & Fungsi" }),
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
                {
                  num: "1⃣",
                  title: "Karakter Kondisi",
                  points: ["Sadar penuh (internal dan eksternal)", "Mampu berpikir normal", "Tubuh tetap stabil", "Kesadaran terfokus", "Proses berjalan dengan kendali penuh"]
                },
                {
                  num: "2⃣",
                ...
                },
                {
                  num: "3⃣",
                  title: "Fungsi Utama",
                  points: ["Kontrol diri secara langsung", "Self-programming", "Pengambilan keputusan", "Aktivasi kondisi optimal", "Pengembangan potensi tingkat lanjut"]
                },
                {
                  num: "4⃣",
                  title: "Trigger Potensi",
                  points: ["Dibuat trigger berupa gerakan", "Diperkuat dengan kata internal", "Digunakan untuk mengaktifkan kondisi optimal", "Kondisi optimal muncul secara langsung dalam aktivitas"]
                }
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-12 text-center text-xl font-black text-gold-600 dark:text-gold-400 italic px-4", children: "Kondisi ini memungkinkan penggunaan unconscious secara sadar dan terarah." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-white/40 dark:bg-gray-900/40 backdrop-blur-2xl rounded-[3rem] p-8 md:p-16 border border-white/40 dark:border-white/10 shadow-2xl relative overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "flex flex-col md:flex-row gap-12 items-center relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsx("h3", { className: "text-3xl font-black text-gray-900 dark:text-white mb-8 tracking-tighter uppercase", children: "Akses ke Potensi Internal" }),
                /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-gold-600 dark:text-gold-400 mb-6", children: "Dalam kondisi ini:" }),
                /* @__PURE__ */ jsx("ul", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                  "Potensi internal dapat diakses secara langsung",
                  "Kondisi optimal dapat diarahkan sesuai kebutuhan",
                  "Sistem bawah sadar dapat digunakan secara sadar",
                  "Proses berjalan dengan kendali penuh",
                  "Kontrol dapat dipertahankan sepanjang sesi"
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-10 space-y-4", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-xl font-black text-gray-900 dark:text-white bg-gold-500/10 dark:bg-white/5 inline-block px-6 py-2 rounded-2xl border border-gold-500/20", children: "Ini adalah kendali aktif atas unconscious." })
                ] })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "py-12", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-3xl font-black text-gray-900 dark:text-white mb-12 text-center uppercase tracking-tighter underline decoration-gold-500 decoration-8 underline-offset-8", children: "Mekanisme Kerja" }),
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
                {
                  title: "Akses",
                  items: ["mengakses unconscious dalam kondisi sadar", "sistem internal terbuka sepenuhnya", "tidak ada hambatan pikiran kritis"]
                },
                {
                  title: "Kendali",
                  items: ["mengarahkan sistem internal secara langsung", "menetapkan kondisi optimal sebagai standar", "proses berjalan atas kendali klien"]
                },
                {
                  title: "Aktivasi",
                  items: ["mengaktifkan kondisi optimal saat dibutuhkan", "trigger dapat digunakan dalam aktivitas", "kondisi dapat diakses secara mandiri"]
                }
              ...
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col lg:flex-row gap-16 items-center", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                    /* @__PURE__ */ jsx("h3", { className: "text-3xl font-black text-gray-900 dark:text-white mb-8 tracking-tighter uppercase", children: "Trigger Potensi" }),
                    /* @__PURE__ */ jsxs("p", { className: "text-xl font-medium text-gray-700 dark:text-gray-300 mb-8 leading-relaxed", children: [
                      "Setelah kondisi optimal tercapai, dibuat ",
                      /* @__PURE__ */ jsx("strong", { className: "text-gold-600 font-black", children: "trigger" }),
                      " yang memungkinkan kondisi tersebut diaktifkan kembali kapan pun dibutuhkan:"
                    ] }),
                    /* @__PURE__ */ jsx("ul", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8", children: [
                      "trigger berupa gerakan spesifik",
                      "diperkuat dengan kata internal",
                      "digunakan dalam aktivitas sehari-hari",
                      "kondisi optimal muncul secara langsung"
                    ...
                    /* @__PURE__ */ jsxs("p", { className: "text-gray-600 dark:text-gray-400 italic font-medium leading-relaxed", children: [
                      "Trigger memungkinkan kondisi optimal ",
                      /* @__PURE__ */ jsx("strong", { className: "text-gold-600 dark:text-gold-400 font-black tracking-widest uppercase", children: "diakses secara mandiri" }),
                      " tanpa perlu sesi tambahan."
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "w-full lg:w-2/5 flex flex-col gap-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-gold-500 to-gold-700 rounded-[3rem] p-10 text-center shadow-2xl border border-white/20 group relative overflow-hidden", children: [
                    ...
                    /* @__PURE__ */ jsx("h4", { className: "text-4xl font-black mb-4 tracking-tighter text-white", children: "TRIGGER" }),
                    /* @__PURE__ */ jsx("p", { className: "font-black text-gold-100 uppercase text-xs tracking-[0.3em] mb-6", children: "Aktivasi Kondisi Optimal" }),
                    /* @__PURE__ */ jsx("div", { className: "space-y-2", children: ["Mandiri", "Instan", "Konsisten"].map((tag, idx) => /* @__PURE__ */ jsx("div", { className: "bg-white/20 rounded-xl py-2 text-[10px] font-black text-white uppercase tracking-widest", children: tag }, idx)) })
                  ] }) })
                ] })
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: "py-12", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-3xl font-black text-gray-900 dark:text-white mb-12 text-center uppercase tracking-tighter", children: "Alur Proses SUPREME TRANCE" }),
              /* @__PURE__ */ jsxs("div", { className: "bg-gray-900 rounded-[3rem] p-8 md:p-12 border border-white/10 shadow-3xl", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-12 text-center text-gray-400 text-lg italic max-w-2xl mx-auto", children: '"Fondasi InDepth TRANCE tetap aktif, ditingkatkan oleh kendali sadar penuh."' })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "py-12", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
                /* @__PURE__ */ jsxs("div", { className: "p-8 bg-white/60 dark:bg-gray-900/40 rounded-[2.5rem] border border-gray-200 dark:border-white/10", children: [
                  ...
                  /* @__PURE__ */ jsxs("ul", { className: "space-y-4 text-gray-600 dark:text-gray-400 font-bold", children: [
                    ...
                    /* @__PURE__ */ jsxs("li", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-gray-400" }),
                      " Proses dipandu terapis"
                    ] }),
                    /* @__PURE__ */ jsxs("li", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-gray-400" }),
                      " Fokus pada akses unconscious"
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-8 bg-gold-500/10 dark:bg-gold-500/5 rounded-[2.5rem] border border-gold-500/20", children: [
                  ...
                  /* @__PURE__ */ jsxs("ul", { className: "space-y-4 text-gray-900 dark:text-gray-100 font-bold", children: [
                    ...
                    /* @__PURE__ */ jsxs("li", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-gold-500" }),
                      " Proses diarahkan oleh klien"
                    ] }),
                    /* @__PURE__ */ jsxs("li", { className: "flex gap-3 items-center", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-gold-500" }),
                      " Fokus pada kontrol dan penggunaan unconscious"
                    ] })
                  ] })
                ] })
              ] })
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-gray-950 rounded-[3rem] p-10 md:p-16 text-center border border-white/5 relative overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("h3", { className: "text-2xl font-black text-gold-500 uppercase mb-8 tracking-widest", children: "Peran Dalam Metodologi" }),
              /* @__PURE__ */ jsx("p", { className: "text-xl md:text-2xl text-gray-300 font-medium leading-relaxed max-w-3xl mx-auto italic", children: '"SUPREME TRANCE digunakan pada layanan Premium untuk pengembangan performa dan peningkatan kapasitas internal."' }),
              /* @__PURE__ */ jsx("p", { className: "mt-6 text-gray-500 font-bold", children: "Kontrol diri dan kondisi optimal dapat digunakan secara konsisten dalam aktivitas." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "py-12", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-3xl font-black text-gray-900 dark:text-white text-center mb-12 uppercase tracking-tighter", children: "FAQ SUPREME TRANCE" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-center py-20 border-t border-gray-100 dark:border-gray-900 space-y-8", children: [
              /* @__PURE__ */ jsx("div", { className: "inline-flex gap-4 md:gap-8 items-center justify-center flex-wrap", children: ["Sadar.", "Potensi.", "Kendali."].map((word, i) => /* @__PURE__ */ jsx("span", { className: "text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tighter", children: word }, i)) }),
              /* @__PURE__ */ jsx("p", { className: "text-xl md:text-2xl text-gray-500 dark:text-gray-400 max-w-3xl mx-auto font-medium leading-relaxed px-4", children: '"SUPREME TRANCE memberikan akses sadar ke sistem terdalam dalam diri Anda. Digunakan untuk mengarahkan potensi dan mengaktifkan kondisi optimal secara langsung."' })
            ] }),
