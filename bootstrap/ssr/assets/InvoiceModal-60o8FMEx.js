        ...
        /* @__PURE__ */ jsxs("div", { id: "invoice-print-area", className: "p-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-8 pb-6 border-b-2 border-indigo-100", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("img", { src: "/images/logo-color.png", alt: "InDepth Logo", className: "h-10 w-auto mb-2" }),
              /* @__PURE__ */ jsx("h1", { className: "text-2xl font-black text-indigo-900 uppercase tracking-tight", children: "InDepth Mental Wellness" }),
