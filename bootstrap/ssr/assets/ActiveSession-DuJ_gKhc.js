...
import { AlertCircle, MessageCircle, Video, Zap, FileText, Shield, CheckSquare, Info, Heart, ExternalLink, Activity, CheckCircle2, Save, Clock, User, ArrowLeft } from "lucide-react";
...
function ActiveSession({ booking, patient, isAdmin = false }) {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                disabled: isFormDisabled,
                className: `flex-1 py-3 rounded-2xl font-black text-xs uppercase tracking-widest transition-all border-2 disabled:opacity-50 disabled:cursor-not-allowed ${cl[field.key] === true ? "bg-emerald-500/10 border-emerald-500 text-emerald-700 dark:text-emerald-400" : "bg-white/50 dark:bg-black/20 border-gray-200 dark:border-gray-700 text-gray-500"}`,
                children: "Ya"
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                disabled: isFormDisabled,
                className: `flex-1 py-3 rounded-2xl font-black text-xs uppercase tracking-widest transition-all border-2 disabled:opacity-50 disabled:cursor-not-allowed ${cl[field.key] === false ? "bg-rose-500/10 border-rose-500 text-rose-700 dark:text-rose-400" : "bg-white/50 dark:bg-black/20 border-gray-200 dark:border-gray-700 text-gray-500"}`,
                children: "Tidak"
              }
            )
          ] })
          ...
          /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 items-start", children: [
            /* @__PURE__ */ jsx("div", { className: "lg:col-span-8 space-y-8", children: /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  isFormDisabled && /* @__PURE__ */ jsx("div", { className: "mb-10 p-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-700 rounded-[2rem]", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
                    /* @__PURE__ */ jsx("div", { className: "p-3 bg-red-500/20 text-red-600 dark:text-red-400 rounded-2xl flex-shrink-0", children: /* @__PURE__ */ jsx(AlertCircle, { className: "w-6 h-6" }) }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "text-base font-black text-red-700 dark:text-red-400 uppercase tracking-widest mb-1", children: "Sesi Melebihi 95 Menit" }),
                      /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-red-600 dark:text-red-300 leading-relaxed", children: "Pengisian data sesi tidak dapat dilakukan setelah durasi 95 menit. Silakan hubungi admin untuk mengisi data atas nama Anda." }),
                      /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center gap-2 text-xs font-black text-red-500 dark:text-red-400 uppercase tracking-widest", children: [
                        /* @__PURE__ */ jsx(MessageCircle, { className: "w-4 h-4" }),
                        " Hubungi admin untuk melanjutkan"
                      ] })
                    ] })
                  ] }) }),
                ...
                motion.div,
                {
                  ...
                  children: [
                    ...
                    sessionAlert === "force" && /* @__PURE__ */ jsxs(Fragment, { children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 mb-4 font-medium", children: "Sesi ini telah melewati batas durasi maksimal sistem." }),
                      /* @__PURE__ */ jsxs("div", { className: "p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-2xl mb-6 text-left", children: [
                        /* @__PURE__ */ jsxs("p", { className: "text-sm font-black text-amber-700 dark:text-amber-400 uppercase tracking-widest mb-1 flex items-center gap-2", children: [
                          /* @__PURE__ */ jsx(MessageCircle, { className: "w-4 h-4" }),
                          " Hubungi Admin"
                        ] }),
                        /* @__PURE__ */ jsx("p", { className: "text-sm text-amber-700 dark:text-amber-300 font-medium", children: "Untuk mengisi atau melengkapi data sesi yang melebihi 95 menit, silakan hubungi admin. Admin dapat mengisi data atas nama Anda." })
                      ] }),
                      /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 font-medium", children: "Sistem akan menutup sesi ini secara otomatis." })
                    ] }),
                    sessionAlert === "force_admin" && /* @__PURE__ */ jsxs(Fragment, { children: [
                      /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 w-full h-2 bg-orange-500 rounded-t-full" }),
                      /* @__PURE__ */ jsx("div", { className: "mx-auto w-20 h-20 bg-orange-50 dark:bg-orange-900/20 rounded-full flex items-center justify-center mb-6", children: /* @__PURE__ */ jsx(AlertCircle, { className: "w-10 h-10 text-orange-500" }) }),
                      /* @__PURE__ */ jsx("h3", { className: "text-2xl font-black text-slate-800 dark:text-white mb-2", children: "Sesi Melebihi 95 Menit" }),
                      /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-400 mb-6 font-medium", children: "Sesi ini telah melewati durasi standar. Sebagai admin, Anda masih dapat mengisi dan menyimpan data sesi ini." }),
                      /* @__PURE__ */ jsx(
                        "button",
                        {
                          onClick: () => {
                          ...
                          children: "Lanjutkan Pengisian Data"
                        }
                      )
                    ] })
                  ]
