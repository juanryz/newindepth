...
const PaymentCountdown = ({ scheduleDate, startTime }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-2", children: [
    /* @__PURE__ */ jsx("span", { className: "w-2 h-2 rounded-full bg-red-500 animate-ping" }),
    /* @__PURE__ */ jsx("span", { className: "text-sm font-black text-red-600 dark:text-red-400 tabular-nums", children: timeLeft })
  ] });
};
          ...
          /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 relative z-10", children: [
            ...
            isPatient && activeBooking?.status === "pending_payment" && /* @__PURE__ */ jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxs(GlassPanel, { className: "!border-red-500/40 dark:!border-red-500/20 bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-950/20 dark:to-rose-950/10 p-6 flex flex-col md:flex-row items-center gap-6 shadow-2xl shadow-red-500/10", children: [
                  /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 p-2 opacity-10 group-hover:opacity-20 transition-opacity", children: /* @__PURE__ */ jsx("svg", { className: "w-24 h-24 text-red-500", fill: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" }) }) }),
                  /* @__PURE__ */ jsx("div", { className: "w-14 h-14 bg-red-600 text-white rounded-2xl flex items-center justify-center flex-shrink-0 animate-bounce shadow-lg shadow-red-600/30", children: /* @__PURE__ */ jsx("svg", { className: "w-8 h-8", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.5", d: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center md:text-left z-10", children: [
                    /* @__PURE__ */ jsx("h3", { className: "text-xl font-black text-red-900 dark:text-red-200 leading-tight", children: "Konfirmasi Pembayaran Diperlukan!" }),
                    /* @__PURE__ */ jsxs("p", { className: "text-sm text-red-700/80 dark:text-red-400 font-bold mt-1", children: [
                      "Segera selesaikan pembayaran untuk mengamankan slot Anda. ",
                      /* @__PURE__ */ jsx("span", { className: "text-red-600 dark:text-red-500 underline uppercase tracking-tighter", children: "Batas waktu 2 jam sebelum jadwal dimulai." })
                    ] }),
                    /* @__PURE__ */ jsx(PaymentCountdown, { scheduleDate: activeBooking.schedule?.date, startTime: activeBooking.schedule?.start_time })
                  ] }),
                  /* @__PURE__ */ jsxs(
                    Link,
                    {
                      ...
                      children: [
                        "Bayar Sekarang",
                        /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3", d: "M14 5l7 7m0 0l-7 7m7-7H3" }) })
                      ]
                    }
                  )
                ] })
