    ...
    /* @__PURE__ */ jsx("div", { id: "layanan-cards", className: "py-24 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-col items-center gap-4", children: [
          ...
          isOnline && /* @__PURE__ */ jsx("p", { className: "text-sm text-blue-600 dark:text-blue-400 font-medium", children: "Sesi online via video call — harga tanpa diskon" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp(0), className: "bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-white/60 dark:border-gray-800/50 rounded-[3rem] p-8 shadow-xl hover:shadow-2xl transition-all duration-500 relative flex flex-col h-full", children: [
          hasActiveDiscount(regulerPkg) && /* @__PURE__ */ jsx("div", { className: "absolute -top-3 -right-3 w-16 h-16 flex items-center justify-center z-10", children: /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-rose-500 rounded-full flex items-center justify-center shadow-xl shadow-rose-500/40 animate-pulse", children: /* @__PURE__ */ jsxs("span", { className: "text-white font-black text-[9px] text-center leading-none uppercase", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-6 border-b border-gray-200 dark:border-gray-700 pb-6 mt-2", children: [
            ...
            !isOnline && regulerPkg.discount_percentage > 0 && regulerPkg.discount_ends_at && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/50 dark:bg-gray-800/50 text-gold-600 dark:text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: [
              "⏳ Diskon ",
              regulerPkg.discount_percentage,
              "% s/d ",
        ...
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp(0.1), className: "relative bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-gold-500/50 rounded-[3rem] p-8 shadow-2xl hover:shadow-[0_20px_40px_rgba(208,170,33,0.15)] transition-all duration-500 flex flex-col h-full", children: [
          ...
          hasActiveDiscount(premiumPkg) && /* @__PURE__ */ jsx("div", { className: "absolute -top-3 -right-3 w-16 h-16 flex items-center justify-center z-10", children: /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-rose-500 rounded-full flex items-center justify-center shadow-xl shadow-rose-500/40 animate-pulse", children: /* @__PURE__ */ jsxs("span", { className: "text-white font-black text-[9px] text-center leading-none uppercase", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-6 border-b border-gray-200 dark:border-gray-700 pb-6 mt-2", children: [
            ...
            !isOnline && premiumPkg.discount_percentage > 0 && premiumPkg.discount_ends_at && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/50 dark:bg-gray-800/50 text-gold-600 dark:text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: [
              "⏳ Diskon ",
              premiumPkg.discount_percentage,
              "% s/d ",
        ...
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp(0.2), className: "relative bg-gray-900/90 dark:bg-black/40 backdrop-blur-xl border border-gray-700/50 rounded-[3rem] p-8 shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col h-full", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-6 border-b border-gray-700 pb-6 mt-2", children: [
            ...
            !isOnline && vipPkg.discount_percentage > 0 && vipPkg.discount_ends_at && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 mt-3 px-2.5 py-1 bg-white/10 text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: [
              "⏳ Diskon ",
              vipPkg.discount_percentage,
              "% s/d ",
