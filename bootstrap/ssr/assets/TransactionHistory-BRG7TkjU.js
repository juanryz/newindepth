...
function TransactionHistory({ bookings, profileProgress }) {
  const isProfileComplete = profileProgress ? profileProgress.percentage === 100 : true;
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight", children: "Riwayat Transaksi & Reservasi" }),
      children: [
          ...
          bookings.data.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100 dark:divide-gray-800", children: bookings.data.map((booking) => {
              ...
              return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors", children: [
                ...
                /* @__PURE__ */ jsxs("td", { className: "py-4 px-4 align-top", children: [
                  isCompleted && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400", children: "Selesai" }),
                ...
                /* @__PURE__ */ jsx("td", { className: "py-4 px-4 align-top text-right whitespace-nowrap", children: /* @__PURE__ */ jsx(
                  Link,
                  {
