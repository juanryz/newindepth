...
function KontakKami({ auth }) {
  ...
  clinicInfo?.whatsapp || "6282220800034";
  ...
  clinicInfo?.mapsUrl || "https://maps.app.goo.gl/KUmgnva1hi9vvrNP7";
  const bankAccounts = clinicInfo?.bankAccounts || [];
  const bankFaqAnswer = bankAccounts.length > 0 ? bankAccounts.map((b) => `${b.bank} No. ${b.account} a.n. ${b.holder}`).join(", ") + ". Konfirmasi via WhatsApp setelah transfer." : `Transfer ke rekening resmi ${clinicName}. Konfirmasi via WhatsApp setelah transfer.`;
  const FAQ_DATA = [
    {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    ...
    /* @__PURE__ */ jsxs(Head, { title: "Kontak Kami | InDepth Clinic", children: [
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Hubungi InDepth Mental Wellness Semarang via WhatsApp, telepon, atau kunjungi langsung di Jalan Kelud Raya 34B, Semarang. Konsultasi awal gratis untuk menentukan paket hipnoterapi yang tepat." }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: "kontak InDepth Clinic, hubungi hipnoterapi Semarang, alamat InDepth Semarang, WhatsApp klinik hipnoterapi, konsultasi hipnoterapi Semarang, InDepth Kelud Raya" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Kontak Kami | InDepth Clinic Semarang" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Hubungi InDepth Mental Wellness via WhatsApp atau kunjungi klinik kami di Semarang. Konsultasi awal untuk hipnoterapi tersedia setiap hari." }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Kontak Kami | InDepth Clinic Semarang" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Hubungi InDepth Mental Wellness Semarang. Konsultasi hipnoterapi tersedia via WhatsApp setiap hari." }),
