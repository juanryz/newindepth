...
import { Clock, Search, LayoutList, CheckCircle2, XCircle, AlertTriangle } from "lucide-react";
...
function TransactionsIndex({ transactions, therapists = [] }) {
  ...
  const statusCounts = useMemo(() => {
    ...
    transactions.data.forEach((tx) => {
      if (counts[tx.status] !== void 0) counts[tx.status]++;
    });
    return counts;
  }, [transactions.data]);
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative py-12 bg-slate-50 dark:bg-slate-950 min-h-screen overflow-hidden transition-colors duration-700", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8 relative z-10", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl border border-white dark:border-slate-800 p-6 rounded-[2.5rem] shadow-[0_10px_30px_rgba(0,0,0,0.04)] dark:shadow-none transition-all duration-500", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-4 items-start lg:items-center", children: [
              /* @__PURE__ */ jsxs("div", { className: "relative flex-1 w-full group", children: [
                /* @__PURE__ */ jsx(Search, { className: "absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-indigo-500 transition-colors" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1.5 bg-slate-100/60 dark:bg-slate-800/40 p-1.5 rounded-2xl border border-slate-200/30 dark:border-slate-700/30", children: statusTabs.map((tab) => {
                const Icon = tab.icon;
                ...
                return /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: `flex items-center gap-1.5 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${isActive ? `bg-white dark:bg-slate-700 text-${tab.color}-600 dark:text-${tab.color}-400 shadow-md` : "text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"}`,
                    children: [
                      /* @__PURE__ */ jsx(Icon, { className: "w-3.5 h-3.5" }),
                      tab.label,
                      /* @__PURE__ */ jsx("span", { className: `ml-1 px-1.5 py-0.5 rounded-md text-[9px] ${isActive ? `bg-${tab.color}-100 dark:bg-${tab.color}-900/30 text-${tab.color}-600 dark:text-${tab.color}-400` : "bg-slate-200/60 dark:bg-slate-700/60 text-slate-400"}`, children: statusCounts[tab.id] })
                    ]
                  },
                  tab.id
                );
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white/70 dark:bg-slate-900/40 backdrop-blur-3xl border border-white dark:border-slate-800 rounded-[3.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.1)] dark:shadow-none overflow-hidden transition-all duration-700", children: [
              /* @__PURE__ */ jsx("div", { className: "overflow-x-auto p-4 sm:p-0", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
                ...
                /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-800/50", children: filteredTransactions.map((tx) => {
                  ...
                  return /* @__PURE__ */ jsxs("tr", { className: "group hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-all", children: [
                    ...
                    /* @__PURE__ */ jsx("td", { className: "px-6 py-5", children: tx.payment_method === "cash" ? /* @__PURE__ */ jsx("span", { className: "px-3 py-1.5 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 text-[10px] font-black uppercase tracking-widest rounded-lg border border-emerald-200 dark:border-emerald-800", children: "💵 Bayar Tunai" }) : tx.payment_proof ? /* @__PURE__ */ jsxs(
                      "a",
                      {
                    ...
                    ) : tx.payment_method === "cash" || tx.payment_method === "Tunai" ? /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black text-emerald-600 uppercase tracking-widest", children: "Tunai (Klinik)" }) : /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black text-rose-500 uppercase tracking-widest italic", children: "Belum Upload" }) }),
                    ...
                    /* @__PURE__ */ jsxs("td", { className: "px-6 py-5 text-center", children: [
                      tx.status === "pending" && hasPermission("edit transactions") && /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-2", children: [
                        tx.payment_proof || tx.payment_method === "cash" || tx.payment_method === "Tunai" ? hasPermission("validate transactions") && /* @__PURE__ */ jsx(
                          "button",
                          {
                            disabled: validating,
                        ...
                        hasPermission("reject transactions") && /* @__PURE__ */ jsx(
                          "button",
                          {
              ...
              filteredTransactions.length === 0 && /* @__PURE__ */ jsxs("div", { className: "py-32 text-center", children: [
                /* @__PURE__ */ jsx("div", { className: "bg-slate-100 dark:bg-slate-800 w-24 h-24 rounded-[2rem] flex items-center justify-center mx-auto mb-6 shadow-inner", children: /* @__PURE__ */ jsx(Search, { className: "w-10 h-10 text-slate-300" }) }),
                /* @__PURE__ */ jsx("p", { className: "text-slate-500 dark:text-slate-600 font-black uppercase tracking-[0.2em] italic", children: searchQuery || statusFilter !== "all" ? "Tidak ada transaksi yang cocok dengan filter." : "Bersih. Tidak ada transaksi tertunda." }),
                (searchQuery || statusFilter !== "all") && /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => {
                      setSearchQuery("");
