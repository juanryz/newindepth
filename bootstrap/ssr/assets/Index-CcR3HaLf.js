...
import { Users, ShieldCheck, Building2, CheckCircle, ShieldAlert, ChevronRight, Search, UserCircle, Eye, Edit, Trash2, Key, Plus, UserPlus, AlertCircle } from "lucide-react";
            ...
            /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0 pb-12", children: /* @__PURE__ */ jsxs(AnimatePresence, { mode: "wait", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "w-full overflow-x-auto md:overflow-visible pb-12", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-100 dark:divide-gray-800", children: [
                        ...
                        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 dark:divide-gray-800", children: users.data.map((user2) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-all group", children: [
                          /* @__PURE__ */ jsx("td", { className: "px-8 py-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                            /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-2xl bg-indigo-100 dark:bg-indigo-900/40 flex items-center justify-center text-indigo-600 dark:text-indigo-400", children: user2.profile_photo_url ? /* @__PURE__ */ jsx("img", { src: user2.profile_photo_url, alt: "", className: "w-full h-full rounded-2xl object-cover" }) : /* @__PURE__ */ jsx(UserCircle, { className: "w-6 h-6" }) }),
                            /* @__PURE__ */ jsxs("div", { children: [
                          ...
                          /* @__PURE__ */ jsx("td", { className: "px-8 py-6 text-center", children: /* @__PURE__ */ jsx(ProfileCompletionBadge, { completion: user2.profile_completion }) }),
                          /* @__PURE__ */ jsx("td", { className: "px-8 py-6 text-center", children: user2.email_verified_at ? /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 rounded-lg text-[9px] font-black uppercase tracking-widest border border-emerald-100 dark:border-emerald-800", children: [
              ...
              activeTab === "groups" && /* @__PURE__ */ jsxs(
                motion.div,
                {
                  ...
                  className: "space-y-6",
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex justify-end items-center bg-indigo-50/50 dark:bg-indigo-950/20 p-6 rounded-[2rem] border border-indigo-100/50 dark:border-indigo-900/30", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden", children: [
                      groups?.data?.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-20", children: [
                        ...
                        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-gray-50/50 dark:bg-gray-800/50", children: ["Grup / Institusi", "PIC", "Anggota", "Total", "Status", "Aksi"].map((h) => /* @__PURE__ */ jsx("th", { className: "text-left text-[10px] font-black uppercase tracking-widest text-gray-400 px-6 py-4", children: h }, h)) }) }),
                        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 dark:divide-gray-800/50", children: groups?.data?.map((g) => {
                          ...
                          return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-colors", children: [
                            ...
                            /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
                              /* @__PURE__ */ jsx("p", { className: "text-sm font-black text-gray-900 dark:text-white", children: formatCurrency(g.total_amount) }),
                              /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400", children: g.payment_method })
                            ] }),
