...
import { Users, ShieldCheck, Building2, CheckCircle, ShieldAlert, ChevronRight, Search, UserCircle, Eye, Edit, Trash2, Key, ChevronLeft, UserPlus, AlertCircle } from "lucide-react";
    ...
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
          ...
          activeTab === "users" && hasPermission("create users") ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsxs(
              Link,
              {
