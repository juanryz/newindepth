...
function ServiceFlowGuide({ user, profileProgress, activeBooking, isProcessingScreening: isProcessingScreening2 }) {
  if (!user) return null;
  ...
  const isScreeningDone = !!user.screening_completed_at || isProcessingScreening2;
...
function ScreeningBanner({ screeningResult, canTakeScreening, daysUntilNextScreening, isProfileComplete, isProcessingScreening: isProcessingScreening2 }) {
  const [isSummaryExpanded, setIsSummaryExpanded] = useState(false);
  if (isProcessingScreening2) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative py-10 min-h-screen", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 relative z-10", children: [
            ...
            canSeeManagement && /* @__PURE__ */ jsx("div", { className: "space-y-10", children: /* @__PURE__ */ jsxs("section", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: [
                ...
                (isSuperAdmin || permissions.includes("view courses")) && /* @__PURE__ */ jsx(
                  QuickCard,
                  {
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("section", { children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
                    ...
                    !isAdmin && !isTherapist && /* @__PURE__ */ jsx(
                      QuickCard,
                      {
