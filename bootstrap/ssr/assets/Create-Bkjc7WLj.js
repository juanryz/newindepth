            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl shadow-sm sm:rounded-2xl border border-gray-100 dark:border-gray-700/50 overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
                packageOptions.is_vip_only ? /* @__PURE__ */ jsx("p", { className: "text-sm text-amber-600 dark:text-amber-400 font-bold mb-6", children: "⚠️ Berdasarkan hasil skrining, kondisi Anda memerlukan penanganan intensif (Paket VIP)." }) : /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500 dark:text-gray-400 mb-6", children: [
                  ...
                  packageOptions.recommended === "hipnoterapi" ? "Paket Hipnoterapi" : "Paket Premium",
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-4", children: [
                        /* @__PURE__ */ jsx("h4", { className: "font-black text-sm uppercase tracking-widest text-gray-900 dark:text-white", children: pkg.name }),
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
                        pkg.original_price && /* @__PURE__ */ jsxs("div", { className: "text-[10px] text-gray-400 dark:text-gray-500 line-through", children: [
                          "Rp ",
                          new Intl.NumberFormat("id-ID").format(pkg.original_price)
                        ] }),
                        /* @__PURE__ */ jsxs("p", { className: "text-xl font-black text-gold-600 dark:text-gold-400", children: [
                          "Rp ",
                          new Intl.NumberFormat("id-ID").format(pkg.price)
                        ] }),
                        /* @__PURE__ */ jsx("p", { className: "text-[9px] font-bold text-gray-400 dark:text-gray-500 mt-1 uppercase tracking-widest", children: "*Harga belum termasuk PPN 11%" })
                      ] }),
                      /* @__PURE__ */ jsx("div", { className: "text-[11px] font-medium text-gray-600 dark:text-gray-200 leading-relaxed prose prose-sm dark:prose-invert max-w-none", dangerouslySetInnerHTML: { __html: pkg.description } })
                    ]
                  },
                  pkg.id
                )) }),
