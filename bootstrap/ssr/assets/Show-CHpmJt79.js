...
import { Clock, CheckCircle, AlertTriangle, Edit2, Building2, MapPin, User, Phone, Mail, FileText, Printer, CreditCard, Banknote, Users, Plus, Eye, UserCheck, Trash2, ChevronLeft, AlertCircle } from "lucide-react";
...
function GroupBookingsShow({ group, invoiceData, schedules = [], bookingPackages = [], paymentMethods = ["Transfer Bank", "Cash"] }) {
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    !complete && /* @__PURE__ */ jsx(
                      Link,
                      {
                        ...
                        children: /* @__PURE__ */ jsx(UserCheck, { className: "w-4 h-4" })
                      }
                    ),
                    /* @__PURE__ */ jsx(
                      Link,
                    ...
                    group.payment_status === "pending" && /* @__PURE__ */ jsx(
                      "button",
                      {
