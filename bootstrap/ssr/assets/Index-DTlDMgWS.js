...
`;
function OrderManagementIndex({ schedules = [], bookings = [], transactions = [], therapists = [], availableSchedules = [], filters = {}, clinicSettings = {} }) {
                      ...
                      txCurrent.map((tx) => {
                        ...
                        return /* @__PURE__ */ jsxs("tr", { className: "group hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-all", children: [
                          ...
                          /* @__PURE__ */ jsx("td", { className: "px-6 py-5", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                            ...
                            /* @__PURE__ */ jsx("span", { className: `mt-1 text-[8px] font-black uppercase tracking-widest px-2 py-0.5 rounded-md border w-fit ${tx.payment_method === "cash" ? "bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800" : "bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800"}`, children: tx.payment_method === "cash" ? "💵 Cash" : "🏦 Transfer" }),
                          ...
                          /* @__PURE__ */ jsx("td", { className: "px-6 py-5", children: tx.payment_method === "cash" ? /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1 px-3 py-1 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800 text-[9px] font-black uppercase rounded-lg", children: "💵 Bayar di Klinik" }) : tx.payment_proof ? /* @__PURE__ */ jsxs("a", { href: `/storage/${tx.payment_proof}`, target: "_blank", rel: "noreferrer", className: "inline-flex items-center gap-2 group/proof", children: [
                          ...
                          /* @__PURE__ */ jsx("td", { className: "px-6 py-5 text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2", children: [
                            tx.status === "pending" && /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-2", children: [
                              tx.payment_proof || tx.payment_method === "cash" ? /* @__PURE__ */ jsx("button", { disabled: validatingTx === tx.id, onClick: () => setValidationChoiceTx(tx), className: `px-4 py-2 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg disabled:opacity-50 ${tx.payment_method === "cash" ? "bg-emerald-600 hover:bg-emerald-500 shadow-emerald-500/20" : "bg-emerald-600 hover:bg-emerald-500 shadow-emerald-500/20"}`, children: validatingTx === tx.id ? "..." : tx.payment_method === "cash" ? "Konfirmasi Cash" : "Validasi" }) : /* @__PURE__ */ jsx("span", { className: "px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-400 text-[9px] font-black uppercase rounded-xl border border-gray-200 dark:border-gray-700 cursor-not-allowed", children: "Bukti Belum Ada" }),
