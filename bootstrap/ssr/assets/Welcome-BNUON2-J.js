  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "py-24 relative z-10 overflow-hidden bg-white/20 dark:bg-gray-900/20 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10 relative z-10 w-full mb-16 items-stretch", children: [
        /* @__PURE__ */ jsxs(Link, { href: "/metode#indepth-trance", className: "bg-white/80 dark:bg-gray-800/80 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-white/60 dark:border-gray-700/50 shadow-xl dark:shadow-[0_8px_30px_rgba(0,0,0,0.2)] text-left relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300 h-full flex flex-col", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 h-full flex flex-col", children: [
            /* @__PURE__ */ jsx("div", { className: "w-14 h-14 bg-gradient-to-br from-gold-500/10 to-gold-500/5 dark:from-gold-500/20 dark:to-gold-500/10 border border-gold-500/20 rounded-2xl flex items-center justify-center mb-6 shrink-0 group-hover:bg-gold-500 group-hover:text-white transition-colors duration-500", children: /* @__PURE__ */ jsx("svg", { className: "w-7 h-7 text-gold-600 dark:text-gold-400 group-hover:text-white", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" }) }) }),
            /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-gray-900 dark:text-white mb-2 leading-tight group-hover:text-gold-600 dark:group-hover:text-gold-400 transition-colors", children: "InDepth Trance State" }),
            /* @__PURE__ */ jsx("p", { className: "font-bold text-gold-600 dark:text-gold-400 mb-3 text-sm", children: "Akses penuh tubuh hingga level sel" }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-300 font-medium text-sm leading-relaxed mt-auto", children: "Memfasilitasi komunikasi langsung dengan kecerdasan tubuh untuk perubahan cepat." }),
            /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center gap-2 text-gold-600 dark:text-gold-400 font-bold text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity", children: [
              "Pelajari Detail ",
        ...
        /* @__PURE__ */ jsxs(Link, { href: "/metode#supreme-trance", className: "bg-white/80 dark:bg-gray-800/80 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-white/60 dark:border-gray-700/50 shadow-xl dark:shadow-[0_8px_30px_rgba(0,0,0,0.2)] text-left relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300 h-full flex flex-col", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 h-full flex flex-col", children: [
            ...
            /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-gray-900 dark:text-white mb-2 leading-tight group-hover:text-gold-600 dark:group-hover:text-gold-400 transition-colors", children: "Supreme Trance State" }),
            /* @__PURE__ */ jsx("p", { className: "font-bold text-gold-600 dark:text-gold-400 mb-3 text-sm", children: "Aktivasi kesadaran tertinggi dan jiwa" }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-300 font-medium text-sm leading-relaxed mt-auto", children: "Digunakan pada kondisi yang membutuhkan integrasi kesadaran tingkat lanjut." }),
            /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center gap-2 text-gold-600 dark:text-gold-400 font-bold text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity", children: [
              "Pelajari Detail ",
              /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M17 8l4 4m0 0l-4 4m4-4H3" }) })
            ] })
        ...
        /* @__PURE__ */ jsxs(Link, { href: "/metode#indepth-solution", className: "bg-white/80 dark:bg-gray-800/80 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-white/60 dark:border-gray-700/50 shadow-xl dark:shadow-[0_8px_30px_rgba(0,0,0,0.2)] text-left relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300 h-full flex flex-col", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 h-full flex flex-col", children: [
            ...
            /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-gray-900 dark:text-white mb-2 leading-tight group-hover:text-gold-600 dark:group-hover:text-gold-400 transition-colors", children: "InDepth Solution" }),
            /* @__PURE__ */ jsx("p", { className: "font-bold text-gold-600 dark:text-gold-400 mb-3 text-sm", children: "Solusi tercepat versi tubuh Anda" }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-300 font-medium text-sm leading-relaxed mt-auto", children: "Pendekatan yang membantu tubuh menemukan jalur penyelesaian internalnya secara alami." }),
            /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center gap-2 text-gold-600 dark:text-gold-400 font-bold text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity", children: [
              "Pelajari Detail ",
              /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M17 8l4 4m0 0l-4 4m4-4H3" }) })
            ] })
    ...
    /* @__PURE__ */ jsxs("div", { id: "paket", className: "py-24 relative z-10 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-8 flex flex-col items-center gap-3 animate-pulse", children: /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center justify-center gap-3 bg-gradient-to-r from-gold-500/20 to-yellow-500/20 border border-gold-500/30 rounded-full px-6 py-3 shadow-[0_4px_20px_rgba(208,170,33,0.15)]", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-stretch", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-white/60 dark:border-gray-800/50 rounded-[3rem] p-8 shadow-xl hover:shadow-2xl transition-all duration-500 group relative flex flex-col h-full w-full", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6 flex-grow-0 border-b border-gray-200 dark:border-gray-700 pb-6 mt-2 relative z-10", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5 mb-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-gray-400 line-through decoration-rose-500/50 decoration-2", children: "Rp 4.000.000" }),
                /* @__PURE__ */ jsx("span", { className: "text-3xl font-extrabold text-gray-900 dark:text-white", children: "Rp 2.000.000" })
              ] }),
            ...
            /* @__PURE__ */ jsx(Link, { href: "/register?package=hipnoterapi", className: "block text-center py-4 px-6 rounded-full border-2 border-gold-500 text-gold-600 dark:text-gold-400 font-bold hover:bg-gold-500 hover:text-white transition-all duration-300 mt-auto", children: "Pilih Reguler" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "relative bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-gold-500/50 rounded-[3rem] p-8 shadow-2xl hover:shadow-[0_20px_40px_rgba(208,170,33,0.15)] transition-all duration-500 group flex flex-col h-full w-full", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6 flex-grow-0 border-b border-gray-200 dark:border-gray-700 pb-6 mt-2 relative z-10", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5 mb-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-gray-400 line-through decoration-rose-500/50 decoration-2", children: "Rp 8.000.000" }),
                /* @__PURE__ */ jsx("span", { className: "text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gold-500 to-yellow-500", children: "Rp 4.000.000" })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-sm", children: "/ sesi" }),
              /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center gap-1.5 mt-3", children: /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1 px-2.5 py-1 bg-white/50 dark:bg-gray-800/50 text-gold-600 dark:text-gold-400 text-[9px] font-bold uppercase tracking-widest rounded-full border border-gold-500/30", children: "⏳ s/d 21 Mei 2026" }) }),
              /* @__PURE__ */ jsx("p", { className: "text-[9px] font-bold text-gray-500 mt-3 uppercase tracking-widest", children: "*Harga belum termasuk PPN 11%" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative bg-gray-900/90 dark:bg-black/40 backdrop-blur-xl border border-gray-700/50 rounded-[3rem] p-8 shadow-xl hover:shadow-2xl transition-all duration-500 group flex flex-col h-full w-full", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mb-6 flex-grow-0 border-b border-gray-700 pb-6 relative z-10", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5 mb-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-gray-500 line-through decoration-rose-500/50 decoration-2", children: "Rp 16.000.000" }),
