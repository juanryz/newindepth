      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-6 md:py-12 min-h-[calc(100dvh-64px)] bg-gray-50/50 dark:bg-gray-900/50", children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-10", children: [
              ...
              /* @__PURE__ */ jsxs("section", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "pl-8", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
                    /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-2 p-3 rounded-lg border cursor-pointer flex-1 justify-center transition-colors ${data.status_medis === "Ya" ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200" : "border-gray-200 dark:border-gray-700"}`, children: [
                    ...
                    /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-2 p-3 rounded-lg border cursor-pointer flex-1 justify-center transition-colors ${data.status_medis === "Tidak" ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200" : "border-gray-200 dark:border-gray-700"}`, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/60 backdrop-blur-xl border border-gray-100 dark:border-gray-700/50 rounded-2xl shadow-lg p-6 sm:p-10", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "font-bold mb-4 dark:text-gray-100", children: "PASAL 14 - PERNYATAAN AKHIR" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/60 backdrop-blur-xl border border-gray-100 dark:border-gray-700/50 rounded-2xl shadow-lg p-6 sm:p-10", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-sm", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold mb-2", children: "1. Kebijakan Privasi" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-sm", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold mb-2", children: "2. Kebijakan Non-Refund" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-sm", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold mb-2", children: "3. Perjanjian Afiliasi" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-sm", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold mb-2", children: "4. Perjanjian Produk Digital & Kelas" }),
