...
function Train({ agent, instructions }) {
  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Link, { href: route("admin.internal-ai.index"), className: "text-sm text-indigo-500 hover:text-indigo-700 font-medium mb-2 inline-block", children: "← Kembali ke Manajemen Agent" }),
        /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-black text-gray-900 dark:text-white", children: [
          "🧠 Training: ",
          agent.name
        ] })
      ] }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: `Training - ${agent.name}` }),
        /* @__PURE__ */ jsxs("div", { className: "py-8 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-3xl p-5 mb-6 border border-gray-200/60 dark:border-gray-700/50 flex items-center gap-4", children: [
            /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-2xl bg-indigo-100 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 flex items-center justify-center text-xl flex-shrink-0", children: "🤖" }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsx("p", { className: "font-black text-gray-900 dark:text-white", children: agent.name }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 truncate", children: agent.description || "Tidak ada deskripsi." })
            ] }),
            /* @__PURE__ */ jsx("span", { className: `px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${agent.is_active ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600" : "bg-gray-100 dark:bg-gray-700 text-gray-400"}`, children: agent.is_active ? "Aktif" : "Nonaktif" })
          ] }),
          agent.system_prompt && /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 dark:bg-gray-900 rounded-2xl p-4 mb-6 border border-gray-200 dark:border-gray-700", children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2", children: "🧩 System Prompt Dasar" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400 leading-relaxed whitespace-pre-wrap", children: agent.system_prompt })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 rounded-3xl p-5 mb-8 border border-indigo-200/50 dark:border-indigo-800/30", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-indigo-700 dark:text-indigo-300 mb-1", children: "💡 Cara Training" }),
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-600 dark:text-gray-400 leading-relaxed", children: [
              ...
              " untuk hal yang harus dilakukan AI, dan ",
              /* @__PURE__ */ jsx("strong", { children: "DON'T" }),
              " untuk hal yang dilarang. Instruksi aktif akan otomatis diinjeksi ke dalam sistem saat karyawan chat dengan agent ini."
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
              ...
              /* @__PURE__ */ jsx(
                "input",
                {
                  ...
                  placeholder: activeTab === "do" ? "Contoh: Selalu jawab dengan sopan dan profesional" : "Contoh: Jangan memberikan informasi gaji karyawan lain",
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-3", children: currentItems.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-16 bg-white dark:bg-gray-800 rounded-3xl border border-dashed border-gray-300 dark:border-gray-700", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400 dark:text-gray-500 mt-1", children: "Tambahkan instruksi di atas untuk mulai melatih agent ini." })
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 shrink-0", children: editingId === item.id ? /* @__PURE__ */ jsxs(Fragment, { children: [
                    ...
                    /* @__PURE__ */ jsx("button", { onClick: () => toggleActive(item), className: `px-3 py-1 rounded-lg text-[10px] font-black uppercase ${item.is_active ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 hover:bg-emerald-200" : "bg-gray-100 dark:bg-gray-900 text-gray-400 hover:bg-gray-200"}`, children: item.is_active ? "Aktif" : "Nonaktif" }),
