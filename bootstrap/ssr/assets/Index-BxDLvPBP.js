...
import { Users, ShieldCheck, Building2, ChevronRight, Search, Plus, Mail, Phone, Eye } from "lucide-react";
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 pb-12 space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden", children: [
              groups.data.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-20", children: [
                ...
                /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "border-b border-gray-100 dark:border-gray-800", children: ["Nama Grup", "Kontak", "Anggota", "Jadwal", "Dibuat", "Aksi"].map((h) => /* @__PURE__ */ jsx("th", { className: "text-left text-[10px] font-black uppercase tracking-widest text-gray-400 px-6 py-4", children: h }, h)) }) }),
                /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 dark:divide-gray-800/50", children: groups.data.map((g) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-colors", children: [
                  ...
                  /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
                    g.email && /* @__PURE__ */ jsxs("p", { className: "text-xs font-bold text-gray-700 dark:text-gray-300 flex items-center gap-1.5", children: [
                      /* @__PURE__ */ jsx(Mail, { className: "w-3 h-3 text-gray-400 flex-shrink-0" }),
                      g.email
                    ] }),
                    g.phone && /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-400 flex items-center gap-1.5 mt-0.5", children: [
                  ...
                  /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-gray-600 dark:text-gray-400", children: g.schedule_id ? "✅ Terjadwal" : "—" }),
                    g.package_type && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400 mt-0.5", children: g.package_type })
                  ] }),
