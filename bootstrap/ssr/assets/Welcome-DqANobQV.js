        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-center gap-16 mb-24", children: [
          /* @__PURE__ */ jsx("div", { className: "w-full lg:w-5/12", children: /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative rounded-[2.5rem] overflow-hidden border border-gold-500/20 shadow-2xl aspect-[4/5] bg-gray-100 dark:bg-gray-800", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0", children: /* @__PURE__ */ jsx("img", { src: "/images/julius-bambang.png", alt: "Julius Bambang", className: "w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110" }) }),
