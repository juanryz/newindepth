...
import { CheckCircle2, Phone, Calendar, Fingerprint, Activity, ShieldCheck, Heart, Clock, CreditCard, ChevronRight, AlertTriangle, FileText, Download, ExternalLink, Clipboard, User, X, MapPin, Wifi, Save } from "lucide-react";
...
function scheduleLabel(s) {
  if (!s) return "—";
  const dateStr = (/* @__PURE__ */ new Date(s.date + "T12:00:00")).toLocaleDateString("id-ID", { weekday: "short", day: "numeric", month: "short" });
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-8", children: [
            /* @__PURE__ */ jsxs("div", { className: "lg:w-72 flex-shrink-0 space-y-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 pt-2", children: [
                /* @__PURE__ */ jsxs(Link, { href: route("admin.users.edit", userModel.id), className: "w-full py-4 bg-indigo-600 text-white font-black uppercase tracking-widest rounded-2xl hover:bg-indigo-700 transition-all text-[10px] shadow-lg shadow-indigo-600/20 flex items-center justify-center gap-2", children: [
                ...
                flash?.invoiceData && /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: () => setShowInvoice(true),
                    className: "w-full py-4 bg-emerald-500 text-white font-black uppercase tracking-widest rounded-2xl hover:bg-emerald-600 transition-all text-[10px] shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2",
                    children: [
                ...
                group && /* @__PURE__ */ jsxs("div", { className: "bg-indigo-50/50 dark:bg-indigo-950/10 rounded-[2rem] border border-indigo-100 dark:border-indigo-900/30 p-6 overflow-hidden relative", children: [
                  /* @__PURE__ */ jsx("div", { className: "absolute -right-8 -top-8 w-24 h-24 bg-indigo-500/10 rounded-full blur-2xl" }),
                  /* @__PURE__ */ jsxs("h4", { className: "flex items-center gap-2 text-[10px] font-black tracking-[0.2em] text-indigo-600 dark:text-indigo-500 uppercase mb-4", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-1.5 h-4 bg-indigo-500 rounded-full" }),
                    " Anggota Grup"
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-gray-400 uppercase", children: "Nama Grup" }),
                      /* @__PURE__ */ jsx("p", { className: "text-sm font-black text-gray-900 dark:text-white uppercase leading-tight", children: group.group_name }),
                      group.institution_name && group.institution_name !== group.group_name && /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-indigo-500 uppercase mt-0.5", children: group.institution_name })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-gray-400 uppercase", children: "Invoice Grup" }),
                      /* @__PURE__ */ jsx("p", { className: "text-xs font-black text-gray-600 dark:text-gray-400 font-mono tracking-wider", children: group.invoice_number })
                    ] }),
                    group.members && group.members.length > 0 && /* @__PURE__ */ jsxs("div", { className: "pt-2 border-t border-indigo-100 dark:border-indigo-900/40", children: [
                      /* @__PURE__ */ jsxs("p", { className: "text-[10px] font-black text-gray-400 uppercase mb-3 flex justify-between", children: [
                        /* @__PURE__ */ jsx("span", { children: "Daftar Rekan" }),
                        /* @__PURE__ */ jsxs("span", { className: "text-indigo-500", children: [
                          group.members.length,
                          " Org"
                        ] })
                      ] }),
                      /* @__PURE__ */ jsx("div", { className: "space-y-2 max-h-[160px] overflow-y-auto pr-1 custom-scrollbar", children: group.members.map((m) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 p-2 bg-white/60 dark:bg-gray-800/60 rounded-xl border border-indigo-50 dark:border-indigo-800/30", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-7 h-7 bg-indigo-100 dark:bg-indigo-900 text-indigo-600 dark:text-indigo-400 rounded-lg flex items-center justify-center text-[10px] font-black uppercase", children: m.user?.name.charAt(0) }),
                        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-gray-800 dark:text-gray-200 uppercase truncate", children: m.user?.name }),
                          /* @__PURE__ */ jsx("p", { className: `text-[8px] font-bold uppercase ${m.user?.id === userModel.id ? "text-indigo-500" : "text-gray-400"}`, children: m.user?.id === userModel.id ? "Saya" : "Anggota" })
                        ] })
                      ] }, m.id)) })
                    ] })
                  ] })
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/80 rounded-[2.5rem] border border-gray-100 dark:border-gray-700/50 p-8 shadow-sm", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
                      /* @__PURE__ */ jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-2", children: Object.entries(profileCompletion?.fields || {}).map(([key, data2]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-2.5 rounded-xl bg-gray-50/50 dark:bg-gray-900/40 border border-gray-100/50 dark:border-gray-700/30", children: [
                          /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-gray-500 uppercase tracking-tight truncate mr-2", children: data2.label }),
                          data2.filled ? /* @__PURE__ */ jsx(CheckCircle2, { className: "w-3.5 h-3.5 text-emerald-500 flex-shrink-0" }) : /* @__PURE__ */ jsx(AlertTriangle, { className: "w-3.5 h-3.5 text-rose-400 flex-shrink-0" })
                        ] }, key)) })
                      ] }),
                        ...
                        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 dark:divide-gray-800/50", children: bookings.map((booking) => {
                          ...
                          return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 dark:hover:bg-gray-900/20 transition-colors", children: [
                            ...
                            /* @__PURE__ */ jsxs("td", { className: "px-8 py-6 text-center", children: [
                              ...
                              booking.group_booking && /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-blue-500 font-bold uppercase mt-0.5", children: [
                                "Grup: ",
                                booking.group_booking.group_name
                              ] }),
                          ...
                          return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-emerald-50/20 dark:hover:bg-emerald-900/10 transition-colors", children: [
                            /* @__PURE__ */ jsx("td", { className: "px-6 py-5 text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
                              ...
                              /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
                                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black text-indigo-600 uppercase tracking-widest leading-tight", children: tx.payment_account_number || tx.payment_bank || "-" }),
                                (tx.payment_account_name || tx.payment_agreement_data?.payment_account_name) && /* @__PURE__ */ jsxs("span", { className: "text-[9px] font-bold text-gray-400 uppercase tracking-tighter mt-0.5", children: [
                                  "A.N. ",
                            ...
                            /* @__PURE__ */ jsx("td", { className: "px-6 py-5 text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
                              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black px-3 py-1 bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-lg border border-indigo-500/20 w-fit uppercase tracking-widest", children: isBooking ? "Booking" : tx.transactionable_type?.split("\\").pop() || "Lainnya" }),
                              /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-gray-800 dark:text-gray-200 mt-1", children: isBooking ? `${tx.transactionable?.package_type || "Package"}` : `${tx.transactionable?.title || "Layanan"}` }),
          ...
          /* @__PURE__ */ jsx(Modal, { show: !!selectedBooking, onClose: () => setSelectedBooking(null), maxWidth: "2xl", children: selectedBooking && /* @__PURE__ */ jsxs("div", { className: "p-8 space-y-8", children: [
            ...
            ].filter(Boolean).map((item, i) => /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              ...
              selectedBooking.session_checklist && Object.keys(selectedBooking.session_checklist).length > 0 && /* @__PURE__ */ jsxs("div", { className: "pt-4", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                  ...
                  selectedBooking.session_checklist.problem_score !== void 0 && selectedBooking.session_checklist.problem_score !== null && /* @__PURE__ */ jsxs("div", { className: "p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-800", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "flex-1 h-1 bg-gray-200 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "h-full bg-indigo-500", style: { width: `${selectedBooking.session_checklist.problem_score * 10}%` } }) })
                    ] })
                  ] }),
                  selectedBooking.session_checklist.final_problem_score !== void 0 && selectedBooking.session_checklist.final_problem_score !== null && /* @__PURE__ */ jsxs("div", { className: "p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-800", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "flex-1 h-1 bg-gray-200 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "h-full bg-emerald-500", style: { width: `${selectedBooking.session_checklist.final_problem_score * 10}%` } }) })
                    ] })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-800", children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: `text-xs font-bold ${selectedBooking.session_checklist.has_abreaction ? "text-rose-500" : "text-gray-400"}`, children: selectedBooking.session_checklist.has_abreaction ? "ADA ABREAKSI" : "TIDAK ADA" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-800", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Segel Hipnotis" }),
                    /* @__PURE__ */ jsx("p", { className: `text-xs font-bold ${selectedBooking.session_checklist.has_seal ? "text-emerald-500" : "text-gray-400"}`, children: selectedBooking.session_checklist.has_seal ? "TERSEGEL" : "TIDAK" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "p-3 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-800", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Uji Hasil" }),
                    /* @__PURE__ */ jsx("p", { className: `text-xs font-bold ${selectedBooking.session_checklist.has_result_test ? "text-emerald-500" : "text-gray-400"}`, children: selectedBooking.session_checklist.has_result_test ? "LOLOS UJI" : "TIDAK" })
                  ] }),
          ...
          /* @__PURE__ */ jsx(Modal, { show: showNewBookingModal, onClose: () => setShowNewBookingModal(false), maxWidth: "2xl", children: /* @__PURE__ */ jsxs("div", { className: "p-8", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-8", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("h3", { className: "text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Calendar, { className: "w-5 h-5 text-blue-600" }),
                  " Daftarkan Sesi Baru"
                ] }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1", children: "Sesi Ulang / Repeat Client" })
              ] }),
              /* @__PURE__ */ jsx("button", { onClick: () => setShowNewBookingModal(false), className: "p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-colors", children: /* @__PURE__ */ jsx(X, { className: "w-5 h-5 text-gray-400" }) })
            ] }),
            /* @__PURE__ */ jsxs("form", { onSubmit: submitNewBooking, className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
                /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsx(InputLabel, { value: "Mode Sesi", className: "!text-[10px] !font-black !uppercase !tracking-widest !text-gray-400" }),
                  /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: [
                    ...
                    "button",
                    {
                      ...
                      className: `flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-2xl border text-[10px] font-black uppercase tracking-widest transition-all ${data.session_type === mode.id ? "bg-blue-600 border-blue-600 text-white shadow-lg shadow-blue-600/20" : "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-500 hover:border-blue-400"}`,
                      children: [
                        /* @__PURE__ */ jsx(mode.icon, { className: "w-3.5 h-3.5" }),
                        mode.label
                      ]
                    },
                    mode.id
                  )) }),
                  /* @__PURE__ */ jsx(InputError, { message: errors.session_type })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsx(InputLabel, { value: "Pilih Paket", className: "!text-[10px] !font-black !uppercase !tracking-widest !text-gray-400" }),
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                      ...
                      children: [
                        ...
                        bookingPackages.map((pkg) => /* @__PURE__ */ jsxs("option", { value: pkg.slug, children: [
                          pkg.name,
                          " — Rp ",
                          new Intl.NumberFormat("id-ID").format(data.session_type === "online" ? pkg.online_price || pkg.price : pkg.price)
                        ] }, pkg.slug))
                      ]
                    }
                  ),
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Jadwal Konsultasi", className: "!text-[10px] !font-black !uppercase !tracking-widest !text-gray-400" }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    className: "w-full bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-2xl text-sm font-bold focus:ring-blue-500 focus:border-blue-500 transition-all p-3.5",
                    ...
                    children: [
                      /* @__PURE__ */ jsx("option", { value: "", children: "Pilih Jadwal Tersedia..." }),
                      availableSchedules.map((s) => /* @__PURE__ */ jsx("option", { value: s.id, children: scheduleLabel(s) }, s.id))
                    ]
                  }
                ),
                /* @__PURE__ */ jsx(InputError, { message: errors.schedule_id })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-blue-50/50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 rounded-3xl", children: [
                /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsx(InputLabel, { value: "Status Pembayaran", className: "!text-[10px] !font-black !uppercase !tracking-widest !text-gray-400" }),
                  /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: [
                    ...
                    "button",
                    {
                      ...
                      className: `flex-1 px-3 py-2.5 rounded-xl border text-[9px] font-black uppercase tracking-widest transition-all ${data.payment_status === s.id ? "bg-blue-600 border-blue-600 text-white shadow-md" : "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-500"}`,
                      children: s.label
                    },
                    s.id
                  )) }),
                  /* @__PURE__ */ jsx(InputError, { message: errors.payment_status })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1", children: "Estimasi Tagihan" }),
                  /* @__PURE__ */ jsxs("p", { className: "text-xl font-black text-blue-700 dark:text-blue-400", children: [
                    "Rp ",
                    new Intl.NumberFormat("id-ID").format(basePrice * 1.11)
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "text-[9px] font-bold text-blue-500 italic", children: "Sudah termasuk PPN 11%" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Catatan Internal / Keluhan", className: "!text-[10px] !font-black !uppercase !tracking-widest !text-gray-400" }),
                /* @__PURE__ */ jsx(
                  "textarea",
                  {
          ...
          showInvoice && flash?.invoiceData && /* @__PURE__ */ jsx(
            InvoiceModal,
            {
