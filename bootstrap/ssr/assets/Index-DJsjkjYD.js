      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg", children: /* @__PURE__ */ jsx("div", { className: "p-6 text-gray-900 dark:text-gray-100 overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200 dark:divide-gray-700", children: [
        ...
        /* @__PURE__ */ jsxs("tbody", { className: "bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700", children: [
          courses.map((course) => /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100", children: /* @__PURE__ */ jsx("a", { href: `/courses/${course.slug}`, target: "_blank", rel: "noreferrer", className: "hover:underline hover:text-indigo-600", children: course.title }) }),
            ...
            /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-medium space-x-3", children: [
              hasPermission("edit courses") && /* @__PURE__ */ jsx(Link, { href: route("admin.courses.edit", course.id), className: "text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300", children: "Edit" }),
              hasPermission("delete courses") && /* @__PURE__ */ jsx("button", { onClick: () => handleDelete(course.id, course.title), className: "text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300", children: "Hapus" })
            ] })
          ] }, course.id)),
