...
function CoursesForm({ course }) {
  ...
  const { data, setData, post, processing, errors } = useForm({
    ...
    // Inertia workaround for file uploads with PUT
  });
  ...
  const submit = (e) => {
    e.preventDefault();
    post(isEditing ? route("admin.courses.update", course.id) : route("admin.courses.store"), {
      forceFormData: true
    });
  };
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight", children: isEditing ? "Edit Kelas LMS" : "Tambah Kelas LMS Baru" }), children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", encType: "multipart/form-data", children: [
          ...
          /* @__PURE__ */ jsxs(
            "select",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("option", { value: "offline", children: "Offline (Tatap Muka)" })
              ]
            }
          ),
          /* @__PURE__ */ jsx(InputError, { message: errors.course_type, className: "mt-2" })
        ] }),
        data.course_type === "online" && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "online_platform", value: "Platform Online (Zoom, Meet, dll)" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
                id: "online_platform",
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors.online_platform, className: "mt-2" })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "online_link", value: "Link Meeting (Zoom/GMeet/dll)" }),
            /* @__PURE__ */ jsx(
              TextInput,
              {
                id: "online_link",
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-500 mt-1", children: "*Link ini hanya akan tampil bagi pasien yang sudah membeli kelas." }),
            /* @__PURE__ */ jsx(InputError, { message: errors.online_link, className: "mt-2" })
          ] })
        ] }),
        data.course_type === "offline" && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(InputLabel, { htmlFor: "location", value: "Lokasi / Alamat" }),
          /* @__PURE__ */ jsx(
            TextInput,
            {
              id: "location",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end mt-6 space-x-3 pt-4 border-t border-gray-100 dark:border-gray-700", children: [
        /* @__PURE__ */ jsx(Link, { href: route("admin.courses.index"), className: "text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md", children: "Batal" }),
