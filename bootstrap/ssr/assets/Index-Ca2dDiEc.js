...
function AdminBookingsIndex({ bookings, therapists, availableSchedules = [], allSchedules = [], bookingStatuses = [] }) {
  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      ...
      children: [
                ...
                bookings.map((booking) => /* @__PURE__ */ jsxs("tr", { className: "group hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-all", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-8 py-6", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-4", children: editingBooking === booking.id ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur p-4 rounded-2xl border border-white dark:border-slate-700 shadow-xl", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between group/tp", children: [
                      ...
                      hasPermission("assign bookings") && /* @__PURE__ */ jsx(
                        "button",
                        {
                          onClick: () => {
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2 pt-2 border-t border-slate-100 dark:border-slate-800/50", children: [
                      ...
                      ["confirmed", "in_progress"].includes(booking.status) && hasPermission("edit bookings") && /* @__PURE__ */ jsxs(Fragment, { children: [
                        /* @__PURE__ */ jsx(
                          "button",
                          {
                      ...
                      ["no_show", "cancelled", "completed"].includes(booking.status) && hasPermission("edit bookings") && /* @__PURE__ */ jsx(
                        "button",
                        {
                          onClick: () => {
        ...
        /* @__PURE__ */ jsx(Modal, { show: fixingBooking !== null, onClose: () => {
          setFixingBooking(null);
          resetFix();
        }, children: /* @__PURE__ */ jsxs("form", { onSubmit: handleFix, className: "p-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-gray-900 dark:text-white mb-1", children: "Koreksi Booking" }),
          /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400 mb-1", children: [
            "Pasien: ",
            /* @__PURE__ */ jsx("strong", { children: fixingBooking?.patient?.name })
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400 mb-6", children: [
            "Jadwal tercatat: ",
            fixingBooking?.schedule?.date,
            " pukul ",
            fixingBooking?.schedule?.start_time?.substring(0, 5),
            " — Status: ",
            /* @__PURE__ */ jsx("span", { className: "font-bold text-rose-500", children: fixingBooking?.status })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "fix_schedule_id", value: "Pilih Jadwal yang Benar" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
                id: "fix_schedule_id",
                ...
                children: [
                  ...
                  allSchedules.map((s) => /* @__PURE__ */ jsxs("option", { value: s.id, children: [
                    ...
                    " ",
                    "— ",
                    s.therapist?.name ?? "Tanpa Terapis",
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
            /* @__PURE__ */ jsx(InputLabel, { htmlFor: "fix_status", value: "Set Status Booking" }),
            /* @__PURE__ */ jsx(
              "select",
              {
                id: "fix_status",
                ...
                required: true,
                children: bookingStatuses.map((s) => /* @__PURE__ */ jsx("option", { value: s, children: s }, s))
              }
            )
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-6 flex justify-end gap-3", children: [
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: fixing ? "Menyimpan..." : "Simpan Koreksi"
              }
            )
          ] })
        ] }) })
