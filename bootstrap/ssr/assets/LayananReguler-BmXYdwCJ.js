...
function LayananReguler({ auth, packages = [] }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    ...
    /* @__PURE__ */ jsxs(Head, { title: "Hipnoterapi Reguler Semarang — Mengatasi Overthinking, Kecemasan, dan Kebiasaan Buruk | InDepth", children: [
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Paket Hipnoterapi Reguler InDepth Semarang: solusi efektif untuk overthinking, kecemasan, fobia, insomnia, dan kebiasaan buruk. Sesi privat dengan terapis bersertifikat, proses terstruktur dan aman." }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: "hipnoterapi reguler Semarang, mengatasi overthinking, terapi kecemasan, hipnoterapi fobia, terapi insomnia, hipnoterapi kebiasaan buruk, InDepth Semarang" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Hipnoterapi Reguler Semarang — Mengatasi Overthinking, Kecemasan & Kebiasaan Buruk | InDepth" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Paket Reguler InDepth: hipnoterapi privat untuk overthinking, kecemasan, fobia, insomnia, dan kebiasaan buruk. Terapis bersertifikat di Semarang." }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Hipnoterapi Reguler Semarang | InDepth" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Hipnoterapi privat untuk overthinking, kecemasan, fobia, insomnia. Terapis bersertifikat di Semarang." }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-white/60 dark:border-gray-700/50 rounded-[2.5rem] p-10 shadow-xl inline-block w-full", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center md:text-left", children: [
            ...
            hasDiscount && /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-400 line-through decoration-rose-500/50 decoration-2 mb-1", children: formatPrice(regulerPkg.base_price) }),
            /* @__PURE__ */ jsx("p", { className: "text-3xl font-black text-gray-900 dark:text-white", children: formatPrice(displayPrice || regulerPkg.base_price) }),
            hasDiscount && regulerPkg.discount_ends_at && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 mt-2 px-3 py-1 bg-rose-500/10 text-rose-600 dark:text-rose-400 text-xs font-bold uppercase tracking-widest rounded-full border border-rose-500/20", children: [
              "Diskon ",
