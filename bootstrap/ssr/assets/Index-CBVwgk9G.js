...
function TherapistsIndex({ therapists }) {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white dark:bg-gray-950", children: [
    ...
    /* @__PURE__ */ jsxs(Head, { title: "Tim Terapis Kami | InDepth Mental Wellness", children: [
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Kenali tim terapis profesional InDepth Mental Wellness Semarang. Terapis bersertifikat dengan keahlian hipnoterapi, psikologi klinis, dan kesehatan mental untuk mendampingi perjalanan pemulihan Anda." }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: "terapis hipnoterapi Semarang, tim terapis InDepth, terapis bersertifikat, hipnoterapis profesional, psikolog Semarang, konselor kesehatan mental" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Tim Terapis InDepth Mental Wellness Semarang" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Tim terapis profesional bersertifikat InDepth Semarang. Spesialis hipnoterapi, psikologi klinis, dan kesehatan mental." }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Tim Terapis InDepth Semarang" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Terapis hipnoterapi profesional bersertifikat di InDepth Mental Wellness Semarang." }),
