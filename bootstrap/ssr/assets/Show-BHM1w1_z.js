...
import { CheckCircle2, Phone, Calendar, Fingerprint, Activity, ShieldCheck, Heart, Clock, CreditCard, ChevronRight, AlertTriangle, FileText, Download, ExternalLink, Clipboard, User, X } from "lucide-react";
...
function InvoiceModal({ invoiceData, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm", onClick: onClose, children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-8 border-b border-gray-100 dark:border-gray-800", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h2", { className: "text-xs font-black uppercase tracking-widest text-indigo-600 mb-1", children: "Invoice" }),
        /* @__PURE__ */ jsx("p", { className: "text-2xl font-black text-gray-900 dark:text-white font-mono", children: invoiceData.invoice_number })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx("span", { className: `px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest ${isPaid ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}`, children: isPaid ? "✓ Lunas" : "⏳ Belum Dibayar" }),
    ...
    /* @__PURE__ */ jsxs("div", { ref: printRef, className: "p-8 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "hidden print:block header", children: [
        /* @__PURE__ */ jsx("div", { className: "logo", children: "InDepth" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("p", { style: { fontSize: "12px", color: "#6b7280" }, children: [
            "Invoice #",
            invoiceData.invoice_number
          ] }),
          /* @__PURE__ */ jsx("p", { style: { fontSize: "12px", color: "#6b7280" }, children: new Date(invoiceData.created_at).toLocaleDateString("id-ID", { dateStyle: "long" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 dark:bg-gray-800 rounded-2xl p-6", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-gray-400 mb-4", children: "Informasi Pasien" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-[9px] font-black uppercase text-gray-400", children: label }),
          /* @__PURE__ */ jsx("p", { className: "text-sm font-black text-gray-900 dark:text-white mt-0.5", children: value })
        ] }, label)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-indigo-50 dark:bg-indigo-950/20 rounded-2xl p-6 border border-indigo-100 dark:border-indigo-900/40", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-indigo-500 mb-4", children: "Detail Sesi" }),
        ...
        ].map(({ label, value }) => /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "border border-gray-100 dark:border-gray-800 rounded-2xl p-6", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-gray-400 mb-4", children: "Rincian Pembayaran" }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500 font-medium", children: "Metode" }),
            /* @__PURE__ */ jsx("span", { className: "font-black text-gray-900 dark:text-white", children: invoiceData.payment_method || "—" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-500 font-medium", children: "Status" }),
            /* @__PURE__ */ jsx("span", { className: `font-black uppercase text-xs ${isPaid ? "text-emerald-600" : "text-amber-600"}`, children: isPaid ? "✓ Lunas" : "⏳ Belum Dibayar" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mt-4 pt-4 border-t-2 border-indigo-600", children: [
          /* @__PURE__ */ jsx("span", { className: "text-sm font-black uppercase tracking-widest text-indigo-600", children: "Total" }),
          /* @__PURE__ */ jsx("span", { className: "text-2xl font-black text-indigo-600", children: fmt(invoiceData.amount) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-gray-400 text-center", children: [
        "Dibuat oleh ",
        /* @__PURE__ */ jsx("span", { className: "font-black", children: invoiceData.created_by }),
        " · ",
        new Date(invoiceData.created_at).toLocaleString("id-ID", { dateStyle: "medium", timeStyle: "short" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-8 border-t border-gray-100 dark:border-gray-800", children: [
