      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-8", children: [
          ...
          step === 2 && /* @__PURE__ */ jsxs("div", { className: "space-y-8 animate-fade-in-up", children: [
            /* @__PURE__ */ jsxs("div", { ref: packageSectionRef, className: "bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl shadow-sm sm:rounded-2xl border border-gray-100 dark:border-gray-700/50 overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxs("div", { ref: scheduleRef, className: "bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl shadow-sm sm:rounded-2xl border border-gray-100 dark:border-gray-700/50 overflow-hidden transition-all duration-500", children: [
