...
function ProfileCompletionBadge({ completion }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1.5 group relative min-w-[60px]", children: [
    ...
    !is_complete && missingFields.length > 0 && /* @__PURE__ */ jsxs("div", { className: "absolute top-1/2 -translate-y-1/2 left-full ml-4 hidden group-hover:block z-[999] w-56 bg-gray-900 dark:bg-gray-700 text-white text-[10px] rounded-2xl p-4 shadow-xl pointer-events-none", children: [
