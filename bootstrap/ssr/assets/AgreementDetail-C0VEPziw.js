    ...
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12 bg-gray-50 dark:bg-gray-950 px-4 sm:px-6 print:bg-white print:py-0 print:px-0", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto space-y-12", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row justify-center gap-4 pt-4 print:hidden", children: [
            !userModel.screening_completed_at && /* @__PURE__ */ jsxs(Link, { href: route("screening.show"), className: "w-full sm:w-auto inline-flex items-center justify-center gap-2 px-12 py-4 bg-indigo-600 text-white text-sm font-black rounded-2xl hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-500/20 uppercase tracking-widest", children: [
            ...
            /* @__PURE__ */ jsxs("button", { onClick: () => window.print(), className: "w-full sm:w-auto inline-flex items-center justify-center gap-2 px-12 py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 text-sm font-black rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all shadow-md uppercase tracking-widest", children: [
            ...
            /* @__PURE__ */ jsxs(Link, { href: route("dashboard"), className: "w-full sm:w-auto inline-flex items-center justify-center gap-2 px-12 py-4 bg-gold-500 text-white text-sm font-black rounded-2xl hover:bg-gold-600 transition-all shadow-md uppercase tracking-widest", children: [
