...
import { Activity, Calendar, Clock, Plus, Users, ShieldCheck, ChevronRight, User, CheckCircle2, Star, Mail, Phone, Eye, Save, AlertTriangle, XCircle, Heart, CreditCard, MapPin, ExternalLink, Fingerprint, Clipboard, ChevronLeft } from "lucide-react";
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "md:flex", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-start", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2", children: "Kapasitas Slot" }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-3 mb-1", children: [
                      /* @__PURE__ */ jsx("span", { className: `text-4xl font-black ${schedule.booked_count >= schedule.quota ? "text-rose-500" : "text-indigo-600"}`, children: schedule.booked_count }),
                      /* @__PURE__ */ jsxs("span", { className: "text-[10px] font-black text-gray-400 mb-2 uppercase tracking-widest", children: [
                        "/ ",
                        schedule.quota,
                        " Terdaftar"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsx("div", { className: "w-full h-3 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden border border-gray-200/50 dark:border-gray-700/50", children: /* @__PURE__ */ jsx(
                      motion.div,
                      {
                        initial: { width: 0 },
            ...
            /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxs(AnimatePresence, { mode: "wait", children: [
              ...
              activeTab === "patients" && /* @__PURE__ */ jsx(motion.div, { initial: { opacity: 0, x: 20 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: -20 }, className: "space-y-6", children: schedule.bookings?.length > 0 ? schedule.bookings.map((booking) => /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/80 rounded-[2.5rem] border border-gray-100 dark:border-gray-700/50 overflow-hidden shadow-sm", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "p-8 space-y-8", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-gray-400 uppercase tracking-widest px-1", children: "Integrasi Sesi" }),
                    /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                          /* @__PURE__ */ jsx("label", { className: "text-[9px] font-black text-indigo-500 uppercase tracking-wider ml-1 mb-1 block", children: "Status Sesi" }),
                          /* @__PURE__ */ jsxs(
                            "select",
                            {
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                          /* @__PURE__ */ jsx("label", { className: "text-[9px] font-black text-indigo-500 uppercase tracking-wider ml-1 mb-1 block", children: "Hasil Outcome" }),
                          /* @__PURE__ */ jsxs(
                            "select",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsx("option", { value: "Abnormal/Emergency", children: "Emergency" })
                              ]
                            }
                          )
                        ] })
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                        /* @__PURE__ */ jsx("label", { className: "text-[9px] font-black text-indigo-500 uppercase tracking-wider ml-1 mb-1 block", children: "Metode yang Digunakan" }),
                        /* @__PURE__ */ jsxs(
                          "select",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsx("option", { value: "", children: "-- Pilih Metode Terapis --" }),
                              /* @__PURE__ */ jsx("option", { value: "InDepth Solution", children: "InDepth Solution" }),
                              /* @__PURE__ */ jsx("option", { value: "InDepth Trance State", children: "InDepth Trance State" }),
                              /* @__PURE__ */ jsx("option", { value: "Supreme Trance State", children: "Supreme Trance State" }),
                              /* @__PURE__ */ jsx("option", { value: "NLP", children: "Neuro Linguistic Programming (NLP)" }),
                              /* @__PURE__ */ jsx("option", { value: "CBT", children: "Cognitive Behavioral Therapy (CBT)" }),
                              (booking.therapist?.specialization || schedule.therapist?.specialization)?.split(",").map((s, idx) => /* @__PURE__ */ jsx("option", { value: s.trim(), children: s.trim() }, idx))
                            ]
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                        /* @__PURE__ */ jsx("label", { className: "text-[9px] font-black text-indigo-500 uppercase tracking-wider ml-1 mb-1 block", children: "Link Rekaman (Optional)" }),
                        /* @__PURE__ */ jsx(
                          "input",
                          {
                            type: "text",
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                        /* @__PURE__ */ jsx("label", { className: "text-[9px] font-black text-indigo-500 uppercase tracking-wider ml-1 mb-1 block", children: "Catatan Terapis (Internal/Klinis)" }),
                        /* @__PURE__ */ jsx(
                          "textarea",
                          {
            ...
            /* @__PURE__ */ jsxs(
              "select",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("option", { value: "upgrade", children: "Paket Upgrade" }),
