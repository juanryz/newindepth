    ...
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6", children: [
          ...
          isPendingPayment && /* @__PURE__ */ jsx("div", { className: "mt-6 flex justify-end items-center", children: /* @__PURE__ */ jsx(Link, { href: route("payments.create", booking.id), children: /* @__PURE__ */ jsx(PrimaryButton, { className: "!bg-blue-600 hover:!bg-blue-500 !rounded-md !px-6 !py-2.5 !text-sm !font-bold", children: "Lanjutkan ke Pembayaran" }) }) })
        ] }) })
      ]
    }
  );
