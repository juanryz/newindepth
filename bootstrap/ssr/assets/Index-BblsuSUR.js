...
function ReportsIndex({ stats, recentTransactions, filters, charts }) {
  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12 bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-64px)] transition-colors duration-500", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900/50 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-800/50", children: [
                /* @__PURE__ */ jsx("h3", { className: "text-xs font-black text-gray-900 dark:text-white mb-6 uppercase tracking-widest text-center", children: "Top Terapis" }),
                /* @__PURE__ */ jsx("div", { className: "h-64", children: charts?.topTherapists?.length > 0 ? /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: charts.topTherapists, layout: "vertical", margin: { top: 0, right: 30, left: 10, bottom: 0 }, children: [
                  /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", horizontal: true, vertical: false, stroke: "rgba(156, 163, 175, 0.1)" }),
                  ...
                  /* @__PURE__ */ jsx(Bar, { dataKey: "bookings", fill: "#d4a321", radius: [0, 10, 10, 0], barSize: 16 })
                ] }) }) : /* @__PURE__ */ jsx("div", { className: "h-full flex items-center justify-center text-gray-400 text-[10px] font-bold border-2 border-dashed border-gray-100 dark:border-gray-800 rounded-[2rem]", children: "Belum ada data." }) })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900/50 backdrop-blur-xl overflow-hidden shadow-2xl sm:rounded-[2.5rem] mt-12 border border-white dark:border-gray-800 transition-all duration-500", children: [
            /* @__PURE__ */ jsx("div", { className: "p-8 border-b border-gray-50 dark:border-gray-800/50 flex justify-between items-center bg-gray-50/30 dark:bg-gray-800/20", children: /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-gray-900 dark:text-white tracking-tight", children: "Transaksi Terakhir" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400 mt-1 font-medium", children: "5 pemasukan terbaru di periode ini." })
            ] }) }),
            /* @__PURE__ */ jsxs("div", { className: "overflow-x-auto", children: [
              /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-100 dark:divide-gray-800/50", children: [
                /* @__PURE__ */ jsx("thead", { className: "bg-gray-50/50 dark:bg-gray-800/10", children: /* @__PURE__ */ jsxs("tr", { children: [
                  ...
                  /* @__PURE__ */ jsx("th", { className: "px-8 py-4 text-left text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest", children: "Invoice" }),
                ...
                /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 dark:divide-gray-800/30", children: recentTransactions.map((tx) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-all duration-300", children: [
                  /* @__PURE__ */ jsx("td", { className: "px-8 py-6 whitespace-nowrap text-sm font-bold text-gray-900 dark:text-white", children: new Date(tx.created_at).toLocaleDateString("id-ID", { day: "numeric", month: "short" }) }),
                  /* @__PURE__ */ jsxs("td", { className: "px-8 py-6 whitespace-nowrap", children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: "text-[10px] text-gray-500 font-medium", children: "Verified Payment" })
                  ] }),
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-8 py-6 whitespace-nowrap text-xs text-gray-500 dark:text-gray-400 font-mono font-bold", children: tx.invoice_number }),
              ...
              recentTransactions.length === 0 && /* @__PURE__ */ jsx("div", { className: "py-20 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-gray-400 dark:text-gray-600 text-sm font-bold italic", children: "Tidak ada pemasukan di periode ini." }) })
            ] })
          ] })
        ] }) })
      ]
