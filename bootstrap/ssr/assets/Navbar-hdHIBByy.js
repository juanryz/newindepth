...
function Navbar({ auth, active = "home", isAuthPage = false, title = "" }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("nav", { className: "fixed top-0 left-0 w-full z-50 bg-white/20 dark:bg-black/20 backdrop-blur-md md:backdrop-blur-xl border-b border-white/20 dark:border-gray-800/20 shadow-[0_8px_32px_rgba(0,0,0,0.05)] transition-all duration-500", children: [
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center h-24 relative", children: [
        /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 flex items-center cursor-pointer group relative z-50", onClick: () => window.scrollTo(0, 0), children: /* @__PURE__ */ jsx(Link, { href: "/", children: /* @__PURE__ */ jsx("img", { src: "/images/Logo-Indepth-Lingkaran-hitam.png", alt: "InDepth", width: "160", height: "80", className: "h-20 w-auto object-contain relative z-10" }) }) }),
        !isAuthPage && /* @__PURE__ */ jsxs("div", { className: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 hidden md:flex items-center space-x-1 bg-white/10 dark:bg-white/5 backdrop-blur-md px-2 py-1.5 rounded-full border border-white/10", children: [
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              href: "/kontak",
              className: `px-5 py-2 rounded-full text-sm font-medium transition-all duration-300 ${active === "kontak" ? "bg-white dark:bg-gray-800 text-gold-600 dark:text-gold-400 shadow-sm" : "text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-white/40 dark:hover:bg-white/10"}`,
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "bg-white/60 dark:bg-gray-900/80 backdrop-blur-2xl border-t border-white/20 dark:border-gray-700/30 px-4 pb-6 pt-4 space-y-1", children: [
            ...
            /* @__PURE__ */ jsxs(
              Link,
              {
                href: "/kontak",
                onClick: () => setIsMobileMenuOpen(false),
                className: `flex items-center gap-3 w-full px-4 py-3 rounded-2xl text-sm font-medium transition-all duration-200 ${active === "kontak" ? "bg-gold-500/10 text-gold-600 dark:text-gold-400" : "text-gray-700 dark:text-gray-300 hover:bg-gray-100/50 dark:hover:bg-gray-800/50"}`,
                children: [
                  active === "kontak" && /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-gold-500 flex-shrink-0" }),
                  "Kontak Kami"
                ]
              }
            ),
