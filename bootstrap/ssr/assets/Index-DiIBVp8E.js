...
import { Calendar, Users, Building2, CreditCard, Activity, ChevronRight, FileText, Eye, CheckCircle2, Clock, AlertTriangle } from "lucide-react";
            ...
            /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxs(AnimatePresence, { mode: "wait", children: [
              ...
              activeTab === "groups" && /* @__PURE__ */ jsx(motion.div, { initial: { opacity: 0, x: 20 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: -20 }, className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/80 rounded-[2.5rem] border border-gray-100 dark:border-gray-700/50 overflow-hidden shadow-sm", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
                  /* @__PURE__ */ jsx("thead", { className: "bg-gray-50/50 dark:bg-gray-800/50", children: /* @__PURE__ */ jsxs("tr", { className: "text-[10px] font-black text-gray-400 uppercase tracking-[0.15em] border-b border-white/40 dark:border-gray-700/30", children: [
                    /* @__PURE__ */ jsx("th", { className: "px-6 py-5", children: "Instansi / Grup" }),
                    /* @__PURE__ */ jsx("th", { className: "px-6 py-5", children: "PIC & Invoice" }),
                    ...
                    /* @__PURE__ */ jsx("th", { className: "px-6 py-5 text-right", children: "Total & Status" }),
                  ...
                  /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-gray-100 dark:divide-gray-800/50", children: [
                    filteredGroups.map((grp) => /* @__PURE__ */ jsxs("tr", { className: "group hover:bg-violet-50/30 dark:hover:bg-violet-900/10 transition-all", children: [
                      /* @__PURE__ */ jsx("td", { className: "px-6 py-5", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
                        ...
                        /* @__PURE__ */ jsx("div", { className: "text-[9px] text-gray-400 ml-10", children: grp.created_at ? new Date(grp.created_at).toLocaleDateString("id-ID", { day: "numeric", month: "short", year: "numeric" }) : "-" })
                      ] }) }),
                      /* @__PURE__ */ jsx("td", { className: "px-6 py-5", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
                        /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-gray-900 dark:text-white", children: grp.pic_name || "-" }),
                        grp.pic_phone && /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: grp.pic_phone }),
                        /* @__PURE__ */ jsx("div", { className: "text-[10px] font-black text-violet-500 uppercase tracking-widest bg-violet-50 dark:bg-violet-900/30 px-2 py-0.5 rounded-md w-fit mt-1", children: grp.invoice_number })
                      ] }) }),
                      ...
                      /* @__PURE__ */ jsx("td", { className: "px-6 py-5 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end gap-2", children: [
                        /* @__PURE__ */ jsxs("span", { className: "text-base font-black text-gray-900 dark:text-white", children: [
                          "Rp ",
                          new Intl.NumberFormat("id-ID").format(grp.total_amount || 0)
                        ] }),
                        /* @__PURE__ */ jsx("span", { className: `px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${grp.payment_status === "paid" ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400" : "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"}`, children: grp.payment_status === "paid" ? "✓ Lunas" : "⏳ Pending" }),
                        grp.payment_method && /* @__PURE__ */ jsx("span", { className: "text-[10px] text-gray-400", children: grp.payment_method })
                      ] }) }),
                      /* @__PURE__ */ jsx("td", { className: "px-6 py-5 text-center", children: /* @__PURE__ */ jsxs(
                        Link,
                        {
                    ...
                    filteredGroups.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsxs("td", { colSpan: "6", className: "px-8 py-20 text-center", children: [
