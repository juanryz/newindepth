  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        selectedBooking && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-gray-900/80 backdrop-blur-sm flex items-center justify-center z-[100] p-4", onClick: () => setSelectedBooking(null), children: /* @__PURE__ */ jsx(
          "div",
          {
