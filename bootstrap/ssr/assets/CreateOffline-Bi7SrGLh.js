...
import { AlertTriangle, CheckSquare, User, Mail, Phone, Camera, AlertCircle, Contact, ClipboardList, Wifi, WifiOff, FileImage, CheckCircle, Calendar, Package, CreditCard, Banknote, Clock, Download, Shield, Lock, EyeOff, Eye, Save, ChevronLeft, Trash2, Upload, X, MapPin } from "lucide-react";
          ...
          hasSchedule && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(Section, { icon: CreditCard, iconBg: "bg-orange-50 dark:bg-orange-900/40", iconColor: "text-orange-600 dark:text-orange-400", title: "Invoice & Pembayaran", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              ...
              data.payment_method === "Transfer Bank" && /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 dark:bg-blue-950/20 rounded-2xl border border-blue-100 dark:border-blue-900/40 p-5", children: [
                ...
                effectiveBankAccounts.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-3", children: effectiveBankAccounts.map((b) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 bg-white dark:bg-gray-900 rounded-xl border border-blue-100 dark:border-blue-900/30", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsx("span", { className: "text-white font-black text-[10px]", children: b.bank }) }),
                    /* @__PURE__ */ jsxs("div", { children: [
                ...
                ] }, b.bank)) }) : /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: [
                  "Silakan transfer ke rekening resmi ",
                  clinicInfo?.name || "InDepth Mental Wellness",
                  "."
                ] }),
              ...
              isPaid && /* @__PURE__ */ jsxs("div", { className: "space-y-6 p-6 bg-emerald-50/50 dark:bg-emerald-950/20 rounded-2xl border border-emerald-100 dark:border-emerald-900/40", children: [
                /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: !["Cash", "Tunai"].includes(data.payment_method) && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
