                ...
                /* @__PURE__ */ jsx("div", { className: "bg-gray-50 dark:bg-gray-800/50 rounded-[2rem] p-6 border border-gray-100 dark:border-gray-800 space-y-3", children: roles.map((role) => /* @__PURE__ */ jsxs(
                  "label",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: `text-[10px] font-black uppercase tracking-widest ${data.roles.includes(role.name) ? "text-white" : "text-gray-700 dark:text-gray-300"}`, children: role.name.replace("_", " ") })
                    ]
                  },
                  role.id
                )) }),
