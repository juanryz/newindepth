        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900 dark:text-gray-100", children: [
          !transactions || transactions.data.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100 dark:divide-gray-800", children: transactions.data.map((tx) => {
              ...
              let isPendingValidation = isBooking && tx.transactionable?.status === "pending_validation";
              ...
              return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors", children: [
                ...
                /* @__PURE__ */ jsx("td", { className: "py-4 px-4 align-top", children: /* @__PURE__ */ jsx("div", { className: "font-medium whitespace-nowrap", children: isBooking ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase text-emerald-500", children: "Sesi Terapi" }),
                  /* @__PURE__ */ jsx("span", { children: tx.transactionable?.package_type === "vip" ? "Paket VIP" : tx.transactionable?.package_type === "premium" ? "Paket Premium" : tx.transactionable?.package_type === "reguler" ? "Paket Reguler" : "Paket Hipnoterapi" })
                ] }) : "-" }) }),
                ...
                /* @__PURE__ */ jsxs("td", { className: "py-4 px-4 align-top", children: [
                  isCompleted && !isPendingValidation && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400", children: "Pembayaran Lunas" }),
                  isPending && !isPendingValidation && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400", children: "Menunggu Pembayaran" }),
                  isPendingValidation && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400", children: "Menunggu Validasi" }),
