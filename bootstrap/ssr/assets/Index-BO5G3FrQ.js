...
function InternalAiIndexPage({ agents }) {
    ...
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "py-8 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsx("p", { className: "text-gray-500 dark:text-gray-400 font-medium", children: "Pilih asisten AI yang ingin kamu ajak bicara. Setiap agent terlatih untuk area tertentu." }) }),
