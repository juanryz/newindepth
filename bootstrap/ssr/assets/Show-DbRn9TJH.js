                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-start", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-2", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black text-gray-500 uppercase tracking-widest", children: schedule.booked_count >= 1 ? `${schedule.booked_count} Pasien Terdaftar` : /* @__PURE__ */ new Date(`${schedule.date}T${schedule.start_time}`) < /* @__PURE__ */ new Date() ? "Jadwal sesi telah berlalu" : "1 Slot tersedia — menunggu 1 pasien" })
                    ] }),
