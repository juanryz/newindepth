...
function TherapistScheduleIndex({ bookings, groupBookings = [], availableSchedules = [], calendarSchedules = [], mySchedules = [], serverNow, clinicSettings = {}, isAdmin = false }) {
  ...
  clinicSettings.standard_slots || [];
  clinicSettings.session_auto_close_min || 95;
  ...
  const nowDt = serverNow ? new Date(serverNow.replace(" ", "T")) : /* @__PURE__ */ new Date();
  const isPastBooking = (booking) => {
    ...
    const endDt = /* @__PURE__ */ new Date(dateOnly + "T" + endTimeStr);
  ...
  const confirmBulkDelete = () => {
    if (bulkDeleteAll) {
      ...
      router.post(route("schedules.bulk-delete"), { ids: selectedScheduleIds }, { onSuccess: () => {
  ...
  const handleAddSchedule = (e) => {
    ...
    const payload = {
      ...recurData,
      // Convert to string to prevent any FormData zero-dropping
      days_of_week: recurData.days_of_week.map((d) => String(d))
    };
    router.post(route("schedules.store-recurring"), payload, {
    ...
    AuthenticatedLayout,
    {
      ...
      children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-8", children: [
            /* @__PURE__ */ jsxs("div", { className: "lg:w-72 flex-shrink-0 space-y-4", children: [
              /* @__PURE__ */ jsx("div", { className: "bg-white/50 dark:bg-gray-800/40 backdrop-blur-md rounded-[2rem] border border-gray-100 dark:border-gray-700/50 p-2 shadow-sm", children: [
                ...
                { id: "groups", label: "Daftar Grup", icon: "🏢", count: groupBookings.length },
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              ...
              activeTab === "history" && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/80 rounded-[2.5rem] border border-gray-100 dark:border-gray-700/50 shadow-sm p-8 pb-4", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 p-1.5 bg-slate-100/50 dark:bg-slate-800/30 rounded-2xl w-fit border border-slate-200/50 dark:border-slate-800", children: [
                  ...
                  ].map(([val, label, cnt]) => /* @__PURE__ */ jsxs(
                    "button",
                    {
                      ...
                      children: [
                        label,
                        cnt > 0 && /* @__PURE__ */ jsx("span", { className: `text-[9px] px-1.5 py-0.5 rounded-full ${historyFilter === val ? "bg-white/20" : val === "berlalu" ? "bg-amber-100 text-amber-600" : "bg-slate-200 dark:bg-slate-700 text-slate-500"}`, children: cnt })
                      ]
                    },
                    val
                  )) }),
                      ...
                      children: [
                        /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-4", children: [
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end gap-1", children: [
                            /* @__PURE__ */ jsx("span", { className: `px-3 py-1 rounded-full text-[10px] font-black uppercase ${isPast ? "bg-slate-200 text-slate-500 dark:bg-slate-700 dark:text-slate-400" : isNoShow ? "bg-orange-100 text-orange-600" : booking.status === "completed" ? "bg-gray-100 text-gray-500" : booking.status === "in_progress" ? "bg-red-100 text-red-600" : "bg-indigo-100 text-indigo-600"}`, children: isPast ? "⏰ Berlalu" : isNoShow ? "No-Show" : booking.status === "completed" ? "Selesai" : booking.status === "in_progress" ? "🔴 Live" : wasRescheduled ? "Dijadwal Ulang" : "Akan Datang" }),
                            isPast && /* @__PURE__ */ jsx("span", { className: "text-[9px] text-slate-400 font-bold uppercase tracking-widest", children: "Tidak dapat dimulai" })
                          ] })
                        ] }),
                        /* @__PURE__ */ jsxs("div", { className: "bg-indigo-50/50 dark:bg-slate-800 rounded-2xl p-4 mb-4 text-xs font-bold text-indigo-900 dark:text-indigo-300 space-y-1", children: [
                          /* @__PURE__ */ jsxs("p", { children: [
                            "📅 ",
                            booking.schedule ? (/* @__PURE__ */ new Date(String(booking.schedule.date).substring(0, 10) + "T00:00:00")).toLocaleDateString("id-ID", { weekday: "long", day: "numeric", month: "long", year: "numeric" }) : "No Date"
                          ] }),
                          /* @__PURE__ */ jsxs("p", { children: [
                            "🕐 ",
                          ...
                          booking.session_type && /* @__PURE__ */ jsx("span", { className: `inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-wider border ${booking.session_type === "online" ? "bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800/50" : "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-800/50"}`, children: booking.session_type === "online" ? "💻 Online" : "🏥 Offline" })
                        ] }),
                        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 mt-auto", children: [
                          ...
                          isPast && booking.status === "confirmed" && /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                            /* @__PURE__ */ jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-rose-500 text-center", children: "⏰ Jadwal Sudah Berlalu" }),
                            /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                              /* @__PURE__ */ jsx("button", { onClick: () => openRescheduleModal(booking), className: "flex-1 text-[10px] font-black text-amber-700 bg-amber-50 hover:bg-amber-100 border border-amber-200 py-2.5 rounded-2xl uppercase", children: "Reschedule" }),
                              /* @__PURE__ */ jsx("button", { onClick: () => openNoShowModal(booking), className: "flex-1 text-[10px] font-black text-red-700 bg-red-50 hover:bg-red-100 border border-red-200 py-2.5 rounded-2xl uppercase", children: "No Show" })
                            ] })
                          ] }),
                          booking.status === "confirmed" && !isPast && /* @__PURE__ */ jsx("button", { onClick: () => handleStartSession(booking.id), className: "w-full text-center text-xs font-black text-white bg-indigo-600 hover:bg-indigo-700 py-3 rounded-2xl shadow-lg uppercase", children: "Mulai Sesi" }),
                          ...
                          ["confirmed", "in_progress"].includes(booking.status) && !isPast && /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                          ...
                          isNoShow && isAdmin && /* @__PURE__ */ jsx("button", { onClick: () => openRescheduleModal(booking), className: "w-full text-[10px] font-black text-amber-700 bg-amber-50 hover:bg-amber-100 border border-amber-200 py-2.5 rounded-2xl uppercase", children: "Koreksi Jadwal (No-Show)" })
                        ] })
                      ]
                    },
                    booking.id
              ...
              activeTab === "groups" && /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/80 rounded-[2.5rem] border border-gray-100 dark:border-gray-700/50 shadow-sm p-8 pb-4", children: [
                /* @__PURE__ */ jsxs("h3", { className: "text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight flex items-center gap-3 mb-6", children: [
                  /* @__PURE__ */ jsx("div", { className: "w-1.5 h-6 bg-indigo-600 rounded-full" }),
                  "Daftar Grup & Institusi"
                ] }),
                /* @__PURE__ */ jsx("div", { className: "bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-4 mb-6", children: /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
                    placeholder: "Cari grup, institusi, atau invoice...",
                    className: "w-full bg-white dark:bg-gray-800 border-none rounded-xl text-sm font-bold text-gray-700 dark:text-white focus:ring-2 focus:ring-indigo-500/20",
                    value: groupSearchQuery,
                    onChange: (e) => setGroupSearchQuery(e.target.value)
                  }
                ) }),
                /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: groupBookings.filter(
                  (g) => g.group_name.toLowerCase().includes(groupSearchQuery.toLowerCase()) || g.institution_name.toLowerCase().includes(groupSearchQuery.toLowerCase()) || g.invoice_number.toLowerCase().includes(groupSearchQuery.toLowerCase())
                ).length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center py-20 bg-white dark:bg-gray-800/40 rounded-[1.5rem] border border-dashed border-gray-200 dark:border-gray-700", children: /* @__PURE__ */ jsx("p", { className: "text-gray-400 font-black uppercase tracking-widest text-sm", children: "Tidak ada grup ditemukan" }) }) : /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-100 dark:divide-gray-800", children: [
                  /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { className: "bg-gray-50/50 dark:bg-gray-800/50", children: ["Grup / Institusi", "Jadwal & Sesi", "PIC", "Anggota", "Status"].map((h) => /* @__PURE__ */ jsx("th", { className: "text-left text-[10px] font-black uppercase tracking-widest text-gray-400 px-6 py-4 rounded-t-xl", children: h }, h)) }) }),
                  /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 dark:divide-gray-800/50", children: groupBookings.filter(
                    (g) => g.group_name.toLowerCase().includes(groupSearchQuery.toLowerCase()) || g.institution_name.toLowerCase().includes(groupSearchQuery.toLowerCase()) || g.invoice_number.toLowerCase().includes(groupSearchQuery.toLowerCase())
                  ).map((g) => {
                    ...
                    return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-colors", children: [
                      /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
                        /* @__PURE__ */ jsx("p", { className: "font-bold text-gray-900 dark:text-white uppercase tracking-tight", children: g.group_name }),
                        g.institution_name !== g.group_name && /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold tracking-widest text-gray-400", children: g.institution_name }),
                        /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black tracking-widest text-indigo-500 mt-1", children: g.invoice_number })
                      ] }),
                      /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
                        /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-gray-900 dark:text-gray-300", children: g.schedule ? new Date(g.schedule.date).toLocaleDateString("id-ID", { day: "numeric", month: "short", year: "numeric" }) : "-" }),
                        /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400", children: g.schedule ? `${g.schedule.start_time.substring(0, 5)} - ${g.schedule.end_time.substring(0, 5)}` : "-" }),
                        /* @__PURE__ */ jsx("span", { className: `mt-1 inline-block px-2 py-0.5 rounded text-[8px] font-black uppercase ${g.session_type === "online" ? "bg-blue-50 text-blue-600 border border-blue-100" : "bg-emerald-50 text-emerald-600 border border-emerald-100"}`, children: g.session_type })
                      ] }),
                      /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
              ...
              activeTab === "mySchedules" && !isAdmin && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/80 rounded-[2.5rem] border border-gray-100 dark:border-gray-700/50 shadow-sm p-8 md:p-10", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-8", children: "Pilih hari & jam — sistem otomatis membagi slot 2 jam" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/80 rounded-[2.5rem] border border-gray-100 dark:border-gray-700/50 shadow-sm overflow-hidden", children: [
                  /* @__PURE__ */ jsxs("div", { className: "p-8 border-b border-gray-100 dark:border-gray-700/50 space-y-4", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                      ...
                      /* @__PURE__ */ jsxs("span", { className: "px-4 py-2 bg-emerald-600 text-white rounded-full text-[10px] font-black uppercase", children: [
                        mySchedules.length,
                        " Slot"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
                      /* @__PURE__ */ jsx("div", { className: "flex gap-1.5 p-1 bg-slate-100/70 dark:bg-slate-800/50 rounded-xl border border-slate-200/50 dark:border-slate-700", children: [["all", "Semua"], ["available", "Tersedia"], ["booked", "Terisi"]].map(([val, lbl]) => /* @__PURE__ */ jsx(
                        "button",
                        {
                          onClick: () => {
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex gap-2 ml-auto flex-wrap", children: [
                        selectedScheduleIds.length > 0 && /* @__PURE__ */ jsxs(
                          "button",
                          {
                        ...
                        /* @__PURE__ */ jsx(
                          "button",
                          {
                            ...
                            children: "🗑 Hapus Semua Kosong"
                          }
                        ),
                        currentSchedules.some((sc) => sc.booked_count === 0) && /* @__PURE__ */ jsx(
                          "button",
                          {
                            ...
                            children: "☑ Pilih Halaman Ini"
                          }
                        ),
                        selectedScheduleIds.length > 0 && /* @__PURE__ */ jsx("button", { onClick: clearSelection, className: "px-4 py-2 text-slate-400 text-[10px] font-black uppercase tracking-widest hover:text-slate-600 transition-all", children: "✕ Batal" })
                      ] })
                    ] })
                  ] }),
                  mySchedules.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "py-20 text-center", children: [
                  ...
                  ] }) : filteredSchedules.length === 0 ? /* @__PURE__ */ jsx("div", { className: "py-10 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-gray-400 font-black text-sm uppercase tracking-widest", children: "Tidak ada slot untuk filter ini" }) }) : /* @__PURE__ */ jsxs("div", { className: "divide-y divide-gray-50 dark:divide-gray-800", children: [
                    currentSchedules.map((sc) => {
                      ...
                      const d = dateOnly ? /* @__PURE__ */ new Date(dateOnly + "T00:00:00") : /* @__PURE__ */ new Date("invalid");
                      const isValidDate = !isNaN(d.getTime());
                      const isSelected = selectedScheduleIds.includes(sc.id);
                      return /* @__PURE__ */ jsxs("div", { className: `px-8 py-5 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition-colors ${isSelected ? "bg-rose-50/50 dark:bg-rose-900/10" : ""}`, children: [
                        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                          /* @__PURE__ */ jsx(
                            "input",
                            {
                              type: "checkbox",
                              checked: isSelected,
                              onChange: () => toggleSelectSchedule(sc.id),
                          ...
                          /* @__PURE__ */ jsxs("div", { className: `w-14 h-14 rounded-2xl flex flex-col items-center justify-center font-black shadow-sm ${sc.booked_count >= 1 ? "bg-rose-100 dark:bg-rose-900/30 text-rose-600" : "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600"}`, children: [
                            /* @__PURE__ */ jsx("span", { className: "text-xs", children: isValidDate ? d.toLocaleDateString("id-ID", { month: "short" }) : "??" }),
                            /* @__PURE__ */ jsx("span", { className: "text-xl leading-none", children: isValidDate ? d.getDate() : "-" })
                          ] }),
                          /* @__PURE__ */ jsxs("div", { children: [
                            /* @__PURE__ */ jsx("p", { className: "text-sm font-black text-gray-900 dark:text-white uppercase", children: isValidDate ? `${d.toLocaleDateString("id-ID", { weekday: "long" })}, ${d.toLocaleDateString("id-ID", { day: "numeric", month: "long", year: "numeric" })}` : `Tanggal tidak valid (${rawDate})` }),
                    ...
                    filteredSchedules.length > scheduleItemsPerPage && /* @__PURE__ */ jsxs("div", { className: "px-8 py-5 flex items-center justify-between bg-gray-50/50 dark:bg-gray-800/20", children: [
                      /* @__PURE__ */ jsxs("span", { className: "text-xs font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest", children: [
                        ...
                        "–",
                        Math.min(schedulePage * scheduleItemsPerPage, filteredSchedules.length),
                        " dari ",
        ...
        /* @__PURE__ */ jsx(Modal, { show: selectedHistoryPatient !== null, onClose: closeHistoryModal, maxWidth: "2xl", children: /* @__PURE__ */ jsxs("div", { className: "p-8", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-4 max-h-[40vh] overflow-y-auto pr-2 custom-scrollbar", children: selectedHistoryPatient?.bookings?.map((hist) => /* @__PURE__ */ jsxs("div", { className: `p-6 rounded-[2rem] border flex gap-5 transition-all ${hist.status === "completed" ? "bg-indigo-50/30 dark:bg-indigo-900/20 border-indigo-100 dark:border-indigo-800/30" : "bg-white dark:bg-slate-900 border-gray-100 dark:border-gray-700"}`, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              ...
              hist.group_booking_member?.group_booking && /* @__PURE__ */ jsxs("div", { className: "mt-4 p-4 bg-white/50 dark:bg-slate-800/50 rounded-2xl border border-indigo-100 dark:border-indigo-800/30", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
                  /* @__PURE__ */ jsxs("p", { className: "text-[10px] font-black text-indigo-500 uppercase tracking-widest flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx("span", { children: "👥 Anggota Grup" }),
                    /* @__PURE__ */ jsx("span", { className: "w-1 h-3 bg-indigo-200 rounded-full" }),
                    /* @__PURE__ */ jsx("span", { className: "truncate max-w-[150px]", children: hist.group_booking_member.group_booking.group_name })
                  ] }),
                  /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-indigo-100 text-indigo-600 rounded text-[8px] font-black uppercase", children: "GROUP" })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: hist.group_booking_member.group_booking.members?.map((m) => /* @__PURE__ */ jsx("div", { className: "px-3 py-1 bg-white dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-[10px] font-black rounded-lg border border-indigo-100/30 dark:border-indigo-800/30 shadow-sm", children: m.user?.name }, m.id)) })
              ] }),
        ...
        /* @__PURE__ */ jsx(Modal, { show: selectedRescheduleBooking !== null, onClose: closeRescheduleModal, children: /* @__PURE__ */ jsxs("form", { onSubmit: handleReschedule, className: "p-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "new_schedule_id", value: "Pilih Slot Tersedia" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  id: "new_schedule_id",
                  ...
                  children: [
                    ...
                    availableSchedules.filter((s) => s.id !== selectedRescheduleBooking?.schedule_id).map((s) => /* @__PURE__ */ jsxs("option", { value: s.id, children: [
                      (/* @__PURE__ */ new Date(String(s.date).substring(0, 10) + "T00:00:00")).toLocaleDateString("id-ID", { weekday: "long", day: "numeric", month: "long" }),
                      " — ",
            ...
            isAdmin && !rescheduleData.new_schedule_id && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "col-span-2", children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Atau Input Tanggal Manual", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2" }),
                /* @__PURE__ */ jsx(TextInput, { type: "date", className: "w-full", value: rescheduleData.new_date, onChange: (e) => setRescheduleData("new_date", e.target.value) })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Jam Mulai", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2" }),
                /* @__PURE__ */ jsx(TextInput, { type: "time", className: "w-full", value: rescheduleData.new_start_time, onChange: (e) => setRescheduleData("new_start_time", e.target.value) })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Jam Selesai", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2" }),
                /* @__PURE__ */ jsx(TextInput, { type: "time", className: "w-full", value: rescheduleData.new_end_time, onChange: (e) => setRescheduleData("new_end_time", e.target.value) })
              ] })
            ] }),
            isAdmin && selectedRescheduleBooking?.completion_outcome?.startsWith("No-Show") && /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { value: "Status Kehadiran Sesi Ini" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  className: "mt-1 block w-full border-gray-200 dark:border-gray-700 dark:bg-slate-800 dark:text-white rounded-2xl shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm font-bold",
                  ...
                  required: true,
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "", children: "-- Pilih Status --" }),
                    /* @__PURE__ */ jsx("option", { value: "Normal", children: "Hadir / Selesai Normal" }),
                    /* @__PURE__ */ jsx("option", { value: "No-Show (Pasien)", children: "No-Show (Pasien)" }),
                    /* @__PURE__ */ jsx("option", { value: "No-Show (Praktisi)", children: "No-Show (Praktisi)" })
                  ]
                }
              )
            ] }),
        ...
        /* @__PURE__ */ jsx(Modal, { show: showBulkConfirm, onClose: () => setShowBulkConfirm(false), children: /* @__PURE__ */ jsxs("div", { className: "p-8", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-black text-gray-900 dark:text-white mb-2 uppercase tracking-tight", children: "Konfirmasi Hapus" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 mb-6", children: bulkDeleteAll ? "Semua slot kosong (belum ada booking) yang mendatang akan dihapus. Tindakan ini tidak dapat dibatalkan." : `${selectedScheduleIds.length} slot yang dipilih akan dihapus. Slot yang sudah terisi tidak akan terpengaruh.` }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-3", children: [
            /* @__PURE__ */ jsx(SecondaryButton, { onClick: () => setShowBulkConfirm(false), className: "rounded-2xl", children: "Batal" }),
            /* @__PURE__ */ jsx(
              "button",
              {
