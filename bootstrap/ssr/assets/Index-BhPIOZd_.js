...
import Form from "./Form-DLCGXIMr.js";
...
function renderEventContent(eventInfo) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `h-full w-full p-2 rounded-xl transition-all flex flex-col justify-center gap-1 group overflow-hidden ${isBooked ? "bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-lg shadow-emerald-500/20 shadow-inner" : "bg-white dark:bg-slate-800 border-2 border-indigo-100 dark:border-indigo-900/30 text-indigo-600 dark:text-indigo-400 shadow-sm"}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between pointer-events-none", children: [
      ...
      isBooked && /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-white animate-pulse shadow-[0_0_8px_white]" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: `text-xs font-black truncate leading-tight uppercase tracking-tight pointer-events-none ${isBooked ? "text-white" : "text-slate-900 dark:text-white"}`, children: isBooked ? "✅ TERISI" : eventInfo.event.extendedProps.therapist?.name }),
    !isBooked && /* @__PURE__ */ jsx("div", { className: "text-[8px] font-bold text-indigo-400 dark:text-indigo-500 uppercase tracking-widest pointer-events-none", children: eventInfo.event.extendedProps.schedule_type === "class" ? "🎓 Kelas" : "👥 Konsultasi" }),
    isBooked && /* @__PURE__ */ jsxs("div", { className: "text-[8px] font-black text-white/70 uppercase tracking-widest pointer-events-none", children: [
