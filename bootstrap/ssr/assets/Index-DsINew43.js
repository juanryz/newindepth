...
function VoucherRow({ voucher, onEdit, onDelete, canEdit, canDelete }) {
  ...
  return /* @__PURE__ */ jsxs("tr", { className: "border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors", children: [
    ...
    /* @__PURE__ */ jsxs("td", { className: "px-4 py-4 text-right space-x-3", children: [
      canEdit && /* @__PURE__ */ jsx("button", { onClick: () => onEdit(voucher), className: "text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 uppercase tracking-tighter", children: "Edit" }),
      canDelete && /* @__PURE__ */ jsx("button", { onClick: () => onDelete(voucher.id), className: "text-xs font-bold text-red-600 dark:text-red-400 hover:text-red-800 uppercase tracking-tighter", children: "Hapus" })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden flex flex-col group hover:shadow-xl transition-all duration-500 hover:-translate-y-1", children: [
    /* @__PURE__ */ jsxs("div", { className: "p-6 flex-1 space-y-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1", children: "Offline" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-1 border-t border-gray-100 dark:border-gray-700", children: [
          /* @__PURE__ */ jsx("p", { className: "text-[9px] font-black text-blue-500 uppercase tracking-widest mb-1", children: "Online" }),
          /* @__PURE__ */ jsx("span", { className: "text-lg font-black text-blue-600 dark:text-blue-400", children: formatRp(pkg.online_current_price) }),
          /* @__PURE__ */ jsx("span", { className: "text-[9px] text-gray-400 font-bold ml-1", children: "tanpa diskon" })
        ] })
      ] }),
...
function PricingIndex({ vouchers = [], packages = [] }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { header: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 w-full", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
      hasPermission("create vouchers") && /* @__PURE__ */ jsxs(
        "button",
        {
      ...
      hasPermission("create packages") && /* @__PURE__ */ jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsx("div", { className: "py-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          packages.length === 0 && hasPermission("create packages") && /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => {
                const defaults = [
        ...
        packages.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white/40 dark:bg-gray-800/40 backdrop-blur-md rounded-[2.5rem] border-2 border-dashed border-gray-200 dark:border-gray-700 p-20 text-center", children: [
          ...
          hasPermission("create packages") && /* @__PURE__ */ jsx("button", { onClick: openCreatePackage, className: "px-8 py-4 bg-indigo-600 text-white rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-indigo-500/30 hover:bg-indigo-700 transition-all", children: "Tambah Paket Sekarang" })
        ] }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: packages.map((p) => /* @__PURE__ */ jsx(
          PackageCard,
          {
            pkg: p,
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-2xl overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 dark:divide-gray-800/30", children: vouchers.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "7", className: "py-20 text-center", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            hasPermission("create vouchers") && /* @__PURE__ */ jsx("button", { onClick: openCreateVoucher, className: "text-indigo-600 dark:text-indigo-400 text-[10px] font-black uppercase tracking-widest hover:underline", children: "Tambah Kode Voucher Pertama" })
          ] }) }) }) : vouchers.map((v) => /* @__PURE__ */ jsx(
            VoucherRow,
            {
              voucher: v,
    ...
    /* @__PURE__ */ jsx(Modal, { show: showPackageModal, onClose: () => setShowPackageModal(false), maxWidth: "2xl", children: /* @__PURE__ */ jsxs("div", { className: "p-8", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handlePackageSubmit, className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2", children: "Harga Offline (Rp)" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "number",
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[9px] text-gray-400 mt-1 font-bold", children: "Harga dasar sesi tatap muka (offline). Diskon berlaku di harga ini." })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-2", children: "Harga Online (Rp)" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "number",
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[9px] text-blue-400 mt-1 font-bold", children: "Harga sesi online. Tanpa diskon. Kosongkan jika sama dengan harga offline dasar." })
          ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx("input", { type: "number", min: "0", max: "100", value: packageForm.data.discount_percentage, onChange: (e) => packageForm.setData("discount_percentage", e.target.value), className: "w-full bg-white dark:bg-gray-900 border-indigo-200 dark:border-indigo-900/50 text-gray-900 dark:text-white rounded-xl pr-10 text-sm font-black focus:ring-2 focus:ring-indigo-500/20" }),
