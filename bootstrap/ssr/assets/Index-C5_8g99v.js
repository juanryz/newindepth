                    ...
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 mt-auto", children: [
                          ...
                          isPast && /* @__PURE__ */ jsx("div", { className: "text-center py-2.5 px-4 rounded-2xl bg-slate-100 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600", children: /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-slate-400 uppercase tracking-widest", children: "Sesi sudah berlalu — tidak dapat dimulai" }) }),
                          ...
                          isPast && booking.status === "confirmed" && /* @__PURE__ */ jsx("button", { onClick: () => openNoShowModal(booking), className: "w-full text-[10px] font-black text-red-700 bg-red-50 hover:bg-red-100 border border-red-200 py-2.5 rounded-2xl uppercase", children: "Isi Alasan Tidak Hadir" })
                        ] })
                      ]
                    },
                    booking.id
