...
function AuthenticatedLayout({ header, children }) {
  ...
  roles.some((r) => typeof r === "string" && ["admin", "super_admin", "cs", "santa_maria"].includes(r.toLowerCase()));
  roles.some((r) => typeof r === "string" && r.toLowerCase() === "super_admin");
  roles.some((r) => typeof r === "string" && r.toLowerCase() === "therapist");
  roles.some((r) => typeof r === "string" && r.toLowerCase() === "patient");
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 transition-colors duration-500 overflow-x-hidden relative", children: [
    ...
    header && /* @__PURE__ */ jsx("header", { className: "relative z-40 border-b border-white/20 dark:border-gray-800/30 bg-white/30 dark:bg-gray-900/30 backdrop-blur-lg shadow-[0_4px_30px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.1)]", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8", children: [
      ![
        ...
        "agreement.patient",
        "agreement.show",
        "schedules.patient-detail",
        "affiliate.agreement.show",
        "admin.roles.create",
        "admin.roles.edit",
        "admin.users.create",
        "admin.users.edit",
        "admin.group-bookings.index",
        "admin.group-bookings.show",
        "admin.group-bookings.create",
        "admin.users.index",
        "admin.users.create-offline",
        "admin.group-bookings.members.add"
      ].some((r) => route().current(r)) && /* @__PURE__ */ jsxs(
        Link,
        {
    ...
    flashMsg && /* @__PURE__ */ jsxs(
      "div",
      {
        className: `fixed bottom-6 left-1/2 -translate-x-1/2 z-[9999] flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl text-sm font-bold backdrop-blur-xl border animate-in slide-in-from-bottom-4 duration-300 max-w-[90vw] ${flashType === "success" ? "bg-emerald-50/95 dark:bg-emerald-900/90 border-emerald-200 dark:border-emerald-700/60 text-emerald-800 dark:text-emerald-200" : "bg-red-50/95 dark:bg-red-900/90 border-red-200 dark:border-red-700/60 text-red-800 dark:text-red-200"}`,
        role: "alert",
        children: [
          flashType === "success" ? /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 flex-shrink-0 text-emerald-500", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.5", d: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" }) }) : /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 flex-shrink-0 text-red-500", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.5", d: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) }),
          /* @__PURE__ */ jsx("span", { children: flashMsg }),
          /* @__PURE__ */ jsx("button", { onClick: () => setFlashMsg(null), className: "ml-2 opacity-50 hover:opacity-100 transition-opacity flex-shrink-0", children: /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M6 18L18 6M6 6l12 12" }) }) })
        ]
      }
    )
  ] });
