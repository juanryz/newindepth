...
import { User, CheckCircle2, Calendar, Fingerprint, Phone, Mail, Activity, ShieldCheck, Heart, Clock, ChevronRight, BookOpen, AlertCircle, Video, ExternalLink, Clipboard, ChevronDown, FileText, ChevronLeft } from "lucide-react";
import "@headlessui/react";
import "./ThemeToggle-SHr-61ed.js";
import "./LiquidBackground-DsMP_cZ6.js";
function PatientDetail({ patient, profileProgress, availableSchedules, fromBookingId, isAdmin = false }) {
    ...
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8", children: [
          flash?.success && /* @__PURE__ */ jsx("div", { className: "p-4 text-sm text-green-800 dark:text-green-300 rounded-2xl bg-green-50/80 dark:bg-green-900/30 border border-green-200 dark:border-green-800/50", children: flash.success }),
          (flash?.error || errors?.error) && /* @__PURE__ */ jsx("div", { className: "p-4 text-sm text-red-800 dark:text-red-300 rounded-2xl bg-red-50/80 dark:bg-red-900/30 border border-red-200 dark:border-red-800/50", children: flash?.error || errors?.error }),
          /* @__PURE__ */ jsx(
            motion.div,
            {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
                      /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/60 rounded-3xl p-8 border border-gray-100 dark:border-gray-700/50 shadow-sm", children: [
                        ...
                        patient.courses?.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-3", children: patient.courses.map((course) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800/80 rounded-2xl border border-gray-100 dark:border-gray-700", children: [
                          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-indigo-100 dark:bg-indigo-900/50 rounded-xl flex items-center justify-center text-indigo-600 dark:text-indigo-400 shrink-0", children: /* @__PURE__ */ jsx(BookOpen, { className: "w-5 h-5" }) }),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/60 rounded-3xl p-8 border border-gray-100 dark:border-gray-700/50 shadow-sm", children: [
                      ...
                      (() => {
                        ...
                        if (!latestBooking) {
                          return /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400 italic", children: "Belum ada riwayat sesi yang terselesaikan." });
                        }
                        const duration = latestBooking.started_at && latestBooking.ended_at ? Math.round((new Date(latestBooking.ended_at) - new Date(latestBooking.started_at)) / 6e4) : null;
                        return /* @__PURE__ */ jsxs("div", { className: "bg-gray-50/50 dark:bg-gray-900/40 border border-gray-100 dark:border-gray-700/50 rounded-3xl p-6 transition-all hover:shadow-md hover:bg-white dark:hover:bg-gray-800", children: [
                          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4 mb-4", children: [
                            /* @__PURE__ */ jsxs("div", { children: [
                              ...
                              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 font-bold mt-0.5", children: new Date(latestBooking.schedule?.date || "").toLocaleDateString("id-ID", { weekday: "long", day: "numeric", month: "long", year: "numeric" }) })
                            ] }),
                            /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                              /* @__PURE__ */ jsx("span", { className: `px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter ${getStatusColor(latestBooking.status)}`, children: "TERLESAIKAN" }),
                              latestBooking.completion_outcome && /* @__PURE__ */ jsxs("span", { className: `px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter ${latestBooking.completion_outcome === "Normal" ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`, children: [
                                "OUTCOME: ",
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 mt-6", children: [
                            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                              /* @__PURE__ */ jsxs("div", { children: [
                                ...
                                /* @__PURE__ */ jsxs("div", { className: "bg-white/50 dark:bg-gray-800/80 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 space-y-3 text-xs", children: [
                                  /* @__PURE__ */ jsxs("p", { className: "flex justify-between", children: [
                                    ...
                                    /* @__PURE__ */ jsx("span", { className: "font-bold text-gray-800 dark:text-gray-200", children: latestBooking.therapist?.name || latestBooking.schedule?.therapist?.name || "-" })
                                  ] }),
                                  /* @__PURE__ */ jsxs("p", { className: "flex justify-between", children: [
                                    /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Paket:" }),
                                    /* @__PURE__ */ jsx("span", { className: "font-bold text-indigo-600 dark:text-indigo-400 uppercase", children: latestBooking.package_type || "REGULER" })
                                  ] }),
                                  latestBooking.started_at && /* @__PURE__ */ jsxs("div", { className: "pt-2 mt-2 border-t border-gray-100 dark:border-gray-700 space-y-2", children: [
                                    /* @__PURE__ */ jsxs("p", { className: "flex justify-between", children: [
                                      /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Mulai:" }),
                                      /* @__PURE__ */ jsxs("span", { className: "font-bold text-emerald-600", children: [
                                        new Date(latestBooking.started_at).toLocaleTimeString("id-id", { hour: "2-digit", minute: "2-digit" }),
                                        " WIB"
                                      ] })
                                    ] }),
                                    latestBooking.ended_at && /* @__PURE__ */ jsxs("p", { className: "flex justify-between", children: [
                                      /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Selesai:" }),
                                      /* @__PURE__ */ jsxs("span", { className: "font-bold text-red-600", children: [
                                        new Date(latestBooking.ended_at).toLocaleTimeString("id-id", { hour: "2-digit", minute: "2-digit" }),
                                        " WIB"
                                      ] })
                                    ] }),
                                    duration !== null && /* @__PURE__ */ jsxs("p", { className: "flex justify-between items-center p-2 bg-indigo-50 dark:bg-indigo-900/30 rounded-xl mt-2", children: [
                                      /* @__PURE__ */ jsx("span", { className: "text-indigo-600 dark:text-indigo-400 font-bold uppercase text-[9px]", children: "Durasi Sesi:" }),
                                      /* @__PURE__ */ jsxs("span", { className: "font-black text-indigo-700 dark:text-indigo-300", children: [
                                        duration,
                                        " Menit"
                                      ] })
                                    ] })
                              ...
                              latestBooking.recording_link && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                            ...
                            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                              /* @__PURE__ */ jsxs("div", { children: [
                                ...
                                /* @__PURE__ */ jsx("div", { className: "bg-indigo-50/30 dark:bg-indigo-900/10 p-5 rounded-2xl border border-indigo-100/30 text-xs text-gray-700 dark:text-gray-300 min-h-[100px] leading-relaxed shadow-sm", children: latestBooking.therapist_notes || "Tidak ada catatan sesi yang dicatat." })
                              ] }),
                              latestBooking.patient_visible_notes && /* @__PURE__ */ jsxs("div", { children: [
                                ...
                                /* @__PURE__ */ jsx("div", { className: "bg-emerald-50/30 dark:bg-emerald-900/10 p-5 rounded-2xl border border-emerald-100/30 text-xs text-emerald-800 dark:text-emerald-300 leading-relaxed shadow-sm", children: latestBooking.patient_visible_notes })
                              ] }),
                              latestBooking.session_checklist && Object.keys(latestBooking.session_checklist).length > 0 && /* @__PURE__ */ jsxs("div", { children: [
                                /* @__PURE__ */ jsxs(
                                  "button",
                                  {
                                    type: "button",
                                    ...
                                    children: [
                                      ...
                                      /* @__PURE__ */ jsx(ChevronDown, { className: `w-4 h-4 text-indigo-400 transition-transform duration-200 ${expandedChecklist === latestBooking.id ? "rotate-180" : ""}` })
                                    ]
                                  }
                                ),
                                expandedChecklist === latestBooking.id && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2 mt-3 animate-in fade-in duration-200", children: [
                                  latestBooking.session_checklist.problem_name && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Masalah" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.problem_name })
                                  ] }),
                                  latestBooking.session_checklist.problem_score && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                  ...
                                  latestBooking.session_checklist.final_problem_score && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                  ...
                                  latestBooking.session_checklist.induction_type?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Induksi" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.induction_type.join(", ") })
                                  ] }),
                                  latestBooking.session_checklist.deepening_technique?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Deepening" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.deepening_technique.join(", ") })
                                  ] }),
                                  latestBooking.session_checklist.core_method_type?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Metode Inti" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.core_method_type.join(", ") })
                                  ] }),
                                  latestBooking.session_checklist.suggestion_type?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Sugesti" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.suggestion_type.join(", ") })
                                  ] }),
                                  latestBooking.session_checklist.timeline_type?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Timeline" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.timeline_type.join(", ") })
                                  ] }),
                                  latestBooking.session_checklist.emerging_type?.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Emerging" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.emerging_type.join(", ") })
                                  ] }),
                                  /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    ...
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.has_abreaction ? "Ya" : "Tidak" })
                                  ] }),
                                  /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Segel Hipnotis" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.has_seal ? "Ya" : "Tidak" })
                                  ] }),
                                  /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Pengujian Hasil" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.has_result_test ? "Ya" : "Tidak" })
                                  ] }),
                                  latestBooking.session_checklist.desired_outcome && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700 col-span-2", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Outcome Diinginkan" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.desired_outcome })
                                  ] }),
                                  latestBooking.session_checklist.outcome_indicator && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700 col-span-2", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Indikator Outcome" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.outcome_indicator })
                                  ] }),
                                  latestBooking.session_checklist.has_exception && latestBooking.session_checklist.exception_detail && /* @__PURE__ */ jsxs("div", { className: "p-2.5 bg-white/50 dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700 col-span-2", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[8px] font-black text-gray-400 uppercase mb-0.5", children: "Pengecualian" }),
                                    /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold text-gray-800 dark:text-gray-200", children: latestBooking.session_checklist.exception_detail })
                                  ] })
                                ] })
                              ] })
                            ] })
              ...
              activeTab === "history" && /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/60 rounded-3xl p-8 border border-gray-100 dark:border-gray-700/50 shadow-sm", children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: "relative space-y-12 before:absolute before:left-6 before:top-2 before:bottom-0 before:w-0.5 before:bg-gray-100 dark:before:bg-gray-700/50", children: patient.bookings?.length > 0 ? patient.bookings.map((booking) => {
                      const duration = booking.started_at && booking.ended_at ? Math.round((new Date(booking.ended_at) - new Date(booking.started_at)) / 6e4) : null;
                      return /* @__PURE__ */ jsxs("div", { className: "relative pl-14", children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "bg-gray-50/50 dark:bg-gray-900/40 border border-gray-100 dark:border-gray-700/50 rounded-3xl p-6 transition-all hover:shadow-md hover:bg-white dark:hover:bg-gray-800", children: [
                          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4 mb-4", children: [
                            ...
                            /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                              ...
                              (booking.status === "confirmed" || isAdmin && booking.status === "completed" && booking.completion_outcome?.includes("No-Show")) && (booking.therapist_id === auth.user.id || isAdmin) && /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                            ...
                            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                              /* @__PURE__ */ jsxs("div", { children: [
                                ...
                                /* @__PURE__ */ jsxs("div", { className: "bg-white/50 dark:bg-gray-800/80 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 space-y-3 text-xs", children: [
                                  ...
                                  booking.started_at && /* @__PURE__ */ jsxs("div", { className: "pt-2 mt-2 border-t border-gray-100 dark:border-gray-700 space-y-2", children: [
                                    /* @__PURE__ */ jsxs("p", { className: "flex justify-between", children: [
                                      /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Mulai:" }),
                                      /* @__PURE__ */ jsxs("span", { className: "font-bold text-emerald-600", children: [
                                    ...
                                    booking.ended_at && /* @__PURE__ */ jsxs("p", { className: "flex justify-between", children: [
                                      /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Selesai:" }),
                                      /* @__PURE__ */ jsxs("span", { className: "font-bold text-red-600", children: [
                                        new Date(booking.ended_at).toLocaleTimeString("id-id", { hour: "2-digit", minute: "2-digit" }),
                                        " WIB"
                                      ] })
                                    ] }),
                                    duration !== null && /* @__PURE__ */ jsxs("p", { className: "flex justify-between items-center p-2 bg-indigo-50 dark:bg-indigo-900/30 rounded-xl mt-2", children: [
                    ...
                    }) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-20 text-gray-400 pl-8", children: [
        ...
        /* @__PURE__ */ jsx(Modal, { show: selectedRescheduleBooking !== null, onClose: () => setSelectedRescheduleBooking(null), children: /* @__PURE__ */ jsxs("form", { onSubmit: handleReschedule, className: "p-8 dark:bg-gray-900 border border-transparent dark:border-gray-800 rounded-[2.5rem]", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "new_schedule_id", value: "Pilih Slot Tersedia", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1 mb-2" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  id: "new_schedule_id",
                  ...
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "", children: "-- Input Tanggal & Jam Manual --" }),
            ...
            !rescheduleData.new_schedule_id && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Tanggal", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1 mb-2" }),
                /* @__PURE__ */ jsx(TextInput, { type: "date", className: "w-full", value: rescheduleData.new_date, onChange: (e) => setRescheduleData("new_date", e.target.value), required: true })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Jam Mulai", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1 mb-2" }),
                /* @__PURE__ */ jsx(TextInput, { type: "time", className: "w-full", value: rescheduleData.new_start_time, onChange: (e) => setRescheduleData("new_start_time", e.target.value), required: true })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Jam Selesai", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1 mb-2" }),
                /* @__PURE__ */ jsx(TextInput, { type: "time", className: "w-full", value: rescheduleData.new_end_time, onChange: (e) => setRescheduleData("new_end_time", e.target.value), required: true })
              ] })
            ] }),
            isAdmin && selectedRescheduleBooking?.completion_outcome?.includes("No-Show") && /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { value: "Status Kehadiran Sesi Ini", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1 mb-2" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  className: "mt-1 block w-full bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 rounded-2xl px-4 py-4 text-sm font-bold focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all dark:text-gray-200",
