...
function LmsIndex({ courses = [], auth, isMyCourses = false }) {
  ...
  return /* @__PURE__ */ jsxs(ErrorBoundary, { children: [
    /* @__PURE__ */ jsx(Head, { title: isMyCourses ? "Koleksi Saya" : "Pelatihan" }),
      ...
      /* @__PURE__ */ jsx("main", { className: "relative z-10 pt-32 pb-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-20", children: [
          ...
          /* @__PURE__ */ jsxs("h2", { className: "text-4xl md:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-6", children: [
            isMyCourses ? "Koleksi" : "Pelatihan",
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-gold-500 via-yellow-400 to-gold-600", children: isMyCourses ? "Kelas Saya" : "Offline" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-4 max-w-2xl mx-auto text-xl text-gray-600 dark:text-gray-300 font-light", children: isMyCourses ? "Akses semua materi kelas pelatihan yang telah Anda miliki untuk dibaca atau dipelajari kembali." : "Ikuti program pelatihan intensif tatap muka (offline) untuk mendalam teknik terapi dan pengembangan diri secara profesional bersama praktisi ahli kami." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: safeCourses.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "col-span-full py-20 text-center rounded-[3rem] border border-dashed border-gold-500/30 bg-white/20 dark:bg-gray-900/20 backdrop-blur-md", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-500 dark:text-gray-400 font-light", children: isMyCourses ? "Anda belum memiliki kelas aktif. Silakan pilih kelas di katalog Pelatihan." : "Belum ada kelas yang dipublikasikan saat ini, nantikan update selanjutnya." })
            ...
            motion.article,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs(Link, { href: `/courses/${course.slug}`, className: "block relative aspect-[16/10] overflow-hidden", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "absolute top-4 left-4", children: /* @__PURE__ */ jsx("span", { className: "px-4 py-1.5 rounded-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-md text-xs font-bold text-gold-600 dark:text-gold-400 shadow-sm border border-white/40 dark:border-gray-700/40", children: "Offline Training" }) })
                ] }),
