...
import { Users, ShieldCheck, Key, CheckCircle, ShieldAlert, ChevronRight, Search, UserCircle, Eye, Edit, Trash2, UserPlus } from "lucide-react";
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12 bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-64px)] transition-colors duration-500", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-8", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0 pb-12", children: /* @__PURE__ */ jsxs(AnimatePresence, { mode: "wait", children: [
              ...
              activeTab === "permissions" && /* @__PURE__ */ jsxs(
                motion.div,
                {
                  initial: { opacity: 0, y: 20 },
                  animate: { opacity: 1, y: 0 },
                  ...
                  className: "space-y-6",
                  children: [
                    /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] p-6 shadow-xl border border-white dark:border-gray-800 transition-all duration-500", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleCreatePermission, className: "flex flex-col sm:flex-row gap-4", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex-1 relative", children: [
                        /* @__PURE__ */ jsx(Key, { className: "absolute left-6 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" }),
                        /* @__PURE__ */ jsx(
                          "input",
                          {
                            type: "text",
                      ...
                      /* @__PURE__ */ jsx("button", { type: "submit", className: "px-8 py-4 bg-indigo-600 text-white rounded-[1.5rem] text-[10px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/20", children: "Simpan Izin Baru" })
                    ] }) }),
                    /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] p-8 shadow-xl border border-white dark:border-gray-800 transition-all duration-500", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: permissions.map((perm) => /* @__PURE__ */ jsxs("div", { className: "group flex items-center justify-between p-4 bg-gray-50/50 dark:bg-gray-800/50 rounded-2xl border border-transparent hover:border-indigo-100 dark:hover:border-indigo-900/30 transition-all", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-xl bg-white dark:bg-gray-900 shadow-sm flex items-center justify-center text-gray-400 group-hover:text-indigo-500 transition-colors", children: /* @__PURE__ */ jsx(Key, { className: "w-3.5 h-3.5" }) }),
                        editingPermission?.id === perm.id ? /* @__PURE__ */ jsx(
                          "input",
                          {
                            type: "text",
                          ...
                          "span",
                          {
                            ...
                            children: perm.name.replace(/_/g, " ")
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsx(
