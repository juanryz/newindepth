...
function InitialAgreement({ userAge }) {
  ...
  useEffect(() => {
    ...
    const requiredBools = [
      ...
      data.privacy_policy,
      data.refund_policy,
      data.affiliate_agreement,
      data.course_agreement
    ];
  ...
  const CheckboxItem = ({ id, label, checked, onChange }) => /* @__PURE__ */ jsxs("label", { className: `flex items-start gap-4 p-4 rounded-xl border cursor-pointer select-none transition-all ${checked ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-900 dark:text-indigo-100 shadow-sm" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/40 hover:border-indigo-300 dark:hover:border-indigo-600"}`, children: [
    /* @__PURE__ */ jsx("div", { className: "pt-0.5", children: /* @__PURE__ */ jsx("input", { type: "checkbox", id, checked, onChange: (e) => onChange(e.target.checked), className: "w-5 h-5 accent-indigo-600 rounded text-indigo-600 focus:ring-indigo-500" }) }),
    /* @__PURE__ */ jsx("span", { className: `text-base md:text-sm leading-relaxed ${checked ? "font-bold" : "text-gray-700 dark:text-gray-300"}`, children: label })
  ] });
  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 dark:text-white leading-tight", children: "Dokumen Persetujuan Layanan" })
      ] }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Dokumen Persetujuan" }),
        /* @__PURE__ */ jsx("div", { className: "py-6 md:py-12 min-h-[calc(100dvh-64px)] bg-gray-50/50 dark:bg-gray-900/50", children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/60 backdrop-blur-xl border border-gray-100 dark:border-gray-700/50 rounded-2xl shadow-lg p-6 sm:p-10", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-8 border-b pb-6 dark:border-gray-700 text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 mt-2", children: "Harap baca dengan teliti dan centang seluruh pernyataan di bawah ini." })
            ] }),
              ...
              /* @__PURE__ */ jsxs("section", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "pl-8", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
                    /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-2 p-3 rounded-lg border cursor-pointer flex-1 justify-center transition-colors ${data.status_medis === "Ya" ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200" : "border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300"}`, children: [
                    ...
                    /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-2 p-3 rounded-lg border cursor-pointer flex-1 justify-center transition-colors ${data.status_medis === "Tidak" ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200" : "border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300"}`, children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "space-y-4 pl-8", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("input", { type: "text", value: data.nama_wali, onChange: (e) => setData("nama_wali", e.target.value), className: "w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 text-base md:text-sm focus:ring-amber-500 focus:border-amber-500", placeholder: "Contoh: Budi Santoso" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1", children: "Nomor Telepon Wali" }),
                      /* @__PURE__ */ jsx("input", { type: "text", value: data.telepon_wali, onChange: (e) => setData("telepon_wali", e.target.value), className: "w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-800 text-base md:text-sm focus:ring-amber-500 focus:border-amber-500", placeholder: "08xxxxxxxxxx" })
                    ] })
                  ] })
                ] })
              ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/60 backdrop-blur-xl border border-gray-100 dark:border-gray-700/50 rounded-2xl shadow-lg p-6 sm:p-10", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-4 border-b pb-6 dark:border-gray-700 text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 mt-2", children: "InDepth Mental Wellness" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 dark:bg-gray-950/50 border border-gray-200 dark:border-gray-800 p-6 sm:p-8 rounded-lg text-sm text-gray-800 dark:text-gray-100 max-h-[500px] overflow-y-auto font-serif leading-relaxed mb-6 shadow-inner relative", children: [
              ...
              /* @__PURE__ */ jsxs("ul", { className: "list-disc pl-5 mb-6 space-y-1", children: [
                ...
                /* @__PURE__ */ jsx("li", { children: "Jika akun dihapus dengan alasan apa pun, akun yang sudah terhapus tidak dapat melakukan klaim apa pun atau tuntutan ke InDepth." })
              ] }),
            ...
            /* @__PURE__ */ jsx("p", { className: "font-bold mb-4 text-gray-900 dark:text-gray-100", children: "PASAL 14 - PERNYATAAN AKHIR" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 text-center mt-8 text-gray-900 dark:text-gray-200", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mb-2 font-bold mt-4 border-t border-gray-200 dark:border-gray-700 pt-4", children: "Tanda Tangan Klien:" }),
                ...
                /* @__PURE__ */ jsx("div", { className: "mt-2 flex justify-center gap-2", children: /* @__PURE__ */ jsx("button", { type: "button", onClick: () => clearCanvas(canvasRef2, setHasDrawn2, "signature"), className: "text-xs text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 underline", children: "Ulangi Tanda Tangan" }) }),
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mb-2 invisible", children: "Spacing" }),
                /* @__PURE__ */ jsx("p", { className: "mb-2 font-bold mt-4 border-t border-gray-200 dark:border-gray-700 pt-4", children: "Tanda Tangan Perwakilan InDepth:" }),
                /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-[150px]", children: /* @__PURE__ */ jsx("img", { src: "/images/saiful-anam-signature.jpeg", alt: "Tanda Tangan Saiful Anam", className: "h-[120px] object-contain mix-blend-multiply dark:mix-blend-normal dark:invert opacity-90" }) }),
                /* @__PURE__ */ jsx("p", { className: "mt-4 font-semibold underline", children: "Saiful Anam" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm dark:text-gray-300", children: "Direktur Utama InDepth Mental Wellness" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800/60 backdrop-blur-xl border border-gray-100 dark:border-gray-700/50 rounded-2xl shadow-lg p-6 sm:p-10", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-8 border-b pb-6 dark:border-gray-700 text-center", children: [
              /* @__PURE__ */ jsx("span", { className: "inline-block py-1 px-3 text-xs font-bold bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300 mb-3 rounded-full", children: "DOKUMEN 3 DARI 3" }),
              /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: "Kebijakan & Perjanjian Tambahan" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 mt-2", children: "Persetujuan untuk operasional, layanan afiliasi, dan produk digital." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-sm", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold mb-2 text-gray-900 dark:text-gray-100", children: "1. Kebijakan Privasi" }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400 mb-3", children: "Saya menyetujui InDepth mengelola data pribadi saya sesuai kebijakan privasi untuk kepentingan layanan, riset internal, dan dokumentasi hukum." }),
                /* @__PURE__ */ jsx(CheckboxItem, { label: "Saya menyetujui Kebijakan Privasi.", checked: data.privacy_policy, onChange: (e) => setData("privacy_policy", e) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-sm", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold mb-2 text-gray-900 dark:text-gray-100", children: "2. Kebijakan Non-Refund" }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400 mb-3", children: "Sesuai Pasal 8, saya memahami bahwa seluruh pembayaran yang telah dilakukan bersifat final dan tidak dapat dikembalikan (non-refundable) apapun alasannya." }),
                /* @__PURE__ */ jsx(CheckboxItem, { label: "Saya menyetujui Kebijakan Non-Refund.", checked: data.refund_policy, onChange: (e) => setData("refund_policy", e) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-sm", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold mb-2 text-gray-900 dark:text-gray-100", children: "3. Perjanjian Afiliasi" }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400 mb-3", children: "Jika saya merujuk orang lain ke InDepth, saya menyetujui syarat & ketentuan komisi afiliasi yang berlaku di platform ini." }),
                /* @__PURE__ */ jsx(CheckboxItem, { label: "Saya menyetujui Syarat & Ketentuan Afiliasi.", checked: data.affiliate_agreement, onChange: (e) => setData("affiliate_agreement", e) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 text-sm", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-bold mb-2 text-gray-900 dark:text-gray-100", children: "4. Perjanjian Produk Digital & Kelas" }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400 mb-3", children: "Akses ke materi e-learning dan kelas digital bersifat personal dan tidak boleh disebarluaskan atau digandakan tanpa izin tertulis." }),
                /* @__PURE__ */ jsx(CheckboxItem, { label: "Saya menyetujui Ketentuan Produk Digital & Kelas.", checked: data.course_agreement, onChange: (e) => setData("course_agreement", e) })
              ] })
            ] })
          ] }),
