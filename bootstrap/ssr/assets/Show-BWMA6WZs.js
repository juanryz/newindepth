...
function PublicBlogShow({ post, auth }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased", children: [
    /* @__PURE__ */ jsxs(Head, { title: `${meta_title || title} | InDepth Mental Wellness`, children: [
    ...
    /* @__PURE__ */ jsxs("article", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-12 md:pt-40 md:pb-20", children: [
