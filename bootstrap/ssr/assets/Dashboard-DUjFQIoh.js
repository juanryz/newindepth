...
function ServiceFlowGuide({ user, profileProgress, activeBooking, isProcessingScreening }) {
  if (!user) return null;
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Asesmen kesehatan mental awal.",
...
function ScreeningBanner({ screeningResult, canTakeScreening, daysUntilNextScreening, isProfileComplete, isProcessingScreening }) {
  ...
  if (isProcessingScreening) {
    return /* @__PURE__ */ jsxs(GlassPanel, { className: "!border-indigo-200/60 dark:!border-indigo-700/30 p-5 relative overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-indigo-100/30 to-purple-100/10 dark:from-indigo-900/10 dark:to-transparent pointer-events-none animate-pulse" }),
      /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col sm:flex-row sm:items-center gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-12 h-12 rounded-2xl bg-indigo-100/80 dark:bg-indigo-800/30 flex items-center justify-center shadow-sm animate-spin", children: /* @__PURE__ */ jsx("svg", { className: "w-6 h-6 text-indigo-600 dark:text-indigo-400", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" }) }) }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsx("p", { className: "font-bold text-indigo-900 dark:text-indigo-200", children: "Sedang Memproses Hasil Skrining..." }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-indigo-700 dark:text-indigo-400 mt-0.5", children: "Mohon tunggu sebentar, AI kami sedang menganalisis jawaban dan riwayat keluhan Anda." })
        ] })
      ] })
    ] });
  }
  if (!screeningResult) {
    ...
    return /* @__PURE__ */ jsxs(GlassPanel, { className: "!border-amber-200/60 dark:!border-amber-700/30 p-5 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col sm:flex-row sm:items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsx("p", { className: "font-bold text-amber-900 dark:text-amber-200", children: "Lengkapi Profil untuk Melihat Hasil Skrining" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-amber-700 dark:text-amber-400 mt-0.5", children: "Jawaban skrining Anda sudah tersimpan aman. Silakan lengkapi profil Anda terlebih dahulu untuk membuka hasil analisis dan membuat janji konsultasi." })
        ] })
      ] })
    ] });
  }
  const packageLabelMap = { reguler: "Reguler", hipnoterapi: "Hipnoterapi", premium: "Premium", vip: "VIP" };
  const packageLabel = screeningResult.recommended_package ? packageLabelMap[screeningResult.recommended_package] ?? screeningResult.recommended_package : null;
...
const SessionReminderCountdown = ({ scheduleDate, startTime }) => {
  ...
  React.useEffect(() => {
    ...
    const tick = () => {
      ...
      if (!datePart) return;
      const sched = /* @__PURE__ */ new Date(`${datePart}T${startTime}`);
  ...
  return /* @__PURE__ */ jsxs("div", { className: `mt-3 flex items-center gap-2 px-4 py-2.5 rounded-2xl border ${urgent ? "bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800/40" : "bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800/40"}`, children: [
    /* @__PURE__ */ jsx("span", { className: `w-2.5 h-2.5 rounded-full flex-shrink-0 ${urgent ? "bg-red-500 animate-ping" : "bg-amber-500"}` }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("p", { className: `text-[9px] font-black uppercase tracking-widest ${urgent ? "text-red-500" : "text-amber-600 dark:text-amber-400"}`, children: "⏰ Ingatkan Hadir" }),
      /* @__PURE__ */ jsx("p", { className: `text-sm font-black tabular-nums ${urgent ? "text-red-600 dark:text-red-400" : "text-amber-700 dark:text-amber-300"}`, children: label }),
      /* @__PURE__ */ jsx("p", { className: `text-[9px] font-bold ${urgent ? "text-red-400" : "text-amber-500"}`, children: "Hadir 2 jam sebelum jadwal dimulai" })
    ] })
  ] });
};
function ActiveBookingCard({ booking }) {
  ...
  const borderCls = isInProgress ? "!border-red-500/50 shadow-[0_0_40px_rgba(239,68,68,0.15)]" : isConfirmed ? "!border-emerald-300/50 dark:!border-emerald-700/30 shadow-[0_0_30px_rgba(16,185,129,0.08)]" : "!border-indigo-200/50 dark:!border-indigo-800/20";
  return /* @__PURE__ */ jsxs(GlassPanel, { className: `p-6 mb-8 relative overflow-hidden transition-all duration-500 ${borderCls}`, children: [
    /* @__PURE__ */ jsx("div", { className: `absolute inset-0 bg-gradient-to-br from-transparent pointer-events-none ${isInProgress ? "from-red-500/10" : isConfirmed ? "from-emerald-50/50 dark:from-emerald-900/10" : "from-indigo-50/50 dark:from-indigo-900/10"}` }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col md:flex-row justify-between items-start gap-4 z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsx("h3", { className: `font-bold text-lg ${isInProgress ? "text-red-600 dark:text-red-400" : isConfirmed ? "text-emerald-700 dark:text-emerald-300" : "text-indigo-900 dark:text-indigo-300"}`, children: isInProgress ? "🔴 Sesi Sedang Berlangsung" : isConfirmed ? "✅ Jadwal Aktif Anda" : "Jadwal Aktif Anda" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-600 dark:text-slate-400 space-y-1", children: [
          ...
          booking.session_type && /* @__PURE__ */ jsxs("p", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("strong", { className: "text-slate-900 dark:text-slate-200 uppercase text-[10px] tracking-wider", children: "Mode Sesi:" }),
            /* @__PURE__ */ jsx("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest ${booking.session_type === "online" ? "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300" : "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"}`, children: booking.session_type === "online" ? "💻 Online" : "🏥 Offline" })
          ] }),
          booking.group_booking_member?.group_booking && /* @__PURE__ */ jsxs("p", { className: "flex items-center gap-1.5 mt-1", children: [
            /* @__PURE__ */ jsx("strong", { className: "text-slate-900 dark:text-slate-200 uppercase text-[10px] tracking-wider", children: "Grup:" }),
            /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300", children: booking.group_booking_member.group_booking.group_name })
          ] })
        ] }),
        isConfirmed && /* @__PURE__ */ jsx(SessionReminderCountdown, { scheduleDate: schedule.date, startTime: schedule.start_time }),
        isPendingPayment && transaction && /* @__PURE__ */ jsxs("div", { className: "mt-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/40 rounded-2xl", children: [
          /* @__PURE__ */ jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-yellow-600 dark:text-yellow-400 mb-1", children: "Nominal yang harus dibayar" }),
          /* @__PURE__ */ jsxs("p", { className: "text-xl font-black text-yellow-700 dark:text-yellow-300", children: [
            "Rp ",
            new Intl.NumberFormat("id-ID").format(transaction.amount || 0)
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-[9px] text-yellow-500 mt-0.5", children: "*Sudah termasuk PPN 11% dan kode unik" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 w-full md:w-auto md:min-w-[180px]", children: [
        /* @__PURE__ */ jsx(
          Link,
          {
        ...
        isPendingPayment && /* @__PURE__ */ jsxs(
          Link,
          {
        ...
        isConfirmed && /* @__PURE__ */ jsxs("a", { href: gcalUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex justify-center items-center gap-2 px-6 py-3 bg-emerald-600 text-white text-sm font-black rounded-2xl hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/20 uppercase tracking-wide", children: [
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      if (raw) {
        ...
        axios.post("/screening/store-public", JSON.parse(raw)).then(() => {
    ...
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500 dark:text-slate-400 mt-1 font-medium", children: canSeeManagement ? "Panel Manajemen Utama" : isTherapist ? "Panel Terapis" : "Panel Pasien" })
        ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative py-10 min-h-screen", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 relative z-10", children: [
            ...
            isPatient && activeBooking?.status === "pending_validation" && /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-2xl sm:rounded-[2rem] flex items-center justify-center flex-shrink-0 shadow-lg shadow-blue-500/30", children: /* @__PURE__ */ jsx("svg", { className: "w-8 h-8 sm:w-10 sm:h-10", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" }) }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-[0.2em] text-blue-400 mb-1", children: "Status Pembayaran" }),
                    /* @__PURE__ */ jsx("h3", { className: "text-xl sm:text-2xl font-black text-blue-900 dark:text-blue-100 leading-tight tracking-tight mb-2", children: "Bukti Pembayaran Sedang Diproses 🕐" }),
                    /* @__PURE__ */ jsxs("p", { className: "text-sm font-bold text-blue-700/80 dark:text-blue-300/80 leading-relaxed", children: [
                      "Bukti pembayaranmu sudah kami terima dan akan ",
                      /* @__PURE__ */ jsx("strong", { children: "divalidasi oleh tim kami" }),
                      " dalam waktu maksimal 1×24 jam. Jadwal konsultasi Anda akan aktif otomatis setelah tervalidasi."
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-wrap gap-3 justify-center sm:justify-start", children: [
                      /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 text-[10px] font-black uppercase tracking-widest rounded-full", children: [
                        /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" }),
                        "Kode: #",
                        activeBooking.booking_code
                      ] }),
                      activeBooking.transaction?.amount && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-100 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-300 text-[10px] font-black uppercase tracking-widest rounded-full", children: [
                        "💳 Rp ",
                        new Intl.NumberFormat("id-ID").format(activeBooking.transaction.amount)
                      ] })
                    ] })
                  ] })
                ]
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center md:text-left z-10 w-full space-y-5", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "bg-red-500/10 border border-red-500/20 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row gap-4 sm:gap-6 text-left w-full shadow-inner", children: [
                      ...
                      activeBooking.therapist && /* @__PURE__ */ jsxs("div", { className: "flex-1 border-t sm:border-t-0 sm:border-l border-red-500/20 pt-3 sm:pt-0 sm:pl-6", children: [
                        ...
                        activeBooking.session_type && /* @__PURE__ */ jsx("span", { className: `inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest ${activeBooking.session_type === "online" ? "bg-blue-500/20 text-blue-200 border border-blue-500/30" : "bg-emerald-500/20 text-emerald-200 border border-emerald-500/30"}`, children: activeBooking.session_type === "online" ? "💻 Online" : "🏥 Offline" })
                      ] })
                    ] }),
            ...
            canSeeManagement && /* @__PURE__ */ jsxs("div", { className: "space-y-10", children: [
              /* @__PURE__ */ jsxs("section", { children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: [
                  (isSuperAdmin || permissions.includes("view bookings") && !isTherapist) && /* @__PURE__ */ jsx(
                    QuickCard,
                    {
                  ...
                  !isSuperAdmin && permissions.includes("view transactions") && /* @__PURE__ */ jsx(
                    QuickCard,
                    {
                  ...
                  (isSuperAdmin || permissions.includes("view finance")) && /* @__PURE__ */ jsx(
                    QuickCard,
                    {
                  ...
                  (isSuperAdmin || permissions.includes("view blog_posts")) && /* @__PURE__ */ jsx(
                    QuickCard,
                    {
                  ...
                  (isSuperAdmin || permissions.includes("view users")) && /* @__PURE__ */ jsx(
                    QuickCard,
                    {
                  ...
                  (isSuperAdmin || permissions.includes("view vouchers") || permissions.includes("view packages")) && /* @__PURE__ */ jsx(
                    QuickCard,
                    {
                  ...
                  isSuperAdmin && /* @__PURE__ */ jsx(
                    QuickCard,
                    {
                      href: route("admin.clinic-settings.index"),
                      title: "Pengaturan Klinik",
                      description: "Jam buka, slot jadwal & durasi sesi — dinamis",
              ...
              /* @__PURE__ */ jsxs("section", { className: "mt-2", children: [
                /* @__PURE__ */ jsx(SectionLabel, { children: "AI Internal Karyawan" }),
                /* @__PURE__ */ jsx(
                  QuickCard,
                  {
            ...
            isPatient && !canSeeManagement && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsx(
                ScreeningBanner,
                {
                  screeningResult,
            ...
            isSantaMaria && !isAdmin && /* @__PURE__ */ jsxs("section", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: /* @__PURE__ */ jsx(
                QuickCard,
                {
            ...
            isTherapist && /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
              /* @__PURE__ */ jsxs("section", { children: [
                /* @__PURE__ */ jsx(SectionLabel, { children: isAdmin ? "Statistik Perusahaan (Konsultasi)" : "Statistik Saya" }),
              ...
              therapistActiveSessions?.length > 0 && /* @__PURE__ */ jsxs("section", { children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: therapistActiveSessions.map((booking) => /* @__PURE__ */ jsxs(GlassPanel, { className: "!border-red-200/50 dark:!border-red-800/20 p-6 relative overflow-hidden", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "relative space-y-2 mb-6 text-sm text-slate-600 dark:text-slate-400", children: [
                    ...
                    booking.group_booking_member?.group_booking && /* @__PURE__ */ jsxs("p", { className: "flex items-center gap-1.5 leading-none", children: [
                      /* @__PURE__ */ jsx("strong", { className: "tracking-tight", children: "Grup:" }),
                      /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300 rounded-lg text-[10px] font-black uppercase", children: booking.group_booking_member.group_booking.group_name })
                    ] }),
                    /* @__PURE__ */ jsxs("p", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1.5 flex-wrap", children: [
                                ...
                                booking.group_booking_member?.group_booking && /* @__PURE__ */ jsxs("span", { className: "text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-800/40", children: [
                                  "Grup: ",
                            ...
                            (() => {
                              ...
                              if (sched && sched.date && sched.start_time && sched.end_time) {
                                const dateStr2 = String(sched.date).includes("T") ? String(sched.date).split("T")[0] : String(sched.date).substring(0, 10);
                                const sessionDate = /* @__PURE__ */ new Date(`${dateStr2}T${sched.start_time}+07:00`);
                                const sessionEnd = /* @__PURE__ */ new Date(`${dateStr2}T${sched.end_time}+07:00`);
                                const now = /* @__PURE__ */ new Date();
                                const minStart = new Date(sessionDate.getTime() - 30 * 6e4);
                                if (now > sessionEnd) {
                                  state = "passed";
                              ...
                              if (state === "ready") {
                                ...
                                return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5 items-end", children: [
                                  /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase tracking-widest text-rose-500 mb-0.5", children: "⏰ Jadwal Sudah Berlalu" }),
                                  /* @__PURE__ */ jsx(
                                    "button",
                                    {
                ...
                /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("section", { children: [
                  /* @__PURE__ */ jsx(SectionLabel, { children: isAdmin ? "Layanan Terapi" : "Menu Terapis" }),
            ...
            !isAdmin && !isTherapist && /* @__PURE__ */ jsxs("section", { children: [
