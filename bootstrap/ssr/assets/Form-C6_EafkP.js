...
function BlogForm({ post, seoRules, forbiddenWords = [] }) {
  ...
  const useIdea = (idea) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => setSelectedIdeaTitle(""), 4e3);
  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        selectedIdeaTitle && /* @__PURE__ */ jsx("div", { className: "fixed top-20 right-6 z-[9999] animate-bounce-in max-w-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-indigo-600 text-white px-5 py-3 rounded-2xl shadow-2xl shadow-indigo-500/30 flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-lg", children: "✅" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest opacity-70", children: "Ide Terpilih" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs font-bold line-clamp-1", children: selectedIdeaTitle })
          ] })
        ] }) }),
          ...
          showGenerator && /* @__PURE__ */ jsx("div", { className: "mb-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-[2.5rem] border border-indigo-200/50 dark:border-indigo-800/30 shadow-2xl overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "p-8 md:p-10", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white/60 dark:bg-gray-800/60 rounded-2xl p-5 mb-6 border border-gray-200/50 dark:border-gray-700/50", children: [
              ...
              showIdeas && ideas.length > 0 && !isLoadingIdeas && /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3", children: ideas.map((idea, i) => {
                  ...
                  return /* @__PURE__ */ jsxs(
                    "button",
                    {
                      ...
                      className: `text-left p-4 rounded-2xl border-2 transition-all group cursor-pointer hover:shadow-lg active:scale-[0.98] ${isSelected ? "bg-indigo-50 dark:bg-indigo-950/30 border-indigo-400 dark:border-indigo-500 shadow-lg shadow-indigo-500/10" : "bg-white dark:bg-gray-900 border-gray-100 dark:border-gray-700 hover:border-indigo-400 dark:hover:border-indigo-500 hover:shadow-indigo-500/10"}`,
                      children: [
                        /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                          /* @__PURE__ */ jsx("p", { className: `text-sm font-bold line-clamp-2 transition-colors ${isSelected ? "text-indigo-600 dark:text-indigo-400" : "text-gray-800 dark:text-gray-200 group-hover:text-indigo-600 dark:group-hover:text-indigo-400"}`, children: idea.title }),
                          isSelected && /* @__PURE__ */ jsx("span", { className: "text-lg shrink-0", children: "✅" })
                        ] }),
                        ...
                        /* @__PURE__ */ jsx("p", { className: `text-[10px] font-bold mt-2 flex items-center gap-1 transition-transform ${isSelected ? "text-emerald-500" : "text-indigo-500 group-hover:translate-x-1"}`, children: isSelected ? "✅ Terpilih — keyword sudah diisi" : "👉 Gunakan ide ini" })
                      ]
                    },
                    i
                  );
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-3", children: [
              ...
              /* @__PURE__ */ jsx(Link, { href: route("admin.ai-training.index"), className: "px-6 py-3 bg-white dark:bg-gray-800 text-amber-600 dark:text-amber-400 text-[10px] font-black uppercase tracking-widest rounded-2xl border-2 border-amber-200 dark:border-amber-800 hover:bg-amber-50 transition-all flex items-center gap-2", children: "🧠 Training AI" })
            ] })
          ] }) }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 pt-6", children: [
                /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/20 dark:to-indigo-950/20 rounded-2xl p-4 border border-purple-200/50 dark:border-purple-800/30", children: [
                    ...
                    generatedImageUrl && /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
                      /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-emerald-500 mb-2", children: "✅ Gambar berhasil di-generate!" }),
                      /* @__PURE__ */ jsx(
                        "img",
                        {
                          src: generatedImageUrl,
                          alt: `Gambar untuk ${genKeyword || data.primary_keyword || "artikel"}`,
                          className: "rounded-xl shadow-lg w-full",
                          onError: (e) => {
                            e.target.src = `https://picsum.photos/seed/${Date.now()}/800/450`;
                          }
                        }
                      )
                    ] })
