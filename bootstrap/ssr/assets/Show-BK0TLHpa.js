      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-6", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900 dark:text-gray-100", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-2", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "font-medium truncate dark:text-white", children: booking.package_type === "vip" ? "Paket VIP (Intensive Care)" : booking.package_type === "premium" ? "Paket Premium" : booking.package_type === "reguler" ? "Paket Reguler" : "Paket Hipnoterapi" })
              ] }),
              ...
              isPendingPayment && !isCashPayment && /* @__PURE__ */ jsxs("div", { className: "mt-4 p-4 bg-orange-50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-800/30 rounded-lg text-sm text-orange-800 dark:text-orange-300", children: [
              ...
              isPendingPayment && isCashPayment && /* @__PURE__ */ jsxs("div", { className: "mt-4 p-4 bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-200 dark:border-emerald-800/30 rounded-lg text-sm text-emerald-800 dark:text-emerald-300", children: [
                /* @__PURE__ */ jsxs("span", { className: "font-bold flex items-center gap-2 mb-1", children: [
                ...
                /* @__PURE__ */ jsx("strong", { children: "Admin akan mengkonfirmasi setelah pembayaran diterima." })
              ] }),
          ...
          canCancel && /* @__PURE__ */ jsxs("div", { className: "mt-6 flex flex-col sm:flex-row justify-between items-center gap-4", children: [
            ...
            isPendingPayment && !isCashPayment && /* @__PURE__ */ jsx(Link, { href: route("payments.create", booking.id), children: /* @__PURE__ */ jsx(PrimaryButton, { className: "!bg-blue-600 hover:!bg-blue-500 !rounded-md !px-6 !py-2.5 !text-sm !font-bold", children: "Lanjutkan ke Pembayaran" }) })
          ] })
        ] }) })
      ]
    }
