...
import { Users, Building2, Phone, Mail, MapPin, FileText, Save, ChevronLeft } from "lucide-react";
    ...
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1", children: isEditing ? "Perbarui informasi dasar grup/institusi" : "Isi data grup/institusi — metode bayar diatur di halaman detail" })
        ] })
      ] }),
      children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-indigo-50 dark:bg-indigo-950/30 rounded-[2rem] p-6 border border-indigo-100 dark:border-indigo-900/40 flex items-start gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("ol", { className: "text-xs text-indigo-700 dark:text-indigo-400 font-medium mt-2 leading-relaxed list-decimal ml-4 space-y-1", children: [
                /* @__PURE__ */ jsx("li", { children: "Isi data grup & PIC → Simpan" }),
                /* @__PURE__ */ jsx("li", { children: "Di halaman detail: tambah anggota satu per satu" }),
                /* @__PURE__ */ jsx("li", { children: "Setelah semua anggota ditambahkan: pilih metode pembayaran & tandai lunas" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] p-8 shadow-xl border border-white dark:border-gray-800", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400 font-medium mt-0.5", children: "Informasi dasar institusi dan penanggung jawab" })
              ] })
            ] }),
