...
function AuthenticatedLayout({ header, children }) {
  ...
  roles.some((r) => ["admin", "super_admin", "cs"].includes(r.toLowerCase()));
  roles.some((r) => r.toLowerCase() === "super_admin");
  roles.some((r) => r.toLowerCase() === "therapist");
  roles.some((r) => r.toLowerCase() === "patient");
