                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { children: [
                          ...
                          /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 mt-1 font-bold", children: [
                            "Oleh: ",
                            proposal.user?.name,
                            proposal.approver && /* @__PURE__ */ jsxs("span", { className: "text-emerald-500 ml-2", children: [
                              "• Disetujui: ",
                  ...
                  proposal.type === "spending" && proposal.proofs.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-10 pt-10 border-t border-gray-100 dark:border-gray-800", children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: proposal.proofs.map((proof) => /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 dark:bg-black/20 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 relative group overflow-hidden", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-4", children: [
                        ...
                        /* @__PURE__ */ jsx("div", { className: `px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest ${getStatusColor(proof.status)}`, children: proof.status === "pending" ? "Menunggu" : proof.status === "approved" ? "Disetujui" : proof.status === "rejected" ? "Ditolak" : proof.status })
                      ] }),
