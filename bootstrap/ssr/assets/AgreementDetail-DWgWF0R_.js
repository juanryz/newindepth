    ...
    AuthenticatedLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12 bg-gray-50 dark:bg-gray-950 px-4 sm:px-6 print:bg-white print:py-0 print:px-0", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto space-y-12", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 print:hidden", children: [
            /* @__PURE__ */ jsxs(PrimaryButton, { onClick: () => window.print(), className: "w-full sm:w-auto px-10 h-14 rounded-2xl bg-slate-950 text-white font-black uppercase tracking-widest shadow-2xl hover:bg-slate-800 transition-all active:scale-95 flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsx(Link, { href: route("affiliate.dashboard"), className: "text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-widest transition-all", children: "Kembali ke Dashboard Affiliate" })
          ] })
        ] }) })
      ]
    }
