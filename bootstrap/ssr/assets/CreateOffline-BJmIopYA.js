...
import { AlertTriangle, CheckSquare, Shield, User, Mail, Lock, EyeOff, Eye, ArrowRight, Phone, Camera, AlertCircle, Contact, ClipboardList, Wifi, WifiOff, FileImage, CheckCircle, Calendar, Package, CreditCard, Banknote, Download, Save, ChevronLeft, Trash2, Upload, X, MapPin } from "lucide-react";
      ...
      /* @__PURE__ */ jsxs("div", { ref: printRef, className: "p-8 space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between pb-6 border-b-2 border-indigo-100", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-2 space-y-0.5", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-x-4", children: [
                clinicInfo?.phone && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400", children: clinicInfo.phone }),
                clinicInfo?.email && /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400", children: clinicInfo.email })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-right flex-shrink-0 ml-4", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: `inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border mt-2 ${data.payment_status === "paid" ? "bg-emerald-50 border-emerald-200 text-emerald-700" : "bg-amber-50 border-amber-200 text-amber-700"}`, children: data.payment_status === "paid" ? "✓ Lunas" : "⏳ Belum Dibayar" })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 dark:bg-blue-950/20 rounded-2xl border border-blue-100 dark:border-blue-900/40 p-5", children: [
          ...
          !isCash && bankAccounts.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            bankAccounts.map((b) => /* @__PURE__ */ jsxs("div", { className: "mb-2 flex items-center justify-between bg-white rounded-xl p-4 border border-blue-100 shadow-sm", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-xs font-black text-gray-900 uppercase", children: b.holder }),
          ...
          !isCash && bankAccounts.length === 0 && /* @__PURE__ */ jsxs("p", { className: "text-xs text-blue-600 font-medium", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-4 border-t border-gray-100 text-center", children: [
          /* @__PURE__ */ jsx("p", { className: "text-[9px] text-gray-400 leading-relaxed", children: "Invoice ini merupakan draft yang dibuat oleh admin. Nomor invoice final akan diterbitkan setelah booking dikonfirmasi." }),
...
function CreateOffline({
  ...
  const goToStep2 = () => {
    if (!data.disclaimer_confirmed) {
      alert("Silakan setujui Pernyataan & Disclaimer terlebih dahulu.");
      return;
    }
            ...
            step === 1 && /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(Section, { icon: Shield, iconBg: "bg-indigo-50 dark:bg-indigo-900/40", iconColor: "text-indigo-600 dark:text-indigo-400", title: "Informasi Identitas & Akun", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "bg-gray-50 dark:bg-gray-800 rounded-[2rem] p-4 border border-gray-100 dark:border-gray-700 space-y-2", children: roles.map((r) => /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all ${data.roles.includes(r.name) ? "bg-indigo-600 border-indigo-600 text-white" : "bg-white dark:bg-gray-900 border-gray-100 dark:border-gray-700 text-gray-500"}`, children: [
                        /* @__PURE__ */ jsx("input", { type: "checkbox", className: "hidden", value: r.name, checked: data.roles.includes(r.name), onChange: handleRoleChange }),
            ...
            step === 2 && /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(Section, { icon: Calendar, iconBg: "bg-blue-50 dark:bg-blue-900/40", iconColor: "text-blue-600 dark:text-blue-400", title: "Mode & Jadwal Sesi", children: /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: sessionTypeOptions.map(({ value, label, desc }) => /* @__PURE__ */ jsxs("label", { className: `flex items-start gap-4 p-5 rounded-2xl border-2 cursor-pointer transition-all ${data.session_type === value ? `bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-600/20` : "bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-gray-300"}`, children: [
                        ...
                        /* @__PURE__ */ jsx("span", { className: "text-2xl flex-shrink-0", children: value === "online" ? "💻" : "🏥" }),
                        /* @__PURE__ */ jsxs("div", { children: [
                          /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest mb-1", children: label }),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                      /* @__PURE__ */ jsx(InputLabel, { className: "text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1", children: "Pilih Jadwal (Opsional)" }),
                    ...
                    hasSchedule && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: bookingPackages.map((pkg) => /* @__PURE__ */ jsxs("label", { className: `flex items-center gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all ${data.package_type === pkg.slug ? "bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-600/20" : "bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-indigo-300"}`, children: [
                        ...
                        /* @__PURE__ */ jsx(Package, { className: `w-4 h-4 ${data.package_type === pkg.slug ? "text-white" : "text-indigo-400"}` }),
                        /* @__PURE__ */ jsxs("div", { children: [
                          /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest", children: pkg.name }),
                          /* @__PURE__ */ jsxs("p", { className: `text-[10px] font-medium ${data.package_type === pkg.slug ? "text-white/80" : "text-gray-400"}`, children: [
                            "Rp ",
                  ...
                  hasSchedule && /* @__PURE__ */ jsx(Section, { icon: CreditCard, iconBg: "bg-orange-50 dark:bg-orange-900/40", iconColor: "text-orange-600 dark:text-orange-400", title: "Invoice & Pembayaran", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: availablePaymentMethods.map((method) => {
                        const isCashMethod = ["Cash", "Tunai"].includes(method);
                        const Icon = isCashMethod ? Banknote : CreditCard;
                        return /* @__PURE__ */ jsxs("label", { className: `flex items-start gap-4 p-5 rounded-2xl border-2 cursor-pointer transition-all ${data.payment_method === method ? "bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-600/20" : "bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-indigo-300"}`, children: [
                          ...
                          /* @__PURE__ */ jsx(Icon, { className: `w-5 h-5 ${data.payment_method === method ? "text-white" : "text-indigo-500"}` }),
