                  ...
                  return /* @__PURE__ */ jsx("div", { className: "p-8 hover:bg-gray-50/30 dark:hover:bg-gray-800/10 transition-colors", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col xl:flex-row xl:items-start gap-8", children: [
                    /* @__PURE__ */ jsxs("div", { className: "xl:w-1/4", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-2", children: [
                        /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-indigo-500 mt-1.5 flex-shrink-0" }),
                        /* @__PURE__ */ jsxs("div", { children: [
                          /* @__PURE__ */ jsx("span", { className: "text-[12px] font-black tracking-widest text-gray-900 dark:text-white block mb-0.5", children: formatResourceName(resource) }),
                          /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-relaxed", children: resourceDescriptions[resource] || "Hak akses untuk mengelola modul ini." })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsx(
                        "button",
                        {
                          ...
                          children: allResSelected ? "Hapus Semua Centang" : "Pilih Semua (Penuh)"
                        }
                      )
                    ] }),
