...
function ServiceFlowGuide({ user, profileProgress, activeBooking }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" }) })
    }
  ];
...
function QuickCard({ href, title, description, iconPath, color, disabled = false, disabledText = "Lengkapi profil & screening" }) {
  ...
  return /* @__PURE__ */ jsx(motion.div, { initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, whileHover: { y: -3, scale: 1.01 }, whileTap: { scale: 0.98 }, className: "h-full", children: /* @__PURE__ */ jsxs(Link, { href, className: cls, children: [
...
function ScreeningBanner({ screeningResult, canTakeScreening, daysUntilNextScreening }) {
    ...
    return /* @__PURE__ */ jsxs(GlassPanel, { className: "!border-amber-200/60 dark:!border-amber-700/30 p-5 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col sm:flex-row sm:items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-amber-700 dark:text-amber-400 mt-0.5", children: "Selesaikan screening terlebih dahulu agar Anda bisa membeli paket dan membuat janji konsultasi." })
        ] })
      ] })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs(GlassPanel, { className: "!border-green-200/60 dark:!border-green-700/30 p-5 relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-start gap-4", children: [
      ...
      ) : /* @__PURE__ */ jsx("div", { className: "text-right", children: /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-xs font-medium text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700 cursor-not-allowed", children: [
...
function LastSessionCard({ booking }) {
  ...
  return /* @__PURE__ */ jsxs(GlassPanel, { className: "!border-emerald-200/50 dark:!border-emerald-800/30 overflow-hidden mb-8 relative", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative bg-emerald-500/5 px-6 py-3 border-b border-emerald-100/50 dark:border-emerald-800/30 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold text-emerald-600 dark:text-emerald-500 bg-emerald-100/60 dark:bg-emerald-900/20 px-2 py-0.5 rounded-full backdrop-blur", children: new Date(schedule.date).toLocaleDateString("id-ID", { day: "numeric", month: "short" }) })
    ] }),
...
function ActiveBookingCard({ booking }) {
  ...
  return /* @__PURE__ */ jsxs(GlassPanel, { className: "!border-indigo-200/50 dark:!border-indigo-800/20 p-6 mb-8 relative overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-indigo-50/50 to-transparent dark:from-indigo-900/10 dark:to-transparent pointer-events-none" }),
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-40 h-40 bg-indigo-400/10 rounded-full blur-3xl -mr-10 -mt-10 pointer-events-none" }),
    /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col md:flex-row justify-between items-start md:items-center gap-4 z-10", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-bold text-lg text-indigo-900 dark:text-indigo-300", children: "Jadwal Aktif Anda" }),
          /* @__PURE__ */ jsx("span", { className: `text-xs font-semibold px-2.5 py-0.5 rounded-full backdrop-blur ${statusColors[status] || "bg-slate-100 text-slate-800"}`, children: statusLabels[status] || status })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-600 dark:text-slate-400 space-y-1", children: [
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("strong", { className: "text-slate-900 dark:text-slate-200", children: "Kode:" }),
            " #",
            booking_code
          ] }),
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("strong", { className: "text-slate-900 dark:text-slate-200", children: "Jadwal:" }),
            " ",
          ...
          /* @__PURE__ */ jsxs("p", { children: [
            /* @__PURE__ */ jsx("strong", { className: "text-slate-900 dark:text-slate-200", children: "Terapis:" }),
            " ",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-3 w-full md:w-auto mt-4 md:mt-0", children: [
        /* @__PURE__ */ jsx(Link, { href: route("bookings.show", booking.id), className: "inline-flex justify-center items-center px-4 py-2.5 bg-white/60 dark:bg-white/[0.04] backdrop-blur-xl border border-indigo-200/50 dark:border-indigo-700/30 text-indigo-600 dark:text-indigo-400 text-sm font-bold rounded-2xl hover:bg-indigo-50/60 transition-all shadow-sm", children: "Lihat Detail" }),
        /* @__PURE__ */ jsxs("a", { href: gcalUrl, target: "_blank", rel: "noopener noreferrer", className: "inline-flex justify-center items-center gap-2 px-4 py-2.5 bg-indigo-600 text-white text-sm font-bold rounded-2xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/20", children: [
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative py-10 min-h-screen", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 relative z-10", children: [
            ...
            isAdmin && /* @__PURE__ */ jsxs("div", { className: "space-y-10", children: [
              /* @__PURE__ */ jsxs("section", { children: [
                /* @__PURE__ */ jsx(SectionLabel, { children: "Statistik Perusahaan (Global Summary)" }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-5", children: [
                  /* @__PURE__ */ jsxs(GlassPanel, { className: "p-6 transition-all", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] mb-2", children: "Total Sesi Berhasil" }),
                  ...
                  /* @__PURE__ */ jsxs(GlassPanel, { className: "p-6 transition-all", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] mb-2", children: "Pasien Terdaftar" }),
                  ...
                  /* @__PURE__ */ jsxs(GlassPanel, { className: "p-6 transition-all", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] mb-2", children: "Total Kelas Online" }),
                    /* @__PURE__ */ jsx("p", { className: "text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-amber-400", children: therapistStats?.active_courses || 0 })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("section", { children: [
            ...
            isTherapist && !isAdmin && /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
              /* @__PURE__ */ jsxs("section", { children: [
                /* @__PURE__ */ jsx(SectionLabel, { children: isAdmin ? "Statistik Perusahaan (Konsultasi & LMS)" : "Statistik Saya" }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-5", children: [
                  /* @__PURE__ */ jsx(Link, { href: isAdmin ? route("admin.bookings.index") : route("schedules.index"), className: "block group", children: /* @__PURE__ */ jsxs(GlassPanel, { className: "p-6 hover:shadow-[0_12px_40px_rgba(99,102,241,0.06)] hover:border-indigo-200/50 dark:hover:border-indigo-500/20 transition-all", children: [
                  ...
                  /* @__PURE__ */ jsx(Link, { href: isAdmin ? route("admin.courses.index") : route("therapist.courses.index"), className: "block group", children: /* @__PURE__ */ jsxs(GlassPanel, { className: "p-6 hover:shadow-[0_12px_40px_rgba(245,158,11,0.06)] hover:border-amber-200/50 dark:hover:border-amber-500/20 transition-all", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] mb-2", children: isAdmin ? "Total Kelas Online" : "Kelas Online Saya" }),
                    /* @__PURE__ */ jsx("p", { className: "text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-amber-400", children: therapistStats?.active_courses || 0 })
                  ] }) })
                ] })
              ] }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
                /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-8", children: [
                  /* @__PURE__ */ jsxs("section", { children: [
                    ...
                    /* @__PURE__ */ jsx(GlassPanel, { className: "p-2 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto max-h-[320px] overflow-y-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left", children: [
                      /* @__PURE__ */ jsx("thead", { className: "sticky top-0 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl z-10", children: /* @__PURE__ */ jsxs("tr", { className: "text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] border-b border-white/40 dark:border-slate-700/30", children: [
                        /* @__PURE__ */ jsx("th", { className: "px-4 py-3", children: "Waktu" }),
                        /* @__PURE__ */ jsx("th", { className: "px-4 py-3", children: "Pasien" }),
                        isAdmin && /* @__PURE__ */ jsx("th", { className: "px-4 py-3", children: "Terapis" }),
                        /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-right", children: "Aksi" })
                      ] }) }),
                      /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-white/30 dark:divide-slate-700/20", children: therapistUpcomingSessions?.length > 0 ? therapistUpcomingSessions.map((booking) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-indigo-50/30 dark:hover:bg-indigo-900/10 transition-colors", children: [
                        /* @__PURE__ */ jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                          /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-gray-900 dark:text-white", children: new Date(booking.schedule.date).toLocaleDateString("id-ID", { day: "numeric", month: "short" }) }),
                        ...
                        /* @__PURE__ */ jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                          /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center text-indigo-700 dark:text-indigo-300 font-bold text-xs", children: booking.patient?.name?.charAt(0) }),
                          /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-700 dark:text-gray-300", children: booking.patient?.name })
                        ] }) }),
                        isAdmin && /* @__PURE__ */ jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600 dark:text-gray-400 font-medium", children: booking.therapist?.name || booking.schedule?.therapist?.name }) }),
                      ...
                      ] }, booking.id)) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "3", className: "px-4 py-8 text-center text-sm text-gray-500 italic", children: "Belum ada agenda sesi." }) }) })
                    ] }) }) })
                  ] }),
                  /* @__PURE__ */ jsxs("section", { children: [
                    /* @__PURE__ */ jsx(SectionLabel, { children: isAdmin ? "Seluruh Riwayat Sesi Terakhir" : "Riwayat Pasien Terakhir" }),
                    /* @__PURE__ */ jsx(GlassPanel, { className: "p-2 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto max-h-[320px] overflow-y-auto custom-scrollbar", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left", children: [
                      /* @__PURE__ */ jsx("thead", { className: "sticky top-0 bg-white dark:bg-gray-800 z-10 shadow-sm", children: /* @__PURE__ */ jsxs("tr", { className: "text-xs font-bold text-gray-400 uppercase border-b border-gray-50 dark:border-gray-700", children: [
                        /* @__PURE__ */ jsx("th", { className: "px-4 py-3", children: "Tanggal" }),
                        /* @__PURE__ */ jsx("th", { className: "px-4 py-3", children: "Pasien" }),
                        isAdmin && /* @__PURE__ */ jsx("th", { className: "px-4 py-3", children: "Terapis" }),
                        /* @__PURE__ */ jsx("th", { className: "px-4 py-3", children: "Hasil" })
                      ] }) }),
                      /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 dark:divide-gray-700", children: therapistPastSessions?.length > 0 ? therapistPastSessions.map((booking) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors", children: [
                        /* @__PURE__ */ jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600 dark:text-gray-400", children: new Date(booking.updated_at).toLocaleDateString("id-ID", { day: "numeric", month: "short", year: "numeric" }) }) }),
                        /* @__PURE__ */ jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-700 dark:text-gray-300", children: booking.patient?.name }) }) }),
                        isAdmin && /* @__PURE__ */ jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600 dark:text-gray-400 font-medium", children: booking.therapist?.name || booking.schedule?.therapist?.name }) }),
                        /* @__PURE__ */ jsx("td", { className: "px-4 py-4", children: /* @__PURE__ */ jsx("span", { className: "px-2 py-1 bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-400 rounded-lg text-[10px] font-bold", children: booking.completion_outcome || "Selesai" }) })
                      ] }, booking.id)) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "3", className: "px-4 py-8 text-center text-sm text-gray-500 italic", children: "Belum ada riwayat sesi." }) }) })
                    ] }) }) })
                  ] })
                ] }),
