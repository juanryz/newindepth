...
import { CheckCircle, AlertTriangle, Edit2, Mail, Phone, MapPin, FileText, Calendar, Users, Plus, Eye, Trash2, ChevronLeft, AlertCircle } from "lucide-react";
...
function GroupBookingsShow({ group, schedules = [], bookingPackages = [] }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8 bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-64px)]", children: /* @__PURE__ */ jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] p-8 border border-gray-100 dark:border-gray-800 shadow-sm", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pb-3 border-b border-gray-100 dark:border-gray-800 mb-6", children: [
                /* @__PURE__ */ jsx("div", { className: "p-2 bg-blue-50 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 rounded-xl", children: /* @__PURE__ */ jsx(Calendar, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-gray-400", children: "Konfirmasi Jadwal" })
              ] }),
              /* @__PURE__ */ jsxs("form", { onSubmit: handleSaveSchedule, className: "space-y-5", children: [
                ...
                group.schedule_id && /* @__PURE__ */ jsxs("div", { className: "p-3 bg-blue-50 dark:bg-blue-950/20 rounded-xl border border-blue-100 dark:border-blue-900/40 text-xs text-blue-700 dark:text-blue-300 font-bold", children: [
                ...
                memberCount > 0 && !group.schedule_id && /* @__PURE__ */ jsxs("div", { className: "p-3 bg-amber-50 dark:bg-amber-950/20 rounded-xl border border-amber-200 dark:border-amber-800 text-xs text-amber-700 dark:text-amber-400 font-bold flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(AlertTriangle, { className: "w-4 h-4 flex-shrink-0" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden", children: [
            ...
            ] }) : /* @__PURE__ */ jsx("div", { className: "w-full overflow-x-auto pb-4", children: /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
