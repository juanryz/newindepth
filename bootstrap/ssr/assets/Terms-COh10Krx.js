...
function Terms({ auth }) {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Syarat dan Ketentuan | InDepth Mental Wellness" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Syarat dan ketentuan penggunaan layanan InDepth Mental Wellness. Baca selengkapnya mengenai hak, kewajiban, kebijakan pembatalan, dan peraturan sesi hipnoterapi." }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: "syarat ketentuan InDepth, aturan layanan hipnoterapi, kebijakan pembatalan sesi, ketentuan InDepth Semarang" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Syarat dan Ketentuan | InDepth Mental Wellness" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Syarat dan ketentuan layanan InDepth Mental Wellness: hak, kewajiban, dan kebijakan sesi hipnoterapi." }),
