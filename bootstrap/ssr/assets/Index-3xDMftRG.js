...
function TherapistScheduleIndex({ bookings, availableSchedules = [], calendarSchedules = [] }) {
  ...
  const renderEventContent = (eventInfo) => {
    ...
    isBooked ? event.extendedProps.bookings[0].patient.name : "Slot Tersedia";
    ...
    return /* @__PURE__ */ jsxs("div", { className: `p-1 rounded-lg text-xs font-semibold ${bgColor} ${textColor} border ${borderColor} flex flex-col h-full justify-center`, children: [
      /* @__PURE__ */ jsx("p", { className: "truncate", children: event.title }),
      isAdmin && therapistName && /* @__PURE__ */ jsxs("p", { className: "truncate text-[9px] opacity-80 mt-0.5 font-bold uppercase tracking-tighter italic", children: [
        "By: ",
        therapistName
      ] })
    ] });
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-black text-slate-900 uppercase tracking-tight leading-none", children: "Kelola Jadwal" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-slate-400 mt-2 uppercase tracking-[0.2em]", children: "Atur ketersediaan & pantau sesi terapi" })
        ] }),
        /* @__PURE__ */ jsxs(PrimaryButton, { onClick: () => setIsAdding(true), className: "rounded-2xl px-8 py-4 bg-indigo-600 hover:bg-indigo-700 shadow-xl shadow-indigo-600/20 transition-all active:scale-95 group", children: [
          /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 mr-2 group-hover:rotate-90 transition-transform duration-300", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3", d: "M12 4v16m8-8H4" }) }),
          "Tambah Slot Praktik"
        ] })
      ] }),
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mb-8 bg-slate-100 p-1.5 rounded-[1.5rem] w-fit border border-slate-200/50 shadow-inner", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsx("div", { className: "bg-white/70 backdrop-blur-xl border border-white/40 shadow-[0_20px_50px_rgba(0,0,0,0.04)] rounded-[3rem] overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "p-8", children: activeTab === "calendar" ? /* @__PURE__ */ jsx("div", { className: "animate-in fade-in duration-500", children: /* @__PURE__ */ jsx(
            FullCalendar,
            {
          ...
          ) }) : /* @__PURE__ */ jsx("div", { className: "space-y-6 animate-in fade-in duration-500", children: bookings.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center py-20 bg-gray-50 rounded-[2rem] border-2 border-dashed border-gray-200", children: /* @__PURE__ */ jsx("p", { className: "text-gray-400 font-medium italic", children: "Belum ada sesi yang tercatat." }) }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: bookings.map((booking) => {
            ...
            return /* @__PURE__ */ jsxs("div", { id: `booking-${booking.id}`, className: `rounded-[2.5rem] border shadow-sm p-7 relative overflow-hidden flex flex-col transition-all duration-300 ${isNoShow ? "bg-orange-50/30 border-orange-200" : booking.status === "completed" ? "bg-gray-50/50 border-gray-200" : booking.status === "in_progress" ? "bg-red-50/30 border-red-200 ring-2 ring-red-500 shadow-xl" : "bg-white border-indigo-100 ring-1 ring-indigo-50 hover:shadow-xl hover:border-indigo-200"}`, children: [
              /* @__PURE__ */ jsx("div", { className: "absolute top-6 right-6 text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest bg-white shadow-sm border border-gray-100", children: isNoShow ? /* @__PURE__ */ jsx("span", { className: "text-orange-600", children: "Tidak Hadir" }) : booking.status === "completed" ? /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Selesai" }) : booking.status === "in_progress" ? /* @__PURE__ */ jsx("span", { className: "text-red-600 animate-pulse", children: "Sedang Berlangsung" }) : /* @__PURE__ */ jsx("span", { className: "text-indigo-600", children: wasRescheduled ? "Dijadwal Ulang" : "Akan Datang" }) }),
              /* @__PURE__ */ jsxs("div", { className: "mb-6 pr-24", children: [
                /* @__PURE__ */ jsx("h4", { className: "font-black text-xl text-gray-900 uppercase tracking-tight leading-none mb-1", children: booking.patient.name }),
                ...
                isAdmin && /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-indigo-700", children: booking.schedule?.therapist?.name })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-indigo-50/50 rounded-3xl p-5 mb-6 border border-indigo-100/50", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center text-xs text-indigo-900 font-black mb-2 uppercase tracking-widest", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center text-xs text-indigo-800 font-bold", children: [
                  /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 mr-2 text-indigo-400", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.5", d: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" }) }),
                  booking.schedule.start_time?.substring(0, 5),
                  " - ",
                  booking.schedule.end_time?.substring(0, 5),
                  " WIB"
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center text-[10px] font-black text-indigo-600 dark:text-indigo-400 mt-3 pt-3 border-t border-indigo-100/50 uppercase tracking-[0.2em]", children: [
                  "Paket: ",
        ...
        /* @__PURE__ */ jsx(Modal, { show: isAdding, onClose: () => setIsAdding(false), children: /* @__PURE__ */ jsxs("form", { onSubmit: handleAddSchedule, className: "p-8", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-black text-gray-900 mb-2 uppercase tracking-tight", children: "Tambah Slot Praktik" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mb-8", children: "Buka slot ketersediaan baru untuk janji temu pasien." }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "date", value: "Tanggal Praktik" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
                  id: "date",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "quota", value: "Kuota (Pasien)" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
                  id: "quota",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "start_time", value: "Jam Mulai" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
                  id: "start_time",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "end_time", value: "Jam Selesai" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
                  id: "end_time",
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-8 flex justify-end gap-3", children: [
            /* @__PURE__ */ jsx(SecondaryButton, { onClick: () => setIsAdding(false), className: "rounded-2xl", children: "Batal" }),
            /* @__PURE__ */ jsx(PrimaryButton, { type: "submit", disabled: addingSchedule, className: "rounded-2xl bg-indigo-600 hover:bg-indigo-700", children: "Simpan Slot" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx(Modal, { show: selectedHistoryPatient !== null, onClose: closeHistoryModal, maxWidth: "2xl", children: /* @__PURE__ */ jsxs("div", { className: "p-8", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-black text-gray-900 mb-2 uppercase tracking-tight", children: "Riwayat Pasien" }),
          /* @__PURE__ */ jsxs("div", { className: "mb-8 p-6 bg-slate-50 rounded-[2rem] border border-gray-100", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xs font-black text-gray-400 uppercase tracking-widest mb-4", children: "Data & Skrining Pasien" }),
        ...
        /* @__PURE__ */ jsx(Modal, { show: selectedCompletingBooking !== null, onClose: closeCompleteModal, children: /* @__PURE__ */ jsxs("form", { onSubmit: handleCompleteSession, className: "p-8", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-black text-gray-900 mb-2 uppercase tracking-tight", children: "Akhiri Sesi" }),
        ...
        /* @__PURE__ */ jsx(Modal, { show: selectedRescheduleBooking !== null, onClose: closeRescheduleModal, children: /* @__PURE__ */ jsxs("form", { onSubmit: handleReschedule, className: "p-8", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-black text-gray-900 mb-2 uppercase tracking-tight", children: "Jadwal Ulang" }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500 mb-8", children: [
            "Pasien: ",
        ...
        /* @__PURE__ */ jsx(Modal, { show: selectedNoShowBooking !== null, onClose: closeNoShowModal, children: /* @__PURE__ */ jsxs("form", { onSubmit: handleNoShow, className: "p-8", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-black text-gray-900 mb-2 uppercase tracking-tight", children: "Tandai Tidak Hadir" }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500 mb-8", children: [
            "Pasien: ",
