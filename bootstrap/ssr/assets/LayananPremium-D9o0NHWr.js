...
function LayananPremium({ auth, packages = [] }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative", children: [
    ...
    /* @__PURE__ */ jsx(Head, { title: "Hipnoterapi Premium Semarang — Optimalisasi Performa dan Pengembangan Diri | InDepth" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-gold-500/50 rounded-[2.5rem] p-10 shadow-2xl hover:shadow-[0_20px_40px_rgba(208,170,33,0.15)] transition-all duration-500 w-full", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center md:text-left", children: [
            ...
            premiumPkg.discount_percentage > 0 && /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-400 line-through decoration-rose-500/50 decoration-2 mb-1", children: formatPrice(premiumPkg.base_price) }),
            /* @__PURE__ */ jsx("p", { className: "text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gold-500 to-yellow-500", children: formatPrice(premiumPkg.current_price || premiumPkg.base_price) }),
            premiumPkg.discount_percentage > 0 && premiumPkg.discount_ends_at && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 mt-2 px-3 py-1 bg-rose-500/10 text-rose-600 dark:text-rose-400 text-xs font-bold uppercase tracking-widest rounded-full border border-rose-500/20", children: [
              "Diskon ",
