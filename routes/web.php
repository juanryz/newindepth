...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware([\Spatie\Permission\Middleware\RoleMiddleware::class . ':patient'])->group(
        function () {
            ...
            Route::post('/bookings/{booking}/cancel', [\App\Http\Controllers\Clinic\BookingController::class, 'cancel'])->name('bookings.cancel');
    ...
    Route::prefix('admin')->name('admin.')->group(
        function () {
            ...
            Route::delete('/finance/petty-cash/{transaction}', [\App\Http\Controllers\Admin\FinanceController::class, 'destroyPettyCash'])
                ->middleware('permission:manage petty cash')
                ->name('finance.petty-cash.destroy');
