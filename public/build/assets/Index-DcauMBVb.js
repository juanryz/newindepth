import{d as o,e as d,j as e,H as h,f as g}from"./app-CM1Y6LTV.js";import{A as u}from"./AuthenticatedLayout-Dl4Dk0q9.js";import{F as f,i as w,a as k,b as v}from"./index-DqqiZ-ZV.js";import j from"./Form-BO9wbEO0.js";import"./transition-CEtJQUh1.js";import"./ThemeToggle-BMQkgMfp.js";import"./LiquidBackground-BWBex_Uv.js";function T({schedules:a,therapists:r,filters:n}){const[c,i]=o.useState(!1),[s,p]=o.useState(n.therapist_id||""),[x,l]=o.useState("timeGridWeek"),m=o.useRef(null);o.useEffect(()=>{const t=()=>{window.innerWidth<1024?l("timeGridDay"):l("timeGridWeek")};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),o.useEffect(()=>{s!==(n.therapist_id||"")&&d.get(route("admin.orders.index"),{...n,therapist_id:s},{preserveState:!0,replace:!0})},[s]);const b=t=>{d.visit(route("admin.schedules.show",t.event.id))};return e.jsxs(u,{header:e.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Manajemen Jadwal"}),children:[e.jsx(h,{title:"Manajemen Jadwal Terapis"}),e.jsx("style",{children:`
        .fc {
