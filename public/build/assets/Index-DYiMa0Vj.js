<<<<<<<< HEAD:public/build/assets/Index-ktRL-1OZ.js
import{e as o,d as p,j as e,H as b,f}from"./app-B3zrDT8S.js";import{A as u}from"./AuthenticatedLayout-CP3HO3mq.js";import{F as w,i as k,a as v,b as j}from"./index-CnQL0wHH.js";import y from"./Form-DkNZjUd7.js";import"./transition-DD4GaMUW.js";import"./ThemeToggle-Csqum6Gk.js";import"./LiquidBackground-B_KLR4Bb.js";function T({schedules:i,therapists:r,filters:d}){const[m,s]=o.useState(!1),[l,x]=o.useState(d.therapist_id||""),[h,c]=o.useState("timeGridWeek"),n=o.useRef(null);o.useEffect(()=>{const t=()=>{if(window.innerWidth<1024){if(c("timeGridDay"),n.current){const a=n.current.getApi();a.view.type.includes("Grid")&&a.view.type!=="timeGridDay"&&a.changeView("timeGridDay")}}else if(c("timeGridWeek"),n.current){const a=n.current.getApi();a.view.type.includes("Grid")&&a.view.type!=="dayGridMonth"&&a.view.type!=="timeGridWeek"&&a.changeView("timeGridWeek")}};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),o.useEffect(()=>{l!==(d.therapist_id||"")&&p.get(route("admin.orders.index"),{...d,therapist_id:l},{preserveState:!0,replace:!0})},[l]);const g=t=>{p.visit(route("admin.schedules.show",t.event.id))};return e.jsxs(u,{header:e.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Manajemen Jadwal"}),children:[e.jsx(b,{title:"Manajemen Jadwal Terapis"}),e.jsx("style",{children:`
========
import{e as o,d as p,j as e,H as b,f}from"./app-B87yEE7x.js";import{A as u}from"./AuthenticatedLayout-CYPBjkwp.js";import{F as w,i as k,a as v,b as j}from"./index-DxXBy-gy.js";import y from"./Form-CmNTAc53.js";import"./transition-XjVX1NpR.js";import"./ThemeToggle-CI7Rv1aS.js";import"./LiquidBackground-BfPKv-OT.js";function T({schedules:i,therapists:r,filters:d}){const[m,s]=o.useState(!1),[l,x]=o.useState(d.therapist_id||""),[h,c]=o.useState("timeGridWeek"),n=o.useRef(null);o.useEffect(()=>{const t=()=>{if(window.innerWidth<1024){if(c("timeGridDay"),n.current){const a=n.current.getApi();a.view.type.includes("Grid")&&a.view.type!=="timeGridDay"&&a.changeView("timeGridDay")}}else if(c("timeGridWeek"),n.current){const a=n.current.getApi();a.view.type.includes("Grid")&&a.view.type!=="dayGridMonth"&&a.view.type!=="timeGridWeek"&&a.changeView("timeGridWeek")}};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),o.useEffect(()=>{l!==(d.therapist_id||"")&&p.get(route("admin.orders.index"),{...d,therapist_id:l},{preserveState:!0,replace:!0})},[l]);const g=t=>{p.visit(route("admin.schedules.show",t.event.id))};return e.jsxs(u,{header:e.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Manajemen Jadwal"}),children:[e.jsx(b,{title:"Manajemen Jadwal Terapis"}),e.jsx("style",{children:`
>>>>>>>> 326b445a3ed050c88fc5a3ee9f76512b37320643:public/build/assets/Index-DYiMa0Vj.js
        .fc {
