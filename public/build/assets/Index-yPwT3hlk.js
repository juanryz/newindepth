import{e as w,b as o,f as m,j as e,H as k,h as v}from"./app-BS48rDuz.js";import{A as j}from"./AuthenticatedLayout-D9fChBI2.js";import{F as y,i as N,a as D,b as _}from"./index-BYTzmwKd.js";import z from"./Form-2ryc9Yr7.js";import"./transition-CPfBbgFd.js";import"./ThemeToggle-DQaj5Tfz.js";import"./LiquidBackground-CTXSiwuA.js";function A({schedules:i,therapists:a,filters:d}){const{auth:x}=w().props,{user:c}=x,h=t=>c.roles?.some(r=>r.name==="super_admin")||c.permissions?.includes(t),[g,s]=o.useState(!1),[l,u]=o.useState(d.therapist_id||""),[b,p]=o.useState("timeGridWeek"),n=o.useRef(null);o.useEffect(()=>{const t=()=>{if(window.innerWidth<1024){if(p("timeGridDay"),n.current){const r=n.current.getApi();r.view.type.includes("Grid")&&r.view.type!=="timeGridDay"&&r.changeView("timeGridDay")}}else if(p("timeGridWeek"),n.current){const r=n.current.getApi();r.view.type.includes("Grid")&&r.view.type!=="dayGridMonth"&&r.view.type!=="timeGridWeek"&&r.changeView("timeGridWeek")}};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),o.useEffect(()=>{l!==(d.therapist_id||"")&&m.get(route("admin.orders.index"),{...d,therapist_id:l},{preserveState:!0,replace:!0})},[l]);const f=t=>{m.visit(route("admin.schedules.show",t.event.id))};return e.jsxs(j,{header:e.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Manajemen Jadwal"}),children:[e.jsx(k,{title:"Manajemen Jadwal Terapis"}),e.jsx("style",{children:`
        .fc {
