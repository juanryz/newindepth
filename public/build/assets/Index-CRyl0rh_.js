import{r as i,b as l,j as e,H as m,d as b}from"./app-_RRHdJdJ.js";import{A as h}from"./AuthenticatedLayout-C5-d4ITV.js";import{F as g,i as u,a as f,b as w}from"./index-D3cHDKUy.js";import k from"./Form-DwdcneJ9.js";import"./transition-VPgp10ao.js";import"./ThemeToggle-BdKtQwcD.js";import"./LiquidBackground-BZWS-jlB.js";function T({schedules:a,therapists:t,filters:n}){const[d,o]=i.useState(!1),[s,c]=i.useState(n.therapist_id||""),p=i.useRef(null);i.useEffect(()=>{s!==(n.therapist_id||"")&&l.get(route("admin.schedules.index"),{...n,therapist_id:s},{preserveState:!0,replace:!0})},[s]);const x=r=>{l.visit(route("admin.schedules.show",r.event.id))};return e.jsxs(h,{header:e.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Manajemen Jadwal"}),children:[e.jsx(m,{title:"Manajemen Jadwal Terapis"}),e.jsx("style",{children:`
        .fc {
