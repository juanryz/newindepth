import{r as o,b as d,j as e,H as h,d as g}from"./app-ChOqDJKf.js";import{A as u}from"./AuthenticatedLayout-BMqM7Tzn.js";import{F as f,i as w,a as k,b as v}from"./index-DzSBZCqQ.js";import j from"./Form-DFAKZa0g.js";import"./transition-C9CL-UdA.js";import"./ThemeToggle-BIZ6iEwJ.js";import"./LiquidBackground-C49mCbrb.js";function T({schedules:r,therapists:a,filters:n}){const[c,s]=o.useState(!1),[i,p]=o.useState(n.therapist_id||""),[x,l]=o.useState("timeGridWeek"),m=o.useRef(null);o.useEffect(()=>{const t=()=>{window.innerWidth<1024?l("timeGridDay"):l("timeGridWeek")};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),o.useEffect(()=>{i!==(n.therapist_id||"")&&d.get(route("admin.schedules.index"),{...n,therapist_id:i},{preserveState:!0,replace:!0})},[i]);const b=t=>{d.visit(route("admin.schedules.show",t.event.id))};return e.jsxs(u,{header:e.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Manajemen Jadwal"}),children:[e.jsx(h,{title:"Manajemen Jadwal Terapis"}),e.jsx("style",{children:`
        .fc {
