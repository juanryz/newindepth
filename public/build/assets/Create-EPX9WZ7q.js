import{j as e,d as v,b as S,u as K,H as C,L as I}from"./app-k0xDp2-T.js";import{A as U}from"./AuthenticatedLayout-D9_akbRR.js";import{R as E}from"./RefundPolicyContent-TmODLXH3.js";import"./transition-DQZIZn-a.js";import"./ThemeToggle-DzsX0VjB.js";import"./LiquidBackground-CCjL27kS.js";function L({schedules:k=[],selectedScheduleId:s,onSelect:h}){if(k.length===0)return e.jsx("div",{className:"p-4 bg-gray-50/50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700/50 rounded-xl text-gray-500 dark:text-gray-400 text-sm italic text-center",children:"Belum ada jadwal yang tersedia untuk saat ini."});const[l,c]=v.useState("week"),r=k.filter(i=>{const o=(i.date||"").substring(0,10),t=new Date(`${o}T00:00:00Z`),d=new Intl.DateTimeFormat("en-CA",{timeZone:"Asia/Jakarta"}).format(new Date),n=new Date(`${d}T00:00:00Z`);switch(l){case"day":return t.getTime()===n.getTime();case"week":const g=new Date(n);return g.setDate(n.getDate()+7),t.getTime()>=n.getTime()&&t.getTime()<=g.getTime();case"month":return t.getUTCMonth()===n.getUTCMonth()&&t.getUTCFullYear()===n.getUTCFullYear();case"year":return t.getUTCFullYear()===n.getUTCFullYear();default:return!0}}).reduce((i,o)=>{const t=(o.date||"").substring(0,10);return i[t]||(i[t]=[]),i[t].push(o),i},{});return e.jsxs("div",{className:"space-y-6",children:[e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:[{id:"day",label:"Hari Ini"},{id:"week",label:"Minggu Ini"},{id:"month",label:"Bulan Ini"},{id:"year",label:"Tahun Ini"},{id:"all",label:"Semua Jadwal"}].map(i=>e.jsx("button",{type:"button",onClick:()=>c(i.id),className:`px-4 py-2 text-sm font-bold rounded-full transition-all duration-200 border ${l===i.id?"bg-indigo-600 text-white border-indigo-600 shadow-md transform -translate-y-0.5":"bg-white/40 dark:bg-gray-800/40 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/60"}`,children:i.label},i.id))}),Object.keys(r).length===0?e.jsx("div",{className:"p-6 bg-gray-50/50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700/50 rounded-2xl text-gray-500 dark:text-gray-400 text-sm text-center italic",children:"Tidak ada jadwal yang sesuai dengan filter ini."}):Object.entries(r).map(([i,o])=>e.jsxs("div",{children:[e.jsx("h4",{className:"text-sm font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-4 px-2",children:new Date(i).toLocaleDateString("id-ID",{weekday:"long",year:"numeric",month:"long",day:"numeric"})}),e.jsx("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-3",children:o.map(t=>{const d=s===t.id,n=t.bookings_count??0,g=new Date,a=new Intl.DateTimeFormat("en-US",{timeZone:"Asia/Jakarta",year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(g).reduce((j,w)=>(j[w.type]=w.value,j),{}),u=new Date(Date.UTC(a.year,a.month-1,a.day,a.hour,a.minute,a.second)),A=new Date(u.getTime()+3600*1e3),[D,_,P]=t.start_time.split(":"),p=new Date(t.date),T=new Date(Date.UTC(p.getUTCFullYear(),p.getUTCMonth(),p.getUTCDate(),D,_,P)),y=t.status==="full"||n>=t.quota,f=T<A,b=y||f;return e.jsxs("button",{type:"button",onClick:()=>!b&&h(t.id),disabled:b,className:`
                                        ...
                                        ${!b&&d?"bg-indigo-50/50 dark:bg-indigo-900/20 border-indigo-500 text-indigo-700 dark:text-indigo-400 shadow-md transform -translate-y-1":""}
                                        ${!b&&!d?"bg-white/40 dark:bg-gray-800/40 border-gray-200 dark:border-gray-700/50 text-gray-700 dark:text-gray-300 hover:border-indigo-300 dark:hover:border-indigo-700 hover:shadow-sm":""}
