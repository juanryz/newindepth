<<<<<<<< HEAD:public/build/assets/Index-TTzVlKCh.js
import{f as j,r as i,a as u,j as e,H as y,h as N}from"./app-ByzrL7ZA.js";import{A as _}from"./AuthenticatedLayout-D0SoT4hm.js";import{F as D,i as z,a as C,b as T}from"./index-CCq6H5t5.js";import E from"./Form-D3MtjF4M.js";import"./transition-DiyTZvfT.js";import"./ThemeToggle-CEko9QTJ.js";import"./LiquidBackground-0kNAM8nn.js";function B({schedules:o,therapists:r,filters:d,clinicSettings:c={}}){const{auth:p}=j().props,{user:G}=p,m=c.open_time||"08:00",x=c.close_time||"22:00",g=c.standard_slots||[],b=t=>p.user.roles?.includes("super_admin")||p.user.permissions?.includes(t),[f,s]=i.useState(!1),[l,w]=i.useState(d.therapist_id||""),[k,h]=i.useState("timeGridWeek"),n=i.useRef(null);i.useEffect(()=>{const t=()=>{if(window.innerWidth<1024){if(h("timeGridDay"),n.current){const a=n.current.getApi();a.view.type.includes("Grid")&&a.view.type!=="timeGridDay"&&a.changeView("timeGridDay")}}else if(h("timeGridWeek"),n.current){const a=n.current.getApi();a.view.type.includes("Grid")&&a.view.type!=="dayGridMonth"&&a.view.type!=="timeGridWeek"&&a.changeView("timeGridWeek")}};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),i.useEffect(()=>{l!==(d.therapist_id||"")&&u.get(route("admin.orders.index"),{...d,therapist_id:l},{preserveState:!0,replace:!0})},[l]);const v=t=>{u.visit(route("admin.schedules.show",t.event.id))};return e.jsxs(_,{header:e.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Manajemen Jadwal"}),children:[e.jsx(y,{title:"Manajemen Jadwal Terapis"}),e.jsx("style",{children:`
========
import{f as j,r as i,a as u,j as e,H as y,h as N}from"./app-DxjMP1Us.js";import{A as _}from"./AuthenticatedLayout-w7l-ldij.js";import{F as D,i as z,a as C,b as T}from"./index-Bdss3jn4.js";import E from"./Form-Cf6HFNFA.js";import"./transition-y9ihWsD3.js";import"./ThemeToggle-DVbApPAa.js";import"./LiquidBackground-BsLCXSZl.js";function B({schedules:o,therapists:r,filters:d,clinicSettings:c={}}){const{auth:p}=j().props,{user:G}=p,m=c.open_time||"08:00",x=c.close_time||"22:00",g=c.standard_slots||[],b=t=>p.user.roles?.includes("super_admin")||p.user.permissions?.includes(t),[f,s]=i.useState(!1),[l,w]=i.useState(d.therapist_id||""),[k,h]=i.useState("timeGridWeek"),n=i.useRef(null);i.useEffect(()=>{const t=()=>{if(window.innerWidth<1024){if(h("timeGridDay"),n.current){const a=n.current.getApi();a.view.type.includes("Grid")&&a.view.type!=="timeGridDay"&&a.changeView("timeGridDay")}}else if(h("timeGridWeek"),n.current){const a=n.current.getApi();a.view.type.includes("Grid")&&a.view.type!=="dayGridMonth"&&a.view.type!=="timeGridWeek"&&a.changeView("timeGridWeek")}};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]),i.useEffect(()=>{l!==(d.therapist_id||"")&&u.get(route("admin.orders.index"),{...d,therapist_id:l},{preserveState:!0,replace:!0})},[l]);const v=t=>{u.visit(route("admin.schedules.show",t.event.id))};return e.jsxs(_,{header:e.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Manajemen Jadwal"}),children:[e.jsx(y,{title:"Manajemen Jadwal Terapis"}),e.jsx("style",{children:`
>>>>>>>> 7dfea74692c3c832c5b7bfd04a3a008f73ebae5c:public/build/assets/Index-DNj35lDf.js
        .fc {
