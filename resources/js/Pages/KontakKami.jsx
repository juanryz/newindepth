...
export default function KontakKami({ auth }) {
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans antialiased selection:bg-gold-500 selection:text-white transition-colors duration-500 overflow-x-hidden relative">
            ...
            {/* ── SEARCH ENGINE ── */}
            <section className="relative z-10 pb-10 px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    <motion.div {...fadeUp(0)}>
                        <Card className="p-6 sm:p-8">
                            <SectionLabel>Cari Informasi</SectionLabel>
                            ...
                            <div className="space-y-2">
                                {filteredFaqs.length === 0 ? (
                                    <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-6">
                                        Tidak ada hasil untuk "<span className="font-semibold">{searchQuery}</span>". Coba kata kunci lain atau hubungi kami langsung.
                                    </p>
                                ) : (
                                    filteredFaqs.map((faq, i) => (
                                        <div key={i} className="rounded-2xl border border-white/60 dark:border-gray-700/40 bg-white/30 dark:bg-gray-800/30 overflow-hidden">
                                            <button
                                            ...
                                            <AnimatePresence initial={false}>
                                                {openFaq === i && (
                                                    ...
                                                    >
                                                        <div className="px-5 pb-4 text-sm text-gray-600 dark:text-gray-400 font-medium leading-relaxed border-t border-white/40 dark:border-gray-700/30 pt-3">
                                                            {faq.answer}
                                                        </div>
                                                    </motion.div>
                                                )}
                ...
                <div className="max-w-7xl mx-auto">
                    <motion.div {...fadeUp(0)}>
                        <Card className="p-10 lg:p-14">
                            <SectionLabel>Konsultasi WhatsApp</SectionLabel>
                            <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-4">
                                Mulai dari WhatsApp
                            </h2>
                            <p className="text-gray-600 dark:text-gray-400 font-medium leading-relaxed mb-8 max-w-2xl">
                                Konsultasi awal dilakukan melalui WhatsApp untuk proses screening dan penjadwalan.
                            </p>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                                <div className="flex items-center gap-4">
                                    <div className="w-14 h-14 rounded-2xl bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800/50 flex items-center justify-center text-green-600 dark:text-green-400 shrink-0">
                                    ...
                                    <div>
                                        <p className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-1">WhatsApp</p>
                                        <p className="text-2xl font-black text-gray-900 dark:text-white">082220800034</p>
                                    </div>
                                </div>
                                <a
                            ...
                            <p className="mt-6 text-sm text-gray-500 dark:text-gray-500 font-medium">
                                Klik untuk mulai konsultasi dan mendapatkan arahan awal sesuai kondisi Anda.
                            </p>
                        </Card>
                    </motion.div>
                </div>
            ...
            {/* ── ALUR AWAL PENANGANAN ── */}
            <section className="relative z-10 py-10 px-4 sm:px-6 lg:px-8 bg-white/20 dark:bg-gray-900/20 backdrop-blur-sm">
                <div className="max-w-7xl mx-auto">
                    <motion.div {...fadeUp(0)} className="text-center mb-12">
                        <SectionLabel>Alur Awal Penanganan</SectionLabel>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <motion.div {...fadeUp(0)}>
                            <Card className="p-10 h-full">
                                ...
                                <SectionLabel>Lokasi InDepth Clinic</SectionLabel>
                                <h2 className="text-xl font-black text-gray-900 dark:text-white mb-4">InDepth Clinic</h2>
                                <address className="not-italic space-y-1 text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                                    <p>Jalan Kelud Raya 34B</p>
                                    <p>Petompon, Gajahmungkur</p>
                        ...
                        <motion.div {...fadeUp(0.1)}>
                            <Card className="p-10 h-full">
                                ...
                                <SectionLabel>Jam Operasional</SectionLabel>
                                <h2 className="text-xl font-black text-gray-900 dark:text-white mb-2">Senin – Sabtu</h2>
                                <p className="text-xs text-gray-400 dark:text-gray-500 font-semibold uppercase tracking-widest mb-5">Sesi tersedia</p>
                                <div className="grid grid-cols-2 gap-3">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center gap-3 bg-white/40 dark:bg-gray-800/40 rounded-2xl px-4 py-3 border border-white/50 dark:border-gray-700/30">
                                            <span className="w-2 h-2 rounded-full bg-gold-500 shrink-0"></span>
                                            <span className="text-sm font-semibold text-gray-800 dark:text-gray-200">{sesi}</span>
                                        </div>
                                    ))}
                                </div>
                            </Card>
                    ...
                    <motion.div {...fadeUp(0.15)} className="mt-8">
                        <Card className="overflow-hidden p-0">
                            <div className="px-8 pt-8 pb-4">
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Gunakan peta berikut untuk navigasi langsung ke lokasi InDepth Clinic.</p>
                            </div>
                            <div className="w-full h-[350px] overflow-hidden rounded-b-[2.5rem]">
                                <iframe
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <motion.div {...fadeUp(0)}>
                            <Card className="p-10 h-full">
                                ...
                                <h2 className="text-xl font-black text-gray-900 dark:text-white mb-6">Transfer Bank</h2>
                                <div className="bg-white/50 dark:bg-gray-800/50 rounded-2xl p-6 border border-white/60 dark:border-gray-700/40 space-y-3">
                                    <div className="flex items-center justify-between">
                                        <span className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">Bank</span>
                                        <span className="font-black text-gray-900 dark:text-white">BCA</span>
                                    </div>
                                    <div className="h-px bg-gray-200/60 dark:bg-gray-700/40" />
                                    <div className="flex items-center justify-between">
                                        <span className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">No. Rekening</span>
                                        <span className="font-black text-gray-900 dark:text-white tracking-wider">2520639058</span>
                                    </div>
                                    <div className="h-px bg-gray-200/60 dark:bg-gray-700/40" />
                                    <div className="flex items-center justify-between">
                                        <span className="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500">Atas Nama</span>
                                        <span className="font-black text-gray-900 dark:text-white">Julius Bambang</span>
                                    </div>
                                </div>
                                <p className="mt-5 text-sm text-gray-500 dark:text-gray-500 font-medium leading-relaxed">
                        ...
                        <motion.div {...fadeUp(0.1)} className="flex flex-col gap-6">
                            {/* Email */}
                            <Card className="p-8">
                                <div className="w-12 h-12 rounded-2xl bg-gold-50 dark:bg-gold-950/30 border border-gold-200 dark:border-gold-800/50 flex items-center justify-center text-gold-600 dark:text-gold-400 mb-5">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <p className="mt-3 text-sm text-gray-500 dark:text-gray-500 font-medium">
                                    Digunakan untuk kebutuhan administrasi dan komunikasi resmi.
                                </p>
                            </Card>
                ...
                <div className="max-w-5xl mx-auto">
                    <motion.div {...fadeUp(0)}>
                        <div className="relative rounded-[3rem] border border-gold-500/20 dark:border-gray-800 bg-white/40 dark:bg-gray-900/30 backdrop-blur-2xl shadow-xl overflow-hidden py-20 px-8 text-center">
                            ...
                            <div className="absolute -top-[50%] -left-[10%] w-[120%] h-[100%] bg-gradient-to-b from-gold-500/5 to-transparent blur-2xl transform -rotate-6 pointer-events-none" />
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-300 font-light leading-relaxed max-w-2xl mx-auto mb-10 relative z-10">
                                Mulai dari konsultasi awal untuk mendapatkan arahan yang sesuai dengan kondisi Anda.
                            </p>
