    ...
    return (
        <div className="space-y-8 text-slate-800 dark:text-white">
            ...
            <section>
                ...
                <ol className="list-decimal pl-5 space-y-2 text-sm text-slate-700 dark:text-white font-medium">
            ...
            <section>
                ...
                <ol className="list-decimal pl-5 space-y-1 text-sm text-slate-700 dark:text-white font-medium">
            ...
            <section>
                ...
                <p className="text-sm text-slate-700 dark:text-white font-medium">Perusahaan berhak menghentikan program affiliate atau akun affiliate kapan saja tanpa kewajiban memberikan alasan, terutama jika dianggap berisiko terhadap reputasi atau keamanan bisnis.</p>
            </section>
            ...
            <section>
                ...
                <p className="text-sm text-slate-700 dark:text-white font-medium">Affiliate setuju untuk membebaskan dan mengganti kerugian Perusahaan atas klaim akibat promosi affiliate, tuntutan klaim berlebihan, atau kerugian reputasi akibat tindakan affiliate.</p>
            </section>
            ...
            <section>
                ...
                <p className="text-sm text-slate-700 dark:text-white font-medium">Affiliate dilarang menyebarkan tuduhan tanpa putusan hukum tetap atau mengancam reputasi bisnis untuk menekan payout. Pelanggaran dapat diproses sesuai hukum yang berlaku.</p>
            </section>
            ...
            <section>
                ...
                <p className="text-sm text-slate-700 dark:text-white font-medium">Perusahaan tidak bertanggung jawab atas gangguan akibat bencana alam, gangguan server, kebijakan pemerintah, atau keadaan darurat lainnya.</p>
            </section>
            ...
            <section>
                ...
                <p className="text-sm text-slate-700 dark:text-white font-medium">Perusahaan berhak mengubah besaran komisi, struktur sistem, atau menghentikan program affiliate kapan pun. Perubahan berlaku sejak diumumkan.</p>
            </section>
            ...
            <section>
                ...
                <p className="text-sm text-slate-700 dark:text-white font-medium">Sengketa diselesaikan melalui musyawarah. Jika tidak tercapai kesepakatan, para pihak sepakat memilih domisili hukum di Pengadilan Negeri Semarang.</p>
            </section>
            ...
            <section>
                ...
                <p className="text-sm text-slate-700 dark:text-white font-medium">Dengan mencentang persetujuan digital: Affiliate menyetujui seluruh isi perjanjian, tunduk pada UU ITE, dan mengikat secara hukum seperti tanda tangan fisik.</p>
            </section>
        </div>
    );
}
