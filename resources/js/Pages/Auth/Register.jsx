    ...
    return (
        <GuestLayout title="Sign Up">
            ...
            <div className="mb-10 text-center relative">
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-32 h-32 bg-gold-400/10 rounded-full blur-3xl pointer-events-none"></div>
                <h2 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-gold-600 to-gray-900 dark:from-white dark:via-gold-400 dark:to-white tracking-tight leading-tight">
                    Sign Up
                </h2>
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400 font-medium tracking-wide">
                    Mulai perjalanan transformasi Anda
                </p>
                <div className="h-1.5 w-12 bg-gradient-to-r from-gold-400 to-gold-600 mx-auto mt-4 rounded-full shadow-sm shadow-gold-500/20"></div>
            </div>

            <form onSubmit={submit} className="space-y-6">
                <div className="group">
                    <InputLabel htmlFor="name" value="Name" className="ml-1 mb-1 transition-colors group-focus-within:text-gold-600 dark:group-focus-within:text-gold-400" />
                ...
                <div className="group">
                    <InputLabel htmlFor="phone" value="Nomor Telepon / WhatsApp" className="ml-1 mb-1 transition-colors group-focus-within:text-gold-600 dark:group-focus-within:text-gold-400" />
                ...
                <div className="group">
                    <InputLabel htmlFor="password" value="Password" className="ml-1 mb-1 transition-colors group-focus-within:text-gold-600 dark:group-focus-within:text-gold-400" />
                ...
                <div className="group">
                    <InputLabel htmlFor="password_confirmation" value="Confirm Password" className="ml-1 mb-1 transition-colors group-focus-within:text-gold-600 dark:group-focus-within:text-gold-400" />
