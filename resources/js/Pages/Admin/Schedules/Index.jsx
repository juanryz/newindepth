...
export default function AdminSchedulesIndex({ schedules, therapists, filters }) {
    ...
    // Custom Calendar Styles for Liquid Glass
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Manajemen Jadwal</h2>}
        >
            ...
            <div className="relative py-12 bg-slate-50 dark:bg-slate-950 min-h-screen overflow-hidden transition-colors duration-700">
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8 relative z-10">
                    ...
                    <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-2xl border border-white dark:border-slate-800 p-8 sm:p-10 rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-none transition-all duration-500">
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                            <div>
                                <h1 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white tracking-tight">
                                    Manajemen <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-indigo-400">Jadwal</span>
                                </h1>
                                <p className="mt-2 text-slate-500 dark:text-slate-400 font-bold italic tracking-wide">Atur waktu dan sesi konsultasi tim psikolog Anda.</p>
                            </div>
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                                ...
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 00-2 2h2m2 4h10a2 2 0 012 2v1H5v-1a2 2 0 012-2z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" /></svg>
                                    Cetak Jadwal
                                </button>
                        ...
                        <div className="mt-10 pt-10 border-t border-slate-100 dark:border-slate-800/50 flex flex-col md:flex-row items-center gap-6">
                            <div className="w-full md:w-auto flex-1">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 block ml-1">Pilih Terapis</label>
                    ...
                    <div className="bg-white/70 dark:bg-slate-900/40 backdrop-blur-3xl border border-white dark:border-slate-800 rounded-[3.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.1)] dark:shadow-none overflow-hidden transition-all duration-700 p-2 group">
                        <div className="bg-white dark:bg-slate-900/20 rounded-[3rem] p-6 sm:p-10 transition-colors">
                            <FullCalendar
                                ref={calendarRef}
                    ...
                    <div className="mt-12 pt-12 border-t border-slate-100 dark:border-slate-800/50 flex flex-col md:flex-row justify-between items-center gap-8">
                        ...
                        <p className="text-[10px] font-black text-slate-400 dark:text-slate-600 tracking-widest uppercase text-center sm:text-right">
                            &copy; {new Date().getFullYear()} InDepth Mental Wellness. Developed for Excellence.
                        </p>
                    </div>
                </div>
                ...
                {isAdding && typeof document !== 'undefined' && createPortal(
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-10 w-full max-w-lg shadow-2xl relative border border-white dark:border-slate-800 animate-in fade-in zoom-in duration-300">
                            <div className="flex justify-between items-center mb-8">
                                <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Tambah Slot Jadwal</h1>
