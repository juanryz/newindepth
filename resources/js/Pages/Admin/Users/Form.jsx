                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-50 dark:bg-gray-800/50 rounded-[2rem] p-6 border border-gray-100 dark:border-gray-800 space-y-3">
                                        {roles.map((role) => {
                                            ...
                                            return (
                                                <label key={role.id} className={`flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all ${isChecked ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-600/20' : 'bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-indigo-300'}`}>
                                                    <input
                                                        type="checkbox"
                                                        className="hidden"
                                                        value={role.name}
                                                    ...
                                                    />
                                                    <div className={`w-4 h-4 rounded border-2 flex items-center justify-center flex-shrink-0 ${isChecked ? 'border-white bg-white' : 'border-gray-300 dark:border-gray-600'}`}>
                                                        {isChecked && <div className="w-2 h-2 rounded-sm bg-indigo-600" />}
                                                    </div>
                                        ...
                                        {roles.length === 0 && (
                                            <p className="text-[10px] text-gray-400 font-medium text-center py-4">Tidak ada role tersedia.</p>
                                        )}
                                    </div>
