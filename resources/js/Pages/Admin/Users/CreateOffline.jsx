                        ...
                        <AnimatePresence mode="wait">
                            {step === 1 && (
                                ...
                                >
                                    ...
                                    {/* ── IDENTITAS AKUN ────────────────────────────── */}
                                    <Section icon={Shield} iconBg="bg-indigo-50 dark:bg-indigo-900/40" iconColor="text-indigo-600 dark:text-indigo-400" title="Informasi Identitas & Akun">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="bg-gray-50 dark:bg-gray-800 rounded-[2rem] p-4 border border-gray-100 dark:border-gray-700 space-y-2">
                                                    {roles.map(r => (
                                    ...
                                    <div className="flex justify-end p-6 bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-xl border border-white dark:border-gray-800">
                                        ...
                                        >
                                            Lanjut ke Detail Pasien <ArrowRight className="w-4 h-4" />
                                        </button>
                                    </div>
                                </motion.div>
                            )}
                            ...
                            {step === 2 && (
                                ...
                                >
                                    ...
                                    <Section icon={Calendar} iconBg="bg-blue-50 dark:bg-blue-900/40" iconColor="text-blue-600 dark:text-blue-400" title="Mode & Jadwal Sesi">
                                        <div className="space-y-8">
                                            <div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                    {sessionTypeOptions.map(({ value, label, desc }) => (
                                                        <label key={value} className={`flex items-start gap-4 p-5 rounded-2xl border-2 cursor-pointer transition-all ${data.session_type === value ? `bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-600/20` : 'bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-gray-300'}`}>
                                                            ...
                                                            <span className="text-2xl flex-shrink-0">{value === 'online' ? '💻' : '🏥'}</span>
                                                            <div>
                                                                <p className="text-[10px] font-black uppercase tracking-widest mb-1">{label}</p>
                                            ...
                                            <div className="space-y-4">
                                                <InputLabel className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Pilih Jadwal (Opsional)</InputLabel>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                        {bookingPackages.map(pkg => (
                                                            <label key={pkg.slug} className={`flex items-center gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all ${data.package_type === pkg.slug ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-600/20' : 'bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-indigo-300'}`}>
                                                                ...
                                                                <PackageIcon className={`w-4 h-4 ${data.package_type === pkg.slug ? 'text-white' : 'text-indigo-400'}`} />
                                                                <div>
                                                                    <p className="text-[10px] font-black uppercase tracking-widest">{pkg.name}</p>
                                                                    <p className={`text-[10px] font-medium ${data.package_type === pkg.slug ? 'text-white/80' : 'text-gray-400'}`}>Rp {pkg.price.toLocaleString('id-ID')}</p>
                                                                </div>
                                                            </label>
                                                        ))}
                                                    </div>
                                                        ...
                                                        {availablePaymentMethods.map(method => {
                                                            ...
                                                            return (
                                                                <label key={method} className={`flex items-start gap-4 p-5 rounded-2xl border-2 cursor-pointer transition-all ${data.payment_method === method ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-600/20' : 'bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-indigo-300'}`}>
                                                                    ...
                                                                    <Icon className={`w-5 h-5 ${data.payment_method === method ? 'text-white' : 'text-indigo-500'}`} />
                                    ...
                                    <div className="flex items-center justify-between bg-white dark:bg-gray-900 p-6 rounded-[2rem] shadow-xl border border-white dark:border-gray-800 sticky bottom-8">
                                        ...
                                        <button type="submit" disabled={processing || !data.disclaimer_confirmed} className="flex items-center gap-3 px-10 py-5 bg-indigo-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-indigo-700 shadow-xl shadow-indigo-600/20 active:scale-95 disabled:opacity-40">
                                            <Save className="w-4 h-4" /> Simpan Pasien Individual
                                        </button>
                                    </div>
                                </motion.div>
                            )}
