            ...
            <main className="relative z-10 pt-32 pb-20 lg:pt-48 lg:pb-32">
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        ...
                        <a href="#layanan" className="group inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-white/30 dark:bg-gray-800/30 backdrop-blur-xl text-gray-800 dark:text-white font-bold text-sm border border-white/70 dark:border-gray-600/50 shadow-[0_4px_15px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_15px_rgba(0,0,0,0.2)] hover:bg-white/50 dark:hover:bg-gray-700/50 hover:shadow-[0_8px_25px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-300">
                            Layanan Kami
