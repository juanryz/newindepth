                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-col sm:flex-row gap-8">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <div className="p-4 bg-white/50 dark:bg-black/20 rounded-2xl border border-white dark:border-gray-800 shadow-sm transition-all hover:shadow-md">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-xl bg-orange-50 dark:bg-orange-900/30 flex items-center justify-center font-black text-xs text-orange-600 dark:text-orange-400">MDR</div>
                                                <div className="min-w-0">
