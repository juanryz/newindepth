                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                        ...
                        <div className="md:flex">
                            <div className="md:w-1/3 bg-gray-100 flex items-center justify-center p-6">
                                {course.thumbnail ? (
                                    ...
                                    <div className="w-48 h-48 bg-indigo-200 rounded-full flex items-center justify-center text-indigo-500">
                            ...
                            <div className="p-8 md:w-2/3 flex flex-col justify-center">
                                ...
                                <div className="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between">
                                    ...
                                    <div>
                                        {isEnrolled ? (
                                            <span className="inline-flex items-center px-4 py-2 bg-green-100 border border-green-300 text-green-800 rounded-md font-semibold font-xs uppercase tracking-widest text-sm">
                                                Kamu Sudah Bergabung
                                            </span>
                                        ) : (
                                            <PrimaryButton>Beli Kelas Ini</PrimaryButton>
                                        )}
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                        <div className="p-6 border-b border-gray-200">
                            ...
                            <p className="text-sm text-gray-600 mt-1">{course.lessons?.length || 0} Materi Tersedia</p>
                        </div>
                        <div className="p-0">
                                        ...
                                        <div className="px-6 py-4 flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-3">
                                                {lesson.is_preview && !isEnrolled && (
                                                    <span className="px-2 py-1 text-xs font-semibold bg-blue-100 text-blue-700 rounded uppercase">Preview Gratis</span>
                                                )}

                                                {(isEnrolled || lesson.is_preview) ? (
                                                    <Link href={route('lessons.show', [course.slug, lesson.id])} className="text-indigo-600 hover:text-indigo-900 font-semibold text-sm">
                                                        Mulai Belajar &rarr;
                                                    </Link>
                                                ) : (
