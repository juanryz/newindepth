...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-w-xl mx-auto p-4 border rounded-lg bg-gray-50">
        ...
        <p>Pembayaran Anda telah diterima dan bersifat <strong>FINAL</strong> sesuai kebijakan InDepth Mental Wellness.
        </p>

        <p>Transaksi ini tidak dapat dibatalkan dan tidak dapat direfund kecuali dalam kondisi <em>Force Majeure</em>
            yang ditentukan oleh penyelenggara.</p>

        <div style="background-color: #fff; padding: 15px; border-radius: 5px; margin: 20px 0; border: 1px solid #ddd;">
            <p style="margin-top: 0; font-weight: bold; border-bottom: 1px solid #eee; padding-bottom: 8px;">Detail
                Reservasi:</p>
            <p><strong>Kode Booking:</strong> {{ $booking->booking_code }}</p>
            <p><strong>Terapis:</strong> {{ $booking->therapist->name ?? 'Akan dihubungi Admin' }}</p>
        ...
        <p>Mohon hadir tepat waktu sesuai dengan jadwal yang telah ditentukan. Simpan email ini sebagai bukti transaksi
            sah.</p>
